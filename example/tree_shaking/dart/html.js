...
let html_common = require("./html_common");
...
class Element extends Node {
  static html(html, {validator = null, treeSanitizer = null} = {}) {
  ...
  appendHtml(text, {validator = null, treeSanitizer = null} = {}) {
  ...
  insertAdjacentHtml(where, html, {validator = null, treeSanitizer = null} = {}) {
  ...
  createFragment(html, {validator = null, treeSanitizer = null} = {}) {
  ...
  setInnerHtml(html, {validator = null, treeSanitizer = null} = {}) {
    this.text = null;
    if (dart.is(treeSanitizer, _TrustedHtmlTreeSanitizer)) {
...
class Event extends DartHtmlDomObject {
  static new(type, {canBubble = true, cancelable = true} = {}) {
    return Event.eventType('Event', type, {canBubble: canBubble, cancelable: cancelable});
  }
  static eventType(type, name, {canBubble = true, cancelable = true} = {}) {
...
class CustomEvent extends Event {
  static new(type, {canBubble = true, cancelable = true, detail = null} = {}) {
...
class DocumentFragment extends Node {
  ...
  static svg(svgContent, {validator = null, treeSanitizer = null} = {}) {
  ...
  appendHtml(text, {validator = null, NodeTreeSanitizer = null, treeSanitizer = null} = {}) {
...
class HtmlDocument extends Document {
  ...
  createElementUpgrader(type, {extendsTag = null} = {}) {
...
class HttpRequest extends HttpRequestEventTarget {
  static getString(url, {withCredentials = null, onProgress = null} = {}) {
  ...
  static postFormData(url, data, {withCredentials = null, responseType = null, requestHeaders = null, onProgress = null} = {}) {
    let parts = [];
  ...
  static request(url, {method = null, withCredentials = null, responseType = null, mimeType = null, requestHeaders = null, sendData = null, onProgress = null} = {}) {
  ...
  static requestCrossOrigin(url, {method = null, sendData = null} = {}) {
...
class InputElement extends HtmlElement {
  ...
  setRangeText(replacement, {start = null, end = null, selectionMode = null} = {}) {
...
class UIEvent extends Event {
  static new(type, {view = null, detail = 0, canBubble = true, cancelable = true} = {}) {
    if (view == null) {
      view = exports.window;
    }
...
class KeyboardEvent extends UIEvent {
  static new(type, {view = null, canBubble = true, cancelable = true, keyLocation = 1, ctrlKey = false, altKey = false, shiftKey = false, metaKey = false} = {}) {
    if (view == null) {
      view = exports.window;
    }
...
class _DataAttributeMap extends core.Object {
  ...
  [_toCamelCase](hyphenedName, {startUppercase = false} = {}) {
...
class KeyEvent extends _WrappedEvent {
  ...
  static new(type, {view = null, canBubble = true, cancelable = true, keyCode = 0, charCode = 0, keyLocation = 1, ctrlKey = false, altKey = false, shiftKey = false, metaKey = false, currentTarget = null} = {}) {
    if (view == null) {
      view = exports.window;
    }
    let eventObj = null;
...
class _Html5NodeValidator extends core.Object {
  _Html5NodeValidator({uriPolicy = null} = {}) {
...
class NodeValidatorBuilder extends core.Object {
  ...
  allowInlineStyles({tagName = null} = {}) {
    if (tagName == null) {
      tagName = '*';
    } else {
  ...
  allowHtml5({uriPolicy = null} = {}) {
    this.add(new _Html5NodeValidator({uriPolicy: uriPolicy}));
  }
  allowSvg() {
    dart.throw('SVG not supported with DDC');
  }
  allowCustomElement(tagName, {uriPolicy = null, attributes = null, uriAttributes = null} = {}) {
  ...
  allowTagExtension(tagName, baseName, {uriPolicy = null, attributes = null, uriAttributes = null} = {}) {
  ...
  allowElement(tagName, {uriPolicy = null, attributes = null, uriAttributes = null} = {}) {
...
class _SimpleNodeValidator extends core.Object {
  ...
  _SimpleNodeValidator(uriPolicy, {allowedElements = null, allowedAttributes = null, allowedUriAttributes = null} = {}) {
