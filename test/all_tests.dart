...
import 'transformer/transformer_test.dart' as transformer_test;
import 'transformer/transformer_e2e_test.dart' as transformer_e2e_test;
...
void main() {
  ...
  // Note: we don't run transformer_test
