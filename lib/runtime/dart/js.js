dart_library.library('dart/js', null, /* Imports */[
  ...
  class JsObject extends core.Object {
    ...
    static fromBrowserObject(object) {
      if (typeof object == 'number' || typeof object == 'string' || typeof object == 'boolean' || object == null) {
        dart.throw_(new core.ArgumentError("object cannot be a num, string, bool, or null"));
      }
      return _wrapToDart(_convertToJS(object));
    }
    static jsify(object) {
      if (!dart.is(object, core.Map) && !dart.is(object, core.Iterable)) {
        dart.throw_(new core.ArgumentError("object must be a Map or Iterable"));
      }
    ...
    get(property) {
      if (!(typeof property == 'string') && !(typeof property == 'number')) {
        dart.throw_(new core.ArgumentError("property is not a String or num"));
      }
    ...
    callMethod(method, args) {
      ...
      if (!(typeof method == 'string') && !(typeof method == 'number')) {
        dart.throw_(new core.ArgumentError("method is not a String or num"));
      }
      if (args != null) args = core.List.from(args[dartx.map](_convertToJS));
      let fn = this[_jsObject][method];
      if (!(fn instanceof Function)) {
        dart.throw_(new core.NoSuchMethodError(this[_jsObject], core.Symbol.new(dart.as(method, core.String)), args, dart.map()));
      }
  ...
  dart.setSignature(JsObject, {
    constructors: () => ({
      _fromJs: [JsObject, [dart.dynamicR]],
      new: [JsObject, [JsFunction], [core.List]],
      fromBrowserObject: [JsObject, [dart.dynamicR]],
      jsify: [JsObject, [dart.dynamicR]]
    }),
    methods: () => ({
      get: [dart.dynamicR, [core.Object]],
      set: [dart.dynamicR, [core.Object, dart.dynamicR]],
      hasProperty: [core.bool, [dart.dynamicR]],
      deleteProperty: [dart.voidR, [dart.dynamicR]],
      instanceof: [core.bool, [JsFunction]],
      callMethod: [dart.dynamicR, [dart.dynamicR], [core.List]]
    }),
    statics: () => ({_convertDataTree: [dart.dynamicR, [dart.dynamicR]]}),
  ...
  dart.setSignature(JsFunction, {
    constructors: () => ({
      ...
      _fromJs: [JsFunction, [dart.dynamicR]]
    }),
    methods: () => ({apply: [dart.dynamicR, [core.List], {thisArg: dart.dynamicR}]})
  });
  ...
  const JsArray$ = dart.generic(function(E) {
    class JsArray extends dart.mixin(JsObject, collection.ListMixin$(E)) {
      ...
      static _checkRange(start, end, length) {
        if (dart.notNull(start) < 0 || dart.notNull(start) > dart.notNull(length)) {
          dart.throw_(new core.RangeError.range(start, 0, length));
        }
        if (dart.notNull(end) < dart.notNull(start) || dart.notNull(end) > dart.notNull(length)) {
          dart.throw_(new core.RangeError.range(end, start, length));
        }
      }
      get(index) {
      ...
      get length() {
        ...
        dart.throw_(new core.StateError('Bad JsArray length'));
      }
      set length(length) {
      ...
      removeLast() {
        if (this.length == 0) dart.throw_(new core.RangeError(-1));
    ...
    dart.setSignature(JsArray, {
      constructors: () => ({
        ...
        _fromJs: [JsArray$(E), [dart.dynamicR]]
      }),
      methods: () => ({
        [_checkIndex]: [dart.dynamicR, [core.int]],
        [_checkInsertIndex]: [dart.dynamicR, [core.int]],
        get: [E, [core.Object]],
        set: [dart.voidR, [core.Object, E]],
        add: [dart.voidR, [E]],
      ...
      statics: () => ({_checkRange: [dart.dynamicR, [core.int, core.int, core.int]]}),
      names: ['_checkRange']
    });
  ...
  dart.fn(_isBrowserType, core.bool, [dart.dynamicR]);
  ...
  dart.setSignature(_DartObject, {
    constructors: () => ({_DartObject: [_DartObject, [dart.dynamicR]]})
  });
  function _convertToJS(o) {
    if (o == null || typeof o == 'string' || typeof o == 'number' || typeof o == 'boolean' || dart.notNull(_isBrowserType(o))) {
      ...
      return _putIfAbsent(_jsProxies, o, dart.fn(o => new _DartObject(o), _DartObject, [dart.dynamicR]));
    }
  }
  ...
  dart.fn(_convertToDart, core.Object, [dart.dynamicR]);
  ...
  dart.fn(_wrapToDart, JsObject, [dart.dynamicR]);
  ...
  dart.fn(_putIfAbsent, core.Object, [dart.dynamicR, dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR])]);
  ...
  const __CastType0$ = dart.generic(function(E) {
    const __CastType0 = dart.typedef('__CastType0', () => dart.functionType(dart.dynamicR, [E]));
    return __CastType0;
  });
