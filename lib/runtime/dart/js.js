dart_library.library('dart/js', null, /* Imports */[
  ...
  class JsObject extends core.Object {
    ...
    instanceof(type) {
      return dart.as(this[_jsObject] instanceof _convertToJS(type), core.bool);
    }
    toString() {
      try {
  ...
  let JsArray$ = dart.generic(function(E) {
    class JsArray extends dart.mixin(JsObject, collection.ListMixin$(E)) {
      ...
      setRange(start, end, iterable, skipCount) {
        ...
        this.callMethod('splice', dart.as(args, core.List));
      }
      sort(compare) {
        if (compare === void 0)
          compare = null;
  ...
  function _convertToDart(o) {
    if (dart.notNull(dart.as(o == null, core.bool)) || dart.notNull(dart.as(typeof o == "string", core.bool)) || dart.notNull(dart.as(typeof o == "number", core.bool)) || dart.notNull(dart.as(typeof o == "boolean", core.bool)) || dart.notNull(_isBrowserType(o))) {
      return o;
