dart_library.library('dart/_debugger', null, /* Imports */[
  ...
  const skipDartConfig = dart.const_(new core.Object());
  ...
  dart.fn(_typeof, core.String, [dart.dynamicR]);
  function _instanceof(object, clazz) {
    return object instanceof clazz;
  }
  dart.fn(_instanceof, core.bool, [dart.dynamicR, dart.dynamicR]);
  function getOwnPropertyNames(object) {
    return dart.as(dart.list(Object.getOwnPropertyNames(object), core.String), core.List$(core.String));
  }
  dart.fn(getOwnPropertyNames, core.List$(core.String), [dart.dynamicR]);
  function getOwnPropertySymbols(object) {
    return Object.getOwnPropertySymbols(object);
  }
  dart.fn(getOwnPropertySymbols, core.List, [dart.dynamicR]);
  ...
  dart.setSignature(JSNative, {
    statics: () => ({
      ...
      setProperty: [dart.dynamicR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
  ...
  dart.fn(isRegularDartObject, core.bool, [dart.dynamicR]);
  ...
  dart.fn(getObjectTypeName, core.String, [dart.dynamicR]);
  ...
  dart.fn(safePreview, core.String, [dart.dynamicR]);
  ...
  dart.fn(symbolName, core.String, [dart.dynamicR]);
  ...
  dart.fn(hasMethod, core.bool, [dart.dynamicR, core.String]);
  ...
  dart.setSignature(JsonMLElement, {
    constructors: () => ({JsonMLElement: [JsonMLElement, [dart.dynamicR]]}),
    methods: () => ({
      appendChild: [dart.dynamicR, [dart.dynamicR]],
      createChild: [JsonMLElement, [core.String]],
      createObjectTag: [JsonMLElement, [dart.dynamicR]],
      setStyle: [dart.voidR, [core.String]],
      addStyle: [dart.dynamicR, [core.String]],
      addAttribute: [dart.dynamicR, [dart.dynamicR, dart.dynamicR]],
      createTextChild: [dart.dynamicR, [core.String]],
      toJsonML: [dart.dynamicR, []]
    })
  });
  ...
  dart.setSignature(JsonMLFormatter, {
    ...
    methods: () => ({
      header: [dart.dynamicR, [dart.dynamicR, dart.dynamicR]],
      hasBody: [core.bool, [dart.dynamicR]],
      body: [dart.dynamicR, [dart.dynamicR]]
    })
  });
  ...
  dart.setSignature(DartFormatter, {
    ...
    methods: () => ({
      preview: [core.String, [dart.dynamicR]],
      hasChildren: [core.bool, [dart.dynamicR]],
      children: [core.List$(NameValuePair), [dart.dynamicR]]
    })
  });
  ...
  dart.setSignature(ObjectFormatter, {
    methods: () => ({
      accept: [core.bool, [dart.dynamicR]],
      preview: [core.String, [dart.dynamicR]],
      hasChildren: [core.bool, [dart.dynamicR]],
      [_addMembers]: [dart.dynamicR, [dart.dynamicR, dart.dynamicR, core.List$(NameValuePair)]],
      children: [core.List$(NameValuePair), [dart.dynamicR]],
      addMetadataChildren: [dart.dynamicR, [dart.dynamicR, core.List$(NameValuePair)]]
    })
  });
  ...
  ClassMetadataFormatter[dart.implements_] = () => [Formatter];
  dart.setSignature(ClassMetadataFormatter, {
    methods: () => ({
      accept: [core.bool, [dart.dynamicR]],
      [_getType]: [dart.dynamicR, [dart.dynamicR]],
      preview: [core.String, [dart.dynamicR]],
      hasChildren: [core.bool, [dart.dynamicR]],
      children: [core.List$(NameValuePair), [dart.dynamicR]]
    })
  ...
  MapEntryFormatter[dart.implements_] = () => [Formatter];
  ...
  class HeritageClauseFormatter extends core.Object {
    ...
    preview(object) {
      ...
      let typeNames = clause.types[dartx.map](dart.fn(type => getTypeName(dart.as(type, core.Type)), core.String, [dart.dynamicR]));
  ...
  HeritageClauseFormatter[dart.implements_] = () => [Formatter];
