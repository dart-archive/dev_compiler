dart_library.library('dart/_debugger', null, /* Imports */[
  ...
  class JsonMLFormatter extends core.Object {
    ...
    body(object) {
      let bodyElement = new JsonMLElement('ol');
      bodyElement.setStyle('list-style-type: none;' + 'padding-left: 0px;' + 'margin-top: 0px;' + 'margin-bottom: 0px;' + 'margin-left: 12px');
      let children = this[_simpleFormatter].children(object);
      for (let child of children) {
        let li = bodyElement.createChild('li');
