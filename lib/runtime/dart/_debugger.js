dart_library.library('dart/_debugger', null, /* Imports */[
  ...
  exports[dart.uri] = 'dart:_debugger';
  ...
  NameValuePair[dart.owner] = exports;
  ...
  ClassMetadata[dart.owner] = exports;
  ...
  HeritageClause[dart.owner] = exports;
  ...
  JsonMLElement[dart.owner] = exports;
  ...
  JsonMLFormatter[dart.owner] = exports;
  class Formatter extends core.Object {}
  Formatter[dart.owner] = exports;
  const _formatters = Symbol('_formatters');
  class DartFormatter extends core.Object {
    DartFormatter() {
      this[_formatters] = null;
      this[_formatters] = [new FunctionFormatter(), new MapFormatter(), new IterableFormatter(), new MapEntryFormatter(), new ClassMetadataFormatter(), new HeritageClauseFormatter(), new ObjectFormatter()];
    }
    preview(object) {
  ...
  DartFormatter[dart.owner] = exports;
  ...
  ObjectFormatter[dart.owner] = exports;
  class FunctionFormatter extends Formatter {
    ...
    children(object) {
      return [new NameValuePair({name: 'signature', value: this.preview(object)}), new NameValuePair({name: 'JavaScript Function', value: object, skipDart: true})];
    }
  }
  ...
  FunctionFormatter[dart.owner] = exports;
  ...
  MapFormatter[dart.owner] = exports;
  ...
  IterableFormatter[dart.owner] = exports;
  ...
  ClassMetadataFormatter[dart.owner] = exports;
  class MapEntryFormatter extends core.Object {
    ...
    children(object) {
      return [new NameValuePair({name: 'key', value: dart.dload(object, 'key')}), new NameValuePair({name: 'value', value: dart.dload(object, 'value')})];
    }
  }
  ...
  MapEntryFormatter[dart.owner] = exports;
  ...
  HeritageClauseFormatter[dart.owner] = exports;
