dart_library.library('dart/core', null, /* Imports */[
  ...
  const _GeneratorIterable$ = dart.generic(function(E) {
    class _GeneratorIterable extends collection.IterableBase$(E) {
      ...
      skip(count) {
        ...
        if (newStart >= dart.notNull(this[_end]))
          return new (_internal.EmptyIterable$(E))();
      ...
      take(count) {
        ...
        if (newEnd >= dart.notNull(this[_end]))
          return this;
  ...
  class Uri extends Object {
    ...
    [_toWindowsFilePath]() {
      ...
      let result = new StringBuffer();
      if (dart.notNull(this[_isPathAbsolute]) && !hasDriveLetter)
        result.write("\\");
      if (this.host != "") {
        result.write("\\");
      ...
      if (hasDriveLetter && segments[dartx.length] == 1)
        result.write("\\");
      return dart.toString(result);
    }
    get [_isPathAbsolute]() {
