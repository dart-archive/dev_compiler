dart_library.library('dart/core', null, /* Imports */[
  ...
  class Object {
    ...
    noSuchMethod(invocation) {
      dart.throw_(new NoSuchMethodError(this, invocation.memberName, invocation.positionalArguments, invocation.namedArguments));
    }
    get runtimeType() {
  ...
  dart.setSignature(Object, {
    ...
    methods: () => ({
      '==': [bool, [dart.dynamicR]],
      toString: [String, []],
      noSuchMethod: [dart.dynamicR, [Invocation]]
    })
  });
  ...
  const deprecated = dart.const_(new Deprecated("next release"));
  const override = dart.const_(new _Override());
  ...
  const proxy = dart.const_(new _Proxy());
  ...
  class bool extends Object {
    static fromEnvironment(name, opts) {
      ...
      dart.throw_(new UnsupportedError('bool.fromEnvironment can only be used as a const constructor'));
    }
    toString() {
  ...
  class DateTime extends Object {
    ...
    static parse(formattedString) {
      ...
      if (match != null) {
        ...
        if (millisecondsSinceEpoch == null) {
          dart.throw_(new FormatException("Time out of range", formattedString));
        }
        ...
        dart.throw_(new FormatException("Invalid date format", formattedString));
      }
    }
    fromMillisecondsSinceEpoch(millisecondsSinceEpoch, opts) {
      ...
      if (dart.notNull(millisecondsSinceEpoch[dartx.abs]()) > dart.notNull(DateTime._MAX_MILLISECONDS_SINCE_EPOCH)) {
        dart.throw_(new ArgumentError(millisecondsSinceEpoch));
      }
      if (isUtc == null) dart.throw_(new ArgumentError(isUtc));
    }
    ['=='](other) {
  ...
  DateTime[dart.implements_] = () => [Comparable];
  ...
  class num extends Object {
    static parse(input, onError) {
      ...
      if (!dart.notNull(num._parseError)) return result;
      if (onError == null) dart.throw_(new FormatException(input));
  ...
  num[dart.implements_] = () => [Comparable$(num)];
  ...
  class Duration extends Object {
    ...
    ['~/'](quotient) {
      if (quotient == 0) dart.throw_(new IntegerDivisionByZeroException());
  ...
  Duration[dart.implements_] = () => [Comparable$(Duration)];
  ...
  Duration.ZERO = dart.const_(new Duration({seconds: 0}));
  ...
  dart.setSignature(ArgumentError, {
    constructors: () => ({
      ArgumentError: [ArgumentError, [], [dart.dynamicR]],
      value: [ArgumentError, [dart.dynamicR], [String, String]],
  ...
  class RangeError extends ArgumentError {
    ...
    static checkValueInInterval(value, minValue, maxValue, name, message) {
      ...
      if (dart.notNull(value) < dart.notNull(minValue) || dart.notNull(value) > dart.notNull(maxValue)) {
        dart.throw_(new RangeError.range(value, minValue, maxValue, name, message));
      }
    }
    static checkValidIndex(index, indexable, name, length, message) {
      ...
      if (dart.notNull(index) < 0 || dart.notNull(index) >= dart.notNull(length)) {
        ...
        dart.throw_(RangeError.index(index, indexable, name, message, length));
      }
    }
    static checkValidRange(start, end, length, startName, endName, message) {
      ...
      if (dart.notNull(start) < 0 || dart.notNull(start) > dart.notNull(length)) {
        ...
        dart.throw_(new RangeError.range(start, 0, length, startName, message));
      }
      if (end != null && (dart.notNull(end) < dart.notNull(start) || dart.notNull(end) > dart.notNull(length))) {
        if (endName == null) endName = "end";
        dart.throw_(new RangeError.range(end, start, length, endName, message));
      }
    }
    static checkNotNegative(value, name, message) {
      if (name === void 0) name = null;
      if (message === void 0) message = null;
      if (dart.notNull(value) < 0) dart.throw_(new RangeError.range(value, 0, null, name, message));
    }
    toString() {
  ...
  dart.setSignature(RangeError, {
    constructors: () => ({
      RangeError: [RangeError, [dart.dynamicR]],
      value: [RangeError, [num], [String, String]],
      range: [RangeError, [num, int, int], [String, String]],
      index: [RangeError, [int, dart.dynamicR], [String, String, int]]
    }),
    statics: () => ({
      checkValueInInterval: [dart.voidR, [int, int, int], [String, String]],
      checkValidIndex: [dart.voidR, [int, dart.dynamicR], [String, int, String]],
      checkValidRange: [dart.voidR, [int, int, int], [String, String, String]],
      checkNotNegative: [dart.voidR, [int], [String, String]]
    }),
  ...
  IndexError[dart.implements_] = () => [RangeError];
  dart.setSignature(IndexError, {
    constructors: () => ({IndexError: [IndexError, [int, dart.dynamicR], [String, String, int]]})
  });
    ...
    toString() {
      ...
      if (this[_namedArguments] != null) {
        this[_namedArguments].forEach(dart.fn((key, value) => {
          ...
          i = dart.notNull(i) + 1;
        }, dart.voidR, [Symbol, dart.dynamicR]));
      }
  ...
  dart.setSignature(NoSuchMethodError, {
    constructors: () => ({NoSuchMethodError: [NoSuchMethodError, [Object, Symbol, List, Map$(Symbol, dart.dynamicR)], [List]]})
  });
  ...
  UnimplementedError[dart.implements_] = () => [UnsupportedError];
  ...
  OutOfMemoryError[dart.implements_] = () => [Error];
  ...
  StackOverflowError[dart.implements_] = () => [Error];
  ...
  dart.setSignature(Exception, {
    constructors: () => ({new: [Exception, [], [dart.dynamicR]]})
  });
  ...
  _ExceptionImplementation[dart.implements_] = () => [Exception];
  dart.setSignature(_ExceptionImplementation, {
    constructors: () => ({_ExceptionImplementation: [_ExceptionImplementation, [], [dart.dynamicR]]})
  });
  ...
  FormatException[dart.implements_] = () => [Exception];
  dart.setSignature(FormatException, {
    constructors: () => ({FormatException: [FormatException, [], [String, dart.dynamicR, int]]})
  });
  ...
  IntegerDivisionByZeroException[dart.implements_] = () => [Exception];
  ...
  dart.setSignature(Function, {
    statics: () => ({
      apply: [dart.dynamicR, [Function, List], [Map$(Symbol, dart.dynamicR)]],
      _toMangledNames: [Map$(String, dart.dynamicR), [Map$(Symbol, dart.dynamicR)]]
    }),
  ...
  class int extends num {
    static fromEnvironment(name, opts) {
      ...
      dart.throw_(new UnsupportedError('int.fromEnvironment can only be used as a const constructor'));
    }
  ...
  const _GeneratorIterable$ = dart.generic(function(E) {
    ...
    _GeneratorIterable[dart.implements_] = () => [_internal.EfficientLength];
  ...
  const _GeneratorIterator$ = dart.generic(function(E) {
    ...
    _GeneratorIterator[dart.implements_] = () => [Iterator$(E)];
  ...
  const BidirectionalIterator$ = dart.generic(function(E) {
    ...
    BidirectionalIterator[dart.implements_] = () => [Iterator$(E)];
  ...
  const List$ = dart.generic(function(E) {
      ...
      static new(length) {
        ...
        if (length == null) {
          ...
          if (!(typeof length == 'number') || dart.notNull(length) < 0) {
            dart.throw_(new ArgumentError(`Length must be a non-negative integer: ${length}`));
          }
    ...
    List[dart.implements_] = () => [Iterable$(E)];
  ...
  const Map$ = dart.generic(function(K, V) {
    ...
    dart.setSignature(Map, {
      constructors: () => ({
        ...
        from: [Map$(K, V), [Map$()]],
        identity: [Map$(K, V), []],
        fromIterable: [Map$(K, V), [Iterable], {key: dart.functionType(K, [dart.dynamicR]), value: dart.functionType(V, [dart.dynamicR])}],
  ...
  class Null extends Object {
    static _uninstantiable() {
      dart.throw_(new UnsupportedError('class Null cannot be instantiated'));
    }
    toString() {
      return "null";
    }
  ...
  dart.fn(print, dart.voidR, [Object]);
  ...
  RegExp[dart.implements_] = () => [Pattern];
  ...
  const Set$ = dart.generic(function(E) {
    ...
    Set[dart.implements_] = () => [_internal.EfficientLength];
  ...
  class String extends Object {
    static fromCharCodes(charCodes, start, end) {
      ...
      if (dart.notNull(start) < 0 || dart.notNull(start) > dart.notNull(len)) {
        dart.throw_(new RangeError.range(start, 0, len));
      }
      if (end == null) {
        end = len;
      } else if (dart.notNull(end) < dart.notNull(start) || dart.notNull(end) > dart.notNull(len)) {
        dart.throw_(new RangeError.range(end, start, len));
      }
    ...
    static fromEnvironment(name, opts) {
      let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : null;
      dart.throw_(new UnsupportedError('String.fromEnvironment can only be used as a const constructor'));
    }
    static _stringFromIterable(charCodes, start, end) {
      if (dart.notNull(start) < 0) dart.throw_(new RangeError.range(start, 0, charCodes[dartx.length]));
      if (end != null && dart.notNull(end) < dart.notNull(start)) {
        dart.throw_(new RangeError.range(end, start, charCodes[dartx.length]));
      }
      let it = charCodes[dartx.iterator];
      for (let i = 0; dart.notNull(i) < dart.notNull(start); i = dart.notNull(i) + 1) {
        if (!dart.notNull(it.moveNext())) {
          dart.throw_(new RangeError.range(start, 0, i));
        }
      }
      let list = [];
      if (end == null) {
        ...
        for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
          if (!dart.notNull(it.moveNext())) {
            dart.throw_(new RangeError.range(end, start, i));
          }
          list[dartx.add](it.current);
        }
      }
  ...
  String[dart.implements_] = () => [Comparable$(String), Pattern];
      ...
      class Runes extends collection.IterableBase$(int) {
        ...
        get last() {
          if (this.string[dartx.length] == 0) {
            dart.throw_(new StateError('No elements.'));
          }
  ...
  class RuneIterator extends Object {
    ...
    [_checkSplitSurrogate](index) {
      if (dart.notNull(index) > 0 && dart.notNull(index) < dart.notNull(this.string[dartx.length]) && dart.notNull(_isLeadSurrogate(this.string[dartx.codeUnitAt](dart.notNull(index) - 1))) && dart.notNull(_isTrailSurrogate(this.string[dartx.codeUnitAt](index)))) {
        dart.throw_(new ArgumentError(`Index inside surrogate pair: ${index}`));
      }
    }
    get rawIndex() {
  ...
  RuneIterator[dart.implements_] = () => [BidirectionalIterator$(int)];
  ...
  dart.setSignature(RuneIterator, {
    ...
    methods: () => ({
      [_checkSplitSurrogate]: [dart.voidR, [int]],
      reset: [dart.voidR, [], [int]],
      moveNext: [bool, []],
      movePrevious: [bool, []]
    })
  });
  ...
  StringBuffer[dart.implements_] = () => [StringSink];
  dart.setSignature(StringBuffer, {
    constructors: () => ({StringBuffer: [StringBuffer, [], [Object]]}),
    methods: () => ({
      write: [dart.voidR, [Object]],
      writeCharCode: [dart.voidR, [int]],
      writeAll: [dart.voidR, [Iterable], [String]],
      writeln: [dart.voidR, [], [Object]],
      clear: [dart.voidR, []],
      [_writeString]: [dart.voidR, [dart.dynamicR]]
    })
  });
  ...
  class Uri extends Object {
    ...
    static _fail(uri, index, message) {
      dart.throw_(new FormatException(message, uri, index));
    }
      ...
      if (authority != null && dart.notNull(authority[dartx.isNotEmpty])) {
        ...
        if (dart.notNull(hostStart) < dart.notNull(authority[dartx.length]) && authority[dartx.codeUnitAt](hostStart) == Uri._LEFT_BRACKET) {
          ...
          if (hostEnd == authority[dartx.length]) {
            dart.throw_(new FormatException("Invalid IPv6 host entry.", authority, hostStart));
          }
          ...
          if (hostEnd != authority[dartx.length] && authority[dartx.codeUnitAt](hostEnd) != Uri._COLON) {
            dart.throw_(new FormatException("Invalid end of authority", authority, hostEnd));
          }
        }
        let hasPort = false;
        for (; dart.notNull(hostEnd) < dart.notNull(authority[dartx.length]); hostEnd = dart.notNull(hostEnd) + 1) {
    ...
    static get base() {
      ...
      dart.throw_(new UnsupportedError("'Uri.base' is not supported"));
    }
      ...
      segments[dartx.forEach](dart.fn(segment => {
        if (dart.notNull(segment[dartx.contains]("/"))) {
          if (dart.notNull(argumentError)) {
            dart.throw_(new ArgumentError(`Illegal path character ${segment}`));
          } else {
            dart.throw_(new UnsupportedError(`Illegal path character ${segment}`));
          }
        }
      }, dart.voidR, [String]));
    }
    static _checkWindowsPathReservedCharacters(segments, argumentError, firstSegment) {
      ...
      segments[dartx.skip](firstSegment)[dartx.forEach](dart.fn(segment => {
        if (dart.notNull(segment[dartx.contains](RegExp.new('["*/:<>?\\\\|]')))) {
          if (dart.notNull(argumentError)) {
            dart.throw_(new ArgumentError("Illegal character in path"));
          } else {
            dart.throw_(new UnsupportedError("Illegal character in path"));
          }
        }
      }, dart.voidR, [String]));
    }
    static _checkWindowsDriveLetter(charCode, argumentError) {
      ...
      if (dart.notNull(argumentError)) {
        dart.throw_(new ArgumentError("Illegal drive letter " + dart.notNull(String.fromCharCode(charCode))));
      } else {
        dart.throw_(new UnsupportedError("Illegal drive letter " + dart.notNull(String.fromCharCode(charCode))));
      }
    }
    ...
    static _makeWindowsFileUrl(path) {
      if (dart.notNull(path[dartx.startsWith]("\\\\?\\"))) {
        if (dart.notNull(path[dartx.startsWith]("\\\\?\\UNC\\"))) {
          ...
          if (dart.notNull(path[dartx.length]) < 3 || path[dartx.codeUnitAt](1) != Uri._COLON || path[dartx.codeUnitAt](2) != Uri._BACKSLASH) {
            dart.throw_(new ArgumentError("Windows paths with \\\\?\\ prefix must be absolute"));
          }
        }
      } else {
      ...
      if (dart.notNull(path[dartx.length]) > 1 && path[dartx.get](1) == ":") {
        ...
        if (path[dartx.length] == 2 || path[dartx.codeUnitAt](2) != Uri._BACKSLASH) {
          dart.throw_(new ArgumentError("Windows paths with drive letter must be absolute"));
        }
    ...
    get pathSegments() {
      if (this[_pathSegments] == null) {
        ...
        this[_pathSegments] = new (collection.UnmodifiableListView$(String))(pathToSplit == "" ? dart.const_(dart.list([], String)) : List$(String).from(pathToSplit[dartx.split]("/")[dartx.map](Uri.decodeComponent), {growable: false}));
      }
    ...
    static _makePath(path, start, end, pathSegments, ensureLeadingSlash, isFile) {
      ...
      if (path != null && pathSegments != null) {
        dart.throw_(new ArgumentError('Both path and pathSegments specified'));
      }
      let result = null;
      if (path != null) {
    ...
    static _makeQuery(query, start, end, queryParameters) {
      ...
      if (query != null && queryParameters != null) {
        dart.throw_(new ArgumentError('Both query and queryParameters specified'));
      }
    ...
    get origin() {
      if (this.scheme == "" || this[_host] == null || this[_host] == "") {
        dart.throw_(new StateError(`Cannot use origin without a scheme: ${this}`));
      }
      if (this.scheme != "http" && this.scheme != "https") {
        dart.throw_(new StateError(`Origin is only applicable schemes http and https: ${this}`));
      }
    ...
    toFilePath(opts) {
      ...
      if (this.scheme != "" && this.scheme != "file") {
        dart.throw_(new UnsupportedError(`Cannot extract a file path from a ${this.scheme} URI`));
      }
      if (this.query != "") {
        dart.throw_(new UnsupportedError("Cannot extract a file path from a URI with a query component"));
      }
      if (this.fragment != "") {
        dart.throw_(new UnsupportedError("Cannot extract a file path from a URI with a fragment component"));
      }
    ...
    [_toFilePath]() {
      if (this.host != "") {
        dart.throw_(new UnsupportedError("Cannot extract a non-Windows file path from a file URI " + "with an authority"));
      }
    ...
    get hashCode() {
      ...
      dart.fn(combine, int, [dart.dynamicR, dart.dynamicR]);
    ...
    static splitQueryString(query, opts) {
      ...
      return dart.as(query[dartx.split]("&")[dartx.fold](dart.map(), dart.fn((map, element) => {
        ...
        return map;
      }, dart.dynamicR, [dart.dynamicR, String])), Map$(String, String));
    }
    static parseIPv4Address(host) {
      function error(msg) {
        dart.throw_(new FormatException(`Illegal IPv4 address, ${msg}`));
      }
      dart.fn(error, dart.voidR, [String]);
      ...
      return dart.as(bytes[dartx.map](dart.fn(byteString => {
        ...
        return byte;
      }, dart.dynamicR, [String]))[dartx.toList](), List$(int));
    }
    static parseIPv6Address(host, start, end) {
      ...
      function error(msg, position) {
        ...
        dart.throw_(new FormatException(`Illegal IPv6 address, ${msg}`, host, dart.as(position, int)));
      }
      dart.fn(error, dart.voidR, [String], [dart.dynamicR]);
      ...
      for (let i = 0; dart.notNull(i) < 2; i = dart.notNull(i) + 1) {
        ...
        if (48 <= dart.notNull(charCode) && dart.notNull(charCode) <= 57) {
          ...
          if (97 <= dart.notNull(charCode) && dart.notNull(charCode) <= 102) {
            ...
            dart.throw_(new ArgumentError("Invalid URL encoding"));
          }
        }
      }
      return byte;
      ...
      if (dart.notNull(simple)) {
        ...
        for (let i = 0; dart.notNull(i) < dart.notNull(text[dartx.length]); i = dart.notNull(i) + 1) {
          ...
          if (dart.notNull(codeUnit) > 127) {
            dart.throw_(new ArgumentError("Illegal percent encoding in URI"));
          }
          if (codeUnit == Uri._PERCENT) {
            if (dart.notNull(i) + 3 > dart.notNull(text[dartx.length])) {
              dart.throw_(new ArgumentError('Truncated URI'));
            }
  ...
  dart.setSignature(Uri, {
    ...
    methods: () => ({
      ...
      [_writeAuthority]: [dart.voidR, [StringSink]]
    }),
    statics: () => ({
      _defaultPort: [int, [String]],
      parse: [Uri, [String]],
      _fail: [dart.voidR, [String, int, String]],
      _makeHttpUri: [Uri, [String, String, String, Map$(String, String)]],
      _checkNonWindowsPathReservedCharacters: [dart.dynamicR, [List$(String), bool]],
      _checkWindowsPathReservedCharacters: [dart.dynamicR, [List$(String), bool], [int]],
      _checkWindowsDriveLetter: [dart.dynamicR, [int, bool]],
      _makeFileUri: [dart.dynamicR, [String]],
      _makeWindowsFileUrl: [dart.dynamicR, [String]],
  ...
  Uri._BAR = 124;
  Uri._unreservedTable = dart.const_([0, 0, 24576, 1023, 65534, 34815, 65534, 18431]);
  Uri._unreserved2396Table = dart.const_([0, 0, 26498, 1023, 65534, 34815, 65534, 18431]);
  Uri._encodeFullTable = dart.const_([0, 0, 65498, 45055, 65535, 34815, 65534, 18431]);
  Uri._schemeTable = dart.const_([0, 0, 26624, 1023, 65534, 2047, 65534, 2047]);
  Uri._schemeLowerTable = dart.const_([0, 0, 26624, 1023, 0, 0, 65534, 2047]);
  Uri._subDelimitersTable = dart.const_([0, 0, 32722, 11263, 65534, 34815, 65534, 18431]);
  Uri._genDelimitersTable = dart.const_([0, 0, 32776, 33792, 1, 10240, 0, 0]);
  Uri._userinfoTable = dart.const_([0, 0, 32722, 12287, 65534, 34815, 65534, 18431]);
  Uri._regNameTable = dart.const_([0, 0, 32754, 11263, 65534, 34815, 65534, 18431]);
  Uri._pathCharTable = dart.const_([0, 0, 32722, 12287, 65535, 34815, 65534, 18431]);
  Uri._pathCharOrSlashTable = dart.const_([0, 0, 65490, 12287, 65535, 34815, 65534, 18431]);
  Uri._queryCharTable = dart.const_([0, 0, 65490, 45055, 65535, 34815, 65534, 18431]);
