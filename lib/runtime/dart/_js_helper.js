dart_library.library('dart/_js_helper', null, /* Imports */[
  ...
  dart.fn(defineProperty, dart.voidR, [dart.dynamicR, core.String, dart.dynamicR]);
  const _nativeRegExp = Symbol('_nativeRegExp');
  function regExpGetNative(regexp) {
    return regexp[_nativeRegExp];
  }
  dart.fn(regExpGetNative, () => dart.definiteFunctionType(dart.dynamicR, [JSSyntaxRegExp]));
  ...
  dart.fn(regExpGetGlobalNative, () => dart.definiteFunctionType(dart.dynamicR, [JSSyntaxRegExp]));
  ...
  class JSSyntaxRegExp extends core.Object {
    ...
    static makeNative(source, multiLine, caseSensitive, global) {
      ...
      dart.throw_(new core.FormatException(`Illegal RegExp pattern: ${source}, ${errorMessage}`));
    }
    firstMatch(string) {
    ...
    allMatches(string, start) {
      ...
      if (dart.notNull(start) < 0 || dart.notNull(start) > dart.notNull(string[dartx.length])) {
        dart.throw_(new core.RangeError.range(start, 0, string[dartx.length]));
      }
  ...
  JSSyntaxRegExp[dart.implements_] = () => [core.RegExp];
  dart.setSignature(JSSyntaxRegExp, {
    ...
    statics: () => ({makeNative: [dart.dynamicR, [core.String, core.bool, core.bool, core.bool]]}),
    names: ['makeNative']
  });
  ...
  _MatchImplementation[dart.implements_] = () => [core.Match];
  ...
  _AllMatchesIterator[dart.implements_] = () => [core.Iterator$(core.Match)];
  ...
  class StringMatch extends core.Object {
    ...
    group(group_) {
      if (group_ != 0) {
        dart.throw_(new core.RangeError.value(group_));
      }
      return this.pattern;
    }
    groups(groups_) {
  ...
  StringMatch[dart.implements_] = () => [core.Match];
  ...
  function stringReplaceAllUnchecked(receiver, from, to) {
    ...
    if (typeof from == 'string') {
      ...
      checkNull(from);
      dart.throw_("String.replaceAll(Pattern) UNIMPLEMENTED");
    }
  }
  ...
  function stringReplaceAllFuncUnchecked(receiver, pattern, onMatch, onNonMatch) {
    if (!dart.is(pattern, core.Pattern)) {
      dart.throw_(new core.ArgumentError(`${pattern} is not a Pattern`));
    }
  ...
  function stringReplaceFirstUnchecked(receiver, from, to, startIndex) {
    ...
    if (typeof from == 'string') {
      ...
      checkNull(from);
      dart.throw_("String.replace(Pattern) UNIMPLEMENTED");
    }
  }
  dart.fn(stringReplaceFirstUnchecked, dart.dynamicR, [dart.dynamicR, dart.dynamicR, dart.dynamicR], [core.int]);
  ...
  dart.fn(getRuntimeType, core.Type, [dart.dynamicR]);
  function getIndex(array, index) {
    dart.assert(isJsArray(array));
    return array[index];
  }
  dart.fn(getIndex, dart.dynamicR, [dart.dynamicR, core.int]);
  function getLength(array) {
    dart.assert(isJsArray(array));
    return array.length;
  }
  dart.fn(getLength, core.int, [dart.dynamicR]);
  function isJsArray(value) {
    return dart.is(value, _interceptors.JSArray);
  }
  dart.fn(isJsArray, core.bool, [dart.dynamicR]);
  ...
  const patch = dart.const_(new _Patch());
  ...
  class Primitives extends core.Object {
    ...
    static _throwFormatException(string) {
      dart.throw_(new core.FormatException(string));
    }
    static parseInt(source, radix, handleError) {
      ...
      if (radix == null) {
        ...
        if (!(typeof radix == 'number')) dart.throw_(new core.ArgumentError("Radix is not an integer"));
        if (dart.notNull(radix) < 2 || dart.notNull(radix) > 36) {
          dart.throw_(new core.RangeError(`Radix ${radix} not in range 2..36`));
        }
        if (match != null) {
    ...
    static stringFromCodePoints(codePoints) {
      ...
      for (let i of dart.as(codePoints, core.Iterable)) {
        if (!(typeof i == 'number')) dart.throw_(new core.ArgumentError(i));
        if (dart.notNull(dart.as(dart.dsend(i, '<=', 65535), core.bool))) {
          ...
          dart.throw_(new core.ArgumentError(i));
        }
      }
    ...
    static stringFromCharCodes(charCodes) {
      for (let i of dart.as(charCodes, core.Iterable)) {
        if (!(typeof i == 'number')) dart.throw_(new core.ArgumentError(i));
        if (dart.notNull(dart.as(dart.dsend(i, '<', 0), core.bool))) dart.throw_(new core.ArgumentError(i));
    ...
    static stringFromCharCode(charCode) {
      ...
      dart.throw_(new core.RangeError.range(dart.as(charCode, core.num), 0, 1114111));
    }
    ...
    static valueFromDateString(str) {
      if (!(typeof str == 'string')) dart.throw_(new core.ArgumentError(str));
      let value = Date.parse(str);
      if (dart.notNull(value[dartx.isNaN])) dart.throw_(new core.ArgumentError(str));
      return value;
    }
    static getProperty(object, key) {
      if (object == null || typeof object == 'boolean' || typeof object == 'number' || typeof object == 'string') {
        dart.throw_(new core.ArgumentError(object));
      }
      return object[key];
    }
  ...
  dart.setSignature(Primitives, {
    statics: () => ({
      initializeStatics: [dart.voidR, [core.int]],
      objectHashCode: [core.int, [dart.dynamicR]],
      _throwFormatException: [dart.dynamicR, [core.String]],
      ...
      dateNow: [core.int, []],
      initTicker: [dart.voidR, []],
      currentUri: [core.String, []],
      _fromCharCodeApply: [core.String, [core.List$(core.int)]],
      stringFromCodePoints: [core.String, [dart.dynamicR]],
      stringFromCharCodes: [core.String, [dart.dynamicR]],
      stringFromCharCode: [core.String, [dart.dynamicR]],
      stringConcatUnchecked: [core.String, [core.String, core.String]],
      flattenString: [core.String, [core.String]],
      getTimeZoneName: [core.String, [dart.dynamicR]],
      getTimeZoneOffsetInMinutes: [core.int, [dart.dynamicR]],
      valueFromDecomposedDate: [dart.dynamicR, [dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      patchUpY2K: [dart.dynamicR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      lazyAsJsDate: [dart.dynamicR, [dart.dynamicR]],
      getYear: [dart.dynamicR, [dart.dynamicR]],
      getMonth: [dart.dynamicR, [dart.dynamicR]],
      getDay: [dart.dynamicR, [dart.dynamicR]],
      getHours: [dart.dynamicR, [dart.dynamicR]],
      getMinutes: [dart.dynamicR, [dart.dynamicR]],
      getSeconds: [dart.dynamicR, [dart.dynamicR]],
      getMilliseconds: [dart.dynamicR, [dart.dynamicR]],
      getWeekday: [dart.dynamicR, [dart.dynamicR]],
      valueFromDateString: [dart.dynamicR, [dart.dynamicR]],
      getProperty: [dart.dynamicR, [dart.dynamicR, dart.dynamicR]],
      setProperty: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      identicalImplementation: [core.bool, [dart.dynamicR, dart.dynamicR]],
  ...
  function checkNull(object) {
    if (object == null) dart.throw_(new core.ArgumentError(null));
    return object;
  }
  dart.fn(checkNull);
  function checkNum(value) {
    if (!(typeof value == 'number')) {
      dart.throw_(new core.ArgumentError(value));
    }
    return value;
  }
  dart.fn(checkNum);
  ...
  function throwRuntimeError(message) {
    dart.throw_(new RuntimeError(message));
  }
  dart.fn(throwRuntimeError);
  function throwAbstractClassInstantiationError(className) {
    dart.throw_(new core.AbstractClassInstantiationError(dart.as(className, core.String)));
  }
  ...
  NullError[dart.implements_] = () => [core.NoSuchMethodError];
  dart.setSignature(NullError, {
    constructors: () => ({NullError: [NullError, [core.String, dart.dynamicR]]})
  });
  ...
  JsNoSuchMethodError[dart.implements_] = () => [core.NoSuchMethodError];
  dart.setSignature(JsNoSuchMethodError, {
    constructors: () => ({JsNoSuchMethodError: [JsNoSuchMethodError, [core.String, dart.dynamicR]]})
  });
  ...
  dart.fn(getTraceFromException, core.StackTrace, [dart.dynamicR]);
  ...
  _StackTrace[dart.implements_] = () => [core.StackTrace];
  dart.setSignature(_StackTrace, {
    constructors: () => ({_StackTrace: [_StackTrace, [dart.dynamicR]]})
  });
  ...
  dart.fn(objectHashCode, core.int, [dart.dynamicR]);
  ...
  dart.fn(fillLiteralMap, dart.dynamicR, [dart.dynamicR, core.Map]);
  function jsHasOwnProperty(jsObject, property) {
    return jsObject.hasOwnProperty(property);
  }
  dart.fn(jsHasOwnProperty, core.bool, [dart.dynamicR, core.String]);
  function jsPropertyAccess(jsObject, property) {
    return jsObject[property];
  }
  dart.fn(jsPropertyAccess, dart.dynamicR, [dart.dynamicR, core.String]);
  ...
  TypeErrorImplementation[dart.implements_] = () => [core.TypeError];
  ...
  CastErrorImplementation[dart.implements_] = () => [core.CastError];
  ...
  dart.setSignature(RuntimeError, {
    constructors: () => ({RuntimeError: [RuntimeError, [dart.dynamicR]]})
  });
  function random64() {
  ...
  const SyncIterator$ = dart.generic(function(E) {
    ...
    SyncIterator[dart.implements_] = () => [core.Iterator$(E)];
    dart.setSignature(SyncIterator, {
      constructors: () => ({SyncIterator: [SyncIterator$(E), [dart.dynamicR]]}),
      methods: () => ({moveNext: [core.bool, []]})
    });
    return SyncIterator;
  });
  ...
  const SyncIterable$ = dart.generic(function(E) {
    ...
    dart.setSignature(SyncIterable, {
      constructors: () => ({SyncIterable: [SyncIterable$(E), [dart.dynamicR, dart.dynamicR]]}),
      methods: () => ({[_jsIterator]: [dart.dynamicR, []]})
    });
