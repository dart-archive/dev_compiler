dart_library.library('dart/_js_helper', null, /* Imports */[
  ...
  class JSSyntaxRegExp extends core.Object {
    ...
    hasMatch(string) {
      return dart.as(this[_nativeRegExp].test(checkString(string)), core.bool);
    }
    stringMatch(string) {
  ...
  class Primitives extends core.Object {
    ...
    static dateNow() {
      return dart.as(Date.now(), core.int);
    }
    static initTicker() {
      ...
      Primitives.timerTicks = dart.fn(() => (1000 * dart.notNull(dart.as(performance.now(), core.num)))[dartx.floor](), core.int, []);
    }
    static get isD8() {
    ...
    static getTimeZoneOffsetInMinutes(receiver) {
      return dart.as(dart.dsend(Primitives.lazyAsJsDate(receiver).getTimezoneOffset(), 'unary-'), core.int);
    }
    ...
    static getWeekday(receiver) {
      let weekday = dart.notNull(dart.as(dart.dload(receiver, 'isUtc'), core.bool)) ? dart.as(Primitives.lazyAsJsDate(receiver).getUTCDay() + 0, core.int) : dart.as(Primitives.lazyAsJsDate(receiver).getDay() + 0, core.int);
