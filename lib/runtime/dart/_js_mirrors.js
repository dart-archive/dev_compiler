dart_library.library('dart/_js_mirrors', null, /* Imports */[
  ...
  exports[dart.uri] = 'dart:_js_mirrors';
  ...
  function realRuntimeType(obj) {
    return _dart.realRuntimeType(obj);
  }
  dart.fn(realRuntimeType);
  ...
  class JsInstanceMirror extends core.Object {
    ...
    get function() {
      return new JsMethodMirror._method(this.reflectee);
    }
    get type() {
  ...
  JsInstanceMirror[dart.owner] = exports;
  class JsLibraryMirror extends core.Object {
    _(libraryObject) {
      this.libraryObject = libraryObject;
    }
    get uri() {
      return this.libraryObject[dart.uri];
    }
  }
  JsLibraryMirror[dart.implements] = () => [mirrors.LibraryMirror];
  dart.defineNamedConstructor(JsLibraryMirror, '_');
  dart.setSignature(JsLibraryMirror, {
    constructors: () => ({_: [JsLibraryMirror, [dart.dynamic]]})
  });
  JsLibraryMirror[dart.owner] = exports;
  ...
  class JsClassMirror extends core.Object {
    ...
    _(cls) {
      ...
      let map = dart.as(fn == null ? dart.map() : dart.dcall(fn), core.Map);
      let typedata = map[dartx.get]('type');
      this[_metadata] = typedata == null ? [] : core.List$(mirrors.InstanceMirror).from(dart.as(dart.dsend(typedata, 'map', dart.fn(i => new JsInstanceMirror._(i), JsInstanceMirror, [dart.dynamic])), core.Iterable));
      this[_owner] = new JsLibraryMirror._(this[_cls][dart.owner]);
      ...
      let properties = dart.as(map[dartx.get]('properties'), core.Map);
      if (properties != null) {
        properties[dartx.forEach](dart.fn((name, annotations) => {
          let symbol = core.Symbol.new(name);
          let metadata = core.List$(mirrors.InstanceMirror).from(annotations[dartx.map](dart.fn(i => new JsInstanceMirror._(i), JsInstanceMirror, [dart.dynamic])));
          this[_declarations][dartx.set](symbol, new JsMethodMirror._(this, null, metadata));
        }, dart.void, [core.String, core.List]));
      }
      let fields = dart.as(map[dartx.get]('fields'), core.Map);
      if (fields != null) {
        fields[dartx.forEach](dart.fn((name, annotations) => {
          let symbol = core.Symbol.new(name);
          let metadata = core.List$(mirrors.InstanceMirror).from(annotations[dartx.map](dart.fn(i => new JsInstanceMirror._(i), JsInstanceMirror, [dart.dynamic])));
          this[_declarations][dartx.set](symbol, new JsMethodMirror._(this, null, metadata));
        }, dart.void, [core.String, core.List]));
    ...
    newInstance(constructorName, args, namedArgs) {
      ...
      let instance = null;
      if (this[_cls].new) {
        instance = this[_cls].new(...args);
      } else {
        instance = new this[_cls](...args);
      }
  ...
  JsClassMirror[dart.owner] = exports;
  ...
  JsTypeMirror[dart.owner] = exports;
  ...
  JsParameterMirror[dart.owner] = exports;
  ...
  class JsMethodMirror extends core.Object {
    _(cls, method, metadata) {
      ...
      if (this[_method] != null) {
        ...
        if (ftype == null) {
          ftype = _dart.classGetConstructorType(cls[_cls], "new");
        }
    ...
    _method(method) {
      ...
      this[_params] = null;
      this[_metadata] = null;
      let ftype = realRuntimeType(method);
      this[_params] = this[_createParameterMirrorList](ftype);
    }
    get constructorName() {
  ...
  dart.defineNamedConstructor(JsMethodMirror, '_method');
  dart.setSignature(JsMethodMirror, {
    constructors: () => ({
      _: [JsMethodMirror, [JsClassMirror, dart.dynamic, core.List$(mirrors.InstanceMirror)]],
      _method: [JsMethodMirror, [dart.dynamic]]
    }),
    methods: () => ({[_createParameterMirrorList]: [core.List$(mirrors.ParameterMirror), [dart.dynamic]]})
  });
  JsMethodMirror[dart.owner] = exports;
  // Exports:
  ...
  exports.JsLibraryMirror = JsLibraryMirror;
