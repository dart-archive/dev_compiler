dart_library.library('dart/_js_mirrors', null, /* Imports */[
  ...
  class JsClassMirror extends core.Object {
    ...
    _(cls) {
      ...
      this[_metadata] = fn == null ? [] : core.List$(mirrors.InstanceMirror).from(dart.as(dart.dsend(dart.dcall(fn), 'map', dart.fn(i => new JsInstanceMirror._(i), JsInstanceMirror, [dart.dynamic])), core.Iterable));
  ...
  dart.setSignature(JsMethodMirror, {
    constructors: () => ({
      _: [JsMethodMirror, [JsClassMirror, dart.dynamic]],
