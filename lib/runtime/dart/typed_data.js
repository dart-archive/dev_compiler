dart_library.library('dart/typed_data', null, /* Imports */[
  ...
  Endianness.BIG_ENDIAN = dart.const_(new Endianness._(false));
  Endianness.LITTLE_ENDIAN = dart.const_(new Endianness._(true));
  ...
  ByteData[dart.implements_] = () => [TypedData];
  ...
  Int8List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Uint8List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Uint8ClampedList[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Int16List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Uint16List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Int32List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Uint32List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Int64List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Uint64List[dart.implements_] = () => [core.List$(core.int), TypedData];
  ...
  Float32List[dart.implements_] = () => [core.List$(core.double), TypedData];
  ...
  Float64List[dart.implements_] = () => [core.List$(core.double), TypedData];
  ...
  Float32x4List[dart.implements_] = () => [core.List$(Float32x4), TypedData];
  ...
  Int32x4List[dart.implements_] = () => [core.List$(Int32x4), TypedData];
  ...
  Float64x2List[dart.implements_] = () => [core.List$(Float64x2), TypedData];
