dart_library.library('dart/_native_typed_data', null, /* Imports */[
  ...
  exports[dart.uri] = 'dart:_native_typed_data';
  ...
  NativeByteBuffer[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("ArrayBuffer"))], 'properties', dart.map(['lengthInBytes', [dart.const(new _js_helper.JSName('byteLength'))]])]);
  NativeByteBuffer[dart.owner] = exports;
  ...
  NativeFloat32x4List[dart.owner] = exports;
  ...
  NativeInt32x4List[dart.owner] = exports;
  ...
  NativeFloat64x2List[dart.owner] = exports;
  dart.defineExtensionNames([
    'buffer',
    'lengthInBytes',
    'offsetInBytes',
  ...
  NativeTypedData[dart.metadata] = () => dart.map(['properties', dart.map(['buffer', [dart.const(new _js_helper.Creates('NativeByteBuffer')), dart.const(new _js_helper.Returns('NativeByteBuffer|Null'))], 'lengthInBytes', [dart.const(new _js_helper.JSName('byteLength'))], 'offsetInBytes', [dart.const(new _js_helper.JSName('byteOffset'))], 'elementSizeInBytes', [dart.const(new _js_helper.JSName('BYTES_PER_ELEMENT'))]])]);
  ...
  NativeByteData[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("DataView"))]]);
  NativeByteData[dart.owner] = exports;
  ...
  NativeFloat32List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Float32Array"))]]);
  NativeFloat32List[dart.owner] = exports;
  ...
  NativeFloat64List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Float64Array"))]]);
  NativeFloat64List[dart.owner] = exports;
  ...
  NativeInt16List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Int16Array"))]]);
  NativeInt16List[dart.owner] = exports;
  ...
  NativeInt32List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Int32Array"))]]);
  NativeInt32List[dart.owner] = exports;
  ...
  NativeInt8List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Int8Array"))]]);
  NativeInt8List[dart.owner] = exports;
  ...
  NativeUint16List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Uint16Array"))]]);
  NativeUint16List[dart.owner] = exports;
  ...
  NativeUint32List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Uint32Array"))]]);
  NativeUint32List[dart.owner] = exports;
  ...
  NativeUint8ClampedList[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Uint8ClampedArray,CanvasPixelArray"))]]);
  NativeUint8ClampedList[dart.owner] = exports;
  ...
  NativeUint8List[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.Native("Uint8Array,!nonleaf"))]]);
  NativeUint8List[dart.owner] = exports;
  ...
  NativeFloat32x4[dart.owner] = exports;
  ...
  NativeInt32x4[dart.owner] = exports;
  ...
  NativeFloat64x2[dart.owner] = exports;
