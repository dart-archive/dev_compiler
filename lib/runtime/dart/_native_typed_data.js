dart_library.library('dart/_native_typed_data', null, /* Imports */[
  ...
  NativeByteBuffer[dart.implements_] = () => [typed_data.ByteBuffer];
  ...
  NativeByteBuffer[dart.metadata] = () => [dart.const_(new _js_helper.Native("ArrayBuffer"))];
  ...
  class NativeFloat32x4List extends dart.mixin(core.Object, collection.ListMixin$(typed_data.Float32x4), _internal.FixedLengthListMixin$(typed_data.Float32x4)) {
    ...
    [_invalidIndex](index, length) {
      if (dart.notNull(index) < 0 || dart.notNull(index) >= dart.notNull(length)) {
        if (length == this.length) {
          dart.throw_(core.RangeError.index(index, this));
        }
        dart.throw_(new core.RangeError.range(index, 0, dart.notNull(length) - 1));
      } else {
        dart.throw_(new core.ArgumentError(`Invalid list index ${index}`));
      }
    }
    ...
    [_checkSublistArguments](start, end, length) {
      ...
      if (dart.notNull(start) > dart.notNull(end)) dart.throw_(new core.RangeError.range(start, 0, end));
      return end;
    }
    get length() {
  ...
  NativeFloat32x4List[dart.implements_] = () => [typed_data.Float32x4List];
  ...
  dart.setSignature(NativeFloat32x4List, {
    ...
    methods: () => ({
      [_invalidIndex]: [dart.voidR, [core.int, core.int]],
      [_checkIndex]: [dart.voidR, [core.int, core.int]],
      [_checkSublistArguments]: [core.int, [core.int, core.int, core.int]],
      get: [typed_data.Float32x4, [core.int]],
      set: [dart.voidR, [core.int, typed_data.Float32x4]],
  ...
  NativeInt32x4List[dart.implements_] = () => [typed_data.Int32x4List];
  ...
  dart.setSignature(NativeInt32x4List, {
    ...
    methods: () => ({
      ...
      set: [dart.voidR, [core.int, typed_data.Int32x4]],
  ...
  NativeFloat64x2List[dart.implements_] = () => [typed_data.Float64x2List];
  ...
  dart.setSignature(NativeFloat64x2List, {
    ...
    methods: () => ({
      ...
      set: [dart.voidR, [core.int, typed_data.Float64x2]],
  ...
  NativeTypedData[dart.implements_] = () => [typed_data.TypedData];
  ...
  NativeTypedData[dart.metadata] = () => [dart.const_(new _js_helper.Native("ArrayBufferView"))];
  function _checkLength(length) {
    if (!(typeof length == 'number')) dart.throw_(new core.ArgumentError(`Invalid length ${length}`));
    return dart.as(length, core.int);
  }
  dart.fn(_checkLength, core.int, [dart.dynamicR]);
  function _checkViewArguments(buffer, offsetInBytes, length) {
    if (!dart.is(buffer, NativeByteBuffer)) {
      dart.throw_(new core.ArgumentError('Invalid view buffer'));
    }
    if (!(typeof offsetInBytes == 'number')) {
      dart.throw_(new core.ArgumentError(`Invalid view offsetInBytes ${offsetInBytes}`));
    }
    if (length != null && !(typeof length == 'number')) {
      dart.throw_(new core.ArgumentError(`Invalid view length ${length}`));
    }
  }
  dart.fn(_checkViewArguments, dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]);
  ...
  class NativeByteData extends NativeTypedData {
    ...
    getInt64(byteOffset, endian) {
      if (endian === void 0) endian = typed_data.Endianness.BIG_ENDIAN;
      dart.throw_(new core.UnsupportedError('Int64 accessor not supported by dart2js.'));
    }
    ...
    getUint64(byteOffset, endian) {
      if (endian === void 0) endian = typed_data.Endianness.BIG_ENDIAN;
      dart.throw_(new core.UnsupportedError('Uint64 accessor not supported by dart2js.'));
    }
  ...
  NativeByteData[dart.implements_] = () => [typed_data.ByteData];
  dart.setSignature(NativeByteData, {
    ...
    methods: () => ({
      ...
      setFloat32: [dart.voidR, [core.int, core.num], [typed_data.Endianness]],
      [_setFloat32]: [dart.voidR, [core.int, core.num], [core.bool]],
      setFloat64: [dart.voidR, [core.int, core.num], [typed_data.Endianness]],
      [_setFloat64]: [dart.voidR, [core.int, core.num], [core.bool]],
      setInt16: [dart.voidR, [core.int, core.int], [typed_data.Endianness]],
      [_setInt16]: [dart.voidR, [core.int, core.int], [core.bool]],
      setInt32: [dart.voidR, [core.int, core.int], [typed_data.Endianness]],
      [_setInt32]: [dart.voidR, [core.int, core.int], [core.bool]],
      setInt64: [dart.voidR, [core.int, core.int], [typed_data.Endianness]],
      setInt8: [dart.voidR, [core.int, core.int]],
      setUint16: [dart.voidR, [core.int, core.int], [typed_data.Endianness]],
      [_setUint16]: [dart.voidR, [core.int, core.int], [core.bool]],
      setUint32: [dart.voidR, [core.int, core.int], [typed_data.Endianness]],
      [_setUint32]: [dart.voidR, [core.int, core.int], [core.bool]],
      setUint64: [dart.voidR, [core.int, core.int], [typed_data.Endianness]],
      setUint8: [dart.voidR, [core.int, core.int]]
    }),
    statics: () => ({
      _create1: [NativeByteData, [dart.dynamicR]],
      _create2: [NativeByteData, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeByteData, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  NativeByteData[dart.metadata] = () => [dart.const_(new _js_helper.Native("DataView"))];
  ...
  class NativeTypedArray extends NativeTypedData {
    [_setRangeFast](start, end, source, skipCount) {
      ...
      if (dart.notNull(sourceLength) - dart.notNull(skipCount) < dart.notNull(count)) {
        dart.throw_(new core.StateError('Not enough elements'));
      }
  ...
  NativeTypedArray[dart.implements_] = () => [_js_helper.JavaScriptIndexingBehavior];
  dart.setSignature(NativeTypedArray, {
    methods: () => ({[_setRangeFast]: [dart.voidR, [core.int, core.int, NativeTypedArray, core.int]]})
  });
  ...
  dart.setSignature(NativeTypedArrayOfDouble, {
    methods: () => ({
      ...
      set: [dart.voidR, [core.int, core.num]],
      setRange: [dart.voidR, [core.int, core.int, core.Iterable$(core.double)], [core.int]]
    })
  });
  ...
  NativeTypedArrayOfInt[dart.implements_] = () => [core.List$(core.int)];
  dart.setSignature(NativeTypedArrayOfInt, {
    methods: () => ({
      set: [dart.voidR, [core.int, core.int]],
      setRange: [dart.voidR, [core.int, core.int, core.Iterable$(core.int)], [core.int]]
    })
  });
  ...
  NativeFloat32List[dart.implements_] = () => [typed_data.Float32List];
  dart.setSignature(NativeFloat32List, {
    ...
    statics: () => ({
      _create1: [NativeFloat32List, [dart.dynamicR]],
      _create2: [NativeFloat32List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeFloat32List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeFloat32List, ['sublist']);
  NativeFloat32List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Float32Array"))];
  ...
  NativeFloat64List[dart.implements_] = () => [typed_data.Float64List];
  dart.setSignature(NativeFloat64List, {
    ...
    methods: () => ({sublist: [core.List$(core.double), [core.int], [core.int]]}),
    statics: () => ({
      _create1: [NativeFloat64List, [dart.dynamicR]],
      _create2: [NativeFloat64List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeFloat64List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeFloat64List, ['sublist']);
  NativeFloat64List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Float64Array"))];
  ...
  NativeInt16List[dart.implements_] = () => [typed_data.Int16List];
  dart.setSignature(NativeInt16List, {
    ...
    statics: () => ({
      _create1: [NativeInt16List, [dart.dynamicR]],
      _create2: [NativeInt16List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeInt16List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeInt16List, ['get', 'sublist']);
  NativeInt16List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Int16Array"))];
  ...
  NativeInt32List[dart.implements_] = () => [typed_data.Int32List];
  dart.setSignature(NativeInt32List, {
    ...
    statics: () => ({
      _create1: [NativeInt32List, [dart.dynamicR]],
      _create2: [NativeInt32List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeInt32List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeInt32List, ['get', 'sublist']);
  NativeInt32List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Int32Array"))];
  ...
  NativeInt8List[dart.implements_] = () => [typed_data.Int8List];
  dart.setSignature(NativeInt8List, {
    ...
    statics: () => ({
      _create1: [NativeInt8List, [dart.dynamicR]],
      _create2: [NativeInt8List, [dart.dynamicR, dart.dynamicR]],
      _create3: [typed_data.Int8List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeInt8List, ['get', 'sublist']);
  NativeInt8List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Int8Array"))];
  ...
  NativeUint16List[dart.implements_] = () => [typed_data.Uint16List];
  dart.setSignature(NativeUint16List, {
    ...
    statics: () => ({
      _create1: [NativeUint16List, [dart.dynamicR]],
      _create2: [NativeUint16List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeUint16List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeUint16List, ['get', 'sublist']);
  NativeUint16List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Uint16Array"))];
  ...
  NativeUint32List[dart.implements_] = () => [typed_data.Uint32List];
  dart.setSignature(NativeUint32List, {
    ...
    statics: () => ({
      _create1: [NativeUint32List, [dart.dynamicR]],
      _create2: [NativeUint32List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeUint32List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeUint32List, ['get', 'sublist']);
  NativeUint32List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Uint32Array"))];
  ...
  NativeUint8ClampedList[dart.implements_] = () => [typed_data.Uint8ClampedList];
  dart.setSignature(NativeUint8ClampedList, {
    ...
    statics: () => ({
      _create1: [NativeUint8ClampedList, [dart.dynamicR]],
      _create2: [NativeUint8ClampedList, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeUint8ClampedList, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeUint8ClampedList, ['get', 'sublist', 'length']);
  NativeUint8ClampedList[dart.metadata] = () => [dart.const_(new _js_helper.Native("Uint8ClampedArray,CanvasPixelArray"))];
  ...
  NativeUint8List[dart.implements_] = () => [typed_data.Uint8List];
  dart.setSignature(NativeUint8List, {
    ...
    statics: () => ({
      _create1: [NativeUint8List, [dart.dynamicR]],
      _create2: [NativeUint8List, [dart.dynamicR, dart.dynamicR]],
      _create3: [NativeUint8List, [dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    names: ['_create1', '_create2', '_create3']
  });
  dart.defineExtensionMembers(NativeUint8List, ['get', 'sublist', 'length']);
  NativeUint8List[dart.metadata] = () => [dart.const_(new _js_helper.Native("Uint8Array,!nonleaf"))];
  class NativeFloat32x4 extends core.Object {
    ...
    NativeFloat32x4(x, y, z, w) {
      ...
      if (!(typeof x == 'number')) dart.throw_(new core.ArgumentError(x));
      if (!(typeof y == 'number')) dart.throw_(new core.ArgumentError(y));
      if (!(typeof z == 'number')) dart.throw_(new core.ArgumentError(z));
      if (!(typeof w == 'number')) dart.throw_(new core.ArgumentError(w));
    }
    splat(v) {
    ...
    shuffle(m) {
      if (dart.notNull(m) < 0 || dart.notNull(m) > 255) {
        dart.throw_(new core.RangeError(`mask ${m} must be in the range [0..256)`));
      }
      NativeFloat32x4._list.set(0, this.x);
      NativeFloat32x4._list.set(1, this.y);
      NativeFloat32x4._list.set(2, this.z);
  ...
  NativeFloat32x4[dart.implements_] = () => [typed_data.Float32x4];
  ...
  dart.setSignature(NativeFloat32x4, {
    ...
    statics: () => ({_truncate: [dart.dynamicR, [dart.dynamicR]]}),
    names: ['_truncate']
  });
  ...
  class NativeInt32x4 extends core.Object {
    ...
    NativeInt32x4(x, y, z, w) {
      ...
      if (x != this.x && !(typeof x == 'number')) dart.throw_(new core.ArgumentError(x));
      if (y != this.y && !(typeof y == 'number')) dart.throw_(new core.ArgumentError(y));
      if (z != this.z && !(typeof z == 'number')) dart.throw_(new core.ArgumentError(z));
      if (w != this.w && !(typeof w == 'number')) dart.throw_(new core.ArgumentError(w));
    }
    bool(x, y, z, w) {
    ...
    shuffle(mask) {
      if (dart.notNull(mask) < 0 || dart.notNull(mask) > 255) {
        dart.throw_(new core.RangeError(`mask ${mask} must be in the range [0..256)`));
      }
  ...
  NativeInt32x4[dart.implements_] = () => [typed_data.Int32x4];
  ...
  class NativeFloat64x2 extends core.Object {
    NativeFloat64x2(x, y) {
      this.x = x;
      this.y = y;
      if (!(typeof this.x == 'number')) dart.throw_(new core.ArgumentError(this.x));
      if (!(typeof this.y == 'number')) dart.throw_(new core.ArgumentError(this.y));
    }
    splat(v) {
  ...
  NativeFloat64x2[dart.implements_] = () => [typed_data.Float64x2];
