dart_library.library('dart/convert', null, /* Imports */[
  ...
  _UnicodeSubsetEncoder[dart.owner] = exports;
  ...
  AsciiEncoder[dart.owner] = exports;
  ...
  StringConversionSinkMixin[dart.owner] = exports;
  class StringConversionSinkBase extends StringConversionSinkMixin {}
  StringConversionSinkBase[dart.owner] = exports;
  ...
  _UnicodeSubsetEncoderSink[dart.owner] = exports;
  ...
  _UnicodeSubsetDecoder[dart.owner] = exports;
  ...
  AsciiDecoder[dart.owner] = exports;
  ...
  const ChunkedConversionSink$ = dart.generic(function(T) {
    ...
    ChunkedConversionSink[dart.owner] = exports;
  ...
  ByteConversionSink[dart.owner] = exports;
  ...
  ByteConversionSinkBase[dart.owner] = exports;
    ...
    addSlice(source, start, end, isLast) {
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        if ((dart.notNull(source[dartx.get](i)) & ~dart.notNull(_ASCII_MASK)) != 0) {
          ...
          this[_utf8Sink].add(dart.const([239, 191, 189]));
  ...
  _ErrorHandlingAsciiDecoderSink[dart.owner] = exports;
  ...
  _SimpleAsciiDecoderSink[dart.owner] = exports;
  ...
  _ByteAdapterSink[dart.owner] = exports;
  ...
  _ByteCallbackSink[dart.owner] = exports;
  ...
  const _SimpleCallbackSink$ = dart.generic(function(T) {
    ...
    _SimpleCallbackSink[dart.owner] = exports;
  ...
  const _EventSinkAdapter$ = dart.generic(function(T) {
    ...
    _EventSinkAdapter[dart.owner] = exports;
  ...
  const _ConverterStreamEventSink$ = dart.generic(function(S, T) {
    ...
    _ConverterStreamEventSink[dart.owner] = exports;
  ...
  const _FusedCodec$ = dart.generic(function(S, M, T) {
    ...
    _FusedCodec[dart.owner] = exports;
    return _FusedCodec;
  });
  ...
  const _InvertedCodec$ = dart.generic(function(T, S) {
    ...
    _InvertedCodec[dart.owner] = exports;
  ...
  const _FusedConverter$ = dart.generic(function(S, M, T) {
    ...
    _FusedConverter[dart.owner] = exports;
  ...
  HtmlEscapeMode[dart.owner] = exports;
  ...
  _HtmlEscapeSink[dart.owner] = exports;
  ...
  JsonUnsupportedObjectError[dart.owner] = exports;
  ...
  JsonCyclicError[dart.owner] = exports;
  ...
  JsonEncoder[dart.owner] = exports;
  ...
  JsonUtf8Encoder[dart.owner] = exports;
  ...
  _JsonEncoderSink[dart.owner] = exports;
  ...
  _JsonUtf8EncoderSink[dart.owner] = exports;
  ...
  JsonDecoder[dart.owner] = exports;
  ...
  _JsonStringifier[dart.owner] = exports;
  ...
  _JsonPrettyPrintMixin[dart.owner] = exports;
  ...
  _JsonStringStringifier[dart.owner] = exports;
  ...
  _JsonStringStringifierPretty[dart.owner] = exports;
  ...
  _JsonUtf8Stringifier[dart.owner] = exports;
  ...
  _JsonUtf8StringifierPretty[dart.owner] = exports;
  ...
  Latin1Codec[dart.owner] = exports;
  ...
  Latin1Encoder[dart.owner] = exports;
  ...
  Latin1Decoder[dart.owner] = exports;
  ...
  _Latin1DecoderSink[dart.owner] = exports;
    ...
    addSlice(source, start, end, isLast) {
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        ...
        if (dart.notNull(char) > dart.notNull(_LATIN1_MASK) || dart.notNull(char) < 0) {
          ...
          this[_addSliceToSink](dart.const([65533]), 0, 1, false);
          start = dart.notNull(i) + 1;
        }
      }
      if (dart.notNull(start) < dart.notNull(end)) {
  ...
  _Latin1AllowInvalidDecoderSink[dart.owner] = exports;
  ...
  LineSplitter[dart.owner] = exports;
  ...
  _LineSplitterSink[dart.owner] = exports;
  ...
  StringConversionSink[dart.owner] = exports;
  ...
  ClosableStringSink[dart.owner] = exports;
  ...
  _ClosableStringSink[dart.owner] = exports;
  ...
  _StringConversionSinkAsStringSinkAdapter[dart.owner] = exports;
  ...
  _StringSinkConversionSink[dart.owner] = exports;
  ...
  _StringCallbackSink[dart.owner] = exports;
  ...
  _StringAdapterSink[dart.owner] = exports;
  ...
  _Utf8StringSinkAdapter[dart.owner] = exports;
  ...
  _Utf8ConversionSink[dart.owner] = exports;
  ...
  Utf8Encoder[dart.owner] = exports;
  ...
  _Utf8Encoder[dart.owner] = exports;
  ...
  _Utf8EncoderSink[dart.owner] = exports;
  ...
  Utf8Decoder[dart.owner] = exports;
  ...
  _Utf8Decoder[dart.owner] = exports;
  _Utf8Decoder._LIMITS = dart.const([_ONE_BYTE_LIMIT, _TWO_BYTE_LIMIT, _THREE_BYTE_LIMIT, _FOUR_BYTE_LIMIT]);
  ...
  _JsonMapKeyIterable[dart.owner] = exports;
  ...
  _JsonDecoderSink[dart.owner] = exports;
  // Exports:
  exports.Codec$ = Codec$;
  exports.Codec = Codec;
