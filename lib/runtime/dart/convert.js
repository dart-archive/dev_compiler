dart_library.library('dart/convert', null, /* Imports */[
  ...
  class _HtmlEscapeSink extends StringConversionSinkBase {
    ...
    addSlice(chunk, start, end, isLast) {
      ...
      if (val == null) {
        ...
        this[_sink].add(dart.as(val, core.String));
        if (dart.notNull(isLast))
          this[_sink].close();
      }
    }
  ...
  class JsonUtf8Encoder extends Converter$(core.Object, core.List$(core.int)) {
    ...
    convert(object) {
      ...
      for (let i = 0, offset = 0; dart.notNull(i) < dart.notNull(bytes[dartx.length]); i = dart.notNull(i) + 1) {
        ...
        let end = dart.asInt(dart.notNull(offset) + dart.notNull(dart.as(dart.dload(byteList, 'length'), core.num)));
        result.setRange(offset, end, dart.as(byteList, core.Iterable$(core.int)));
        offset = end;
      }
      return result;
    }
  ...
  class LineSplitter extends Converter$(core.String, core.List$(core.String)) {
    ...
    convert(data) {
      ...
      _LineSplitterSink._addSlice(data, 0, data[dartx.length], true, dart.as(dart.dload(lines, 'add'), __CastType6));
  ...
  let __CastType6 = dart.typedef('__CastType6', () => dart.functionType(dart.void, [core.String]));
  ...
  class _StringConversionSinkAsStringSinkAdapter extends core.Object {
    ...
    writeAll(objects, separator) {
      ...
      if (dart.notNull(separator[dartx.isEmpty])) {
        do {
          this[_chunkedSink].add(dart.as(dart.dsend(iterator.current, 'toString'), core.String));
