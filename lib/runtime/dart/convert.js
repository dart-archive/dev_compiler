dart_library.library('dart/convert', null, /* Imports */[
  ...
  const Codec$ = dart.generic(function(S, T) {
    class Codec extends core.Object {
      ...
      fuse(other) {
        dart.as(other, Codec$(T, dart.dynamicR));
        return new (_FusedCodec$(S, T, dart.dynamicR))(this, other);
      }
      get inverted() {
    ...
    dart.setSignature(Codec, {
      ...
      methods: () => ({
        encode: [T, [S]],
        decode: [S, [T]],
        fuse: [Codec$(S, dart.dynamicR), [Codec$(T, dart.dynamicR)]]
      })
    });
    return Codec;
  });
  ...
  class Encoding extends Codec$(core.String, core.List$(core.int)) {
    ...
    decodeStream(byteStream) {
      return byteStream.transform(this.decoder).fold(new core.StringBuffer(), dart.fn((buffer, string) => ((() => {
        ...
        return buffer;
      })()))).then(dart.fn(buffer => dart.toString(buffer), core.String, [dart.dynamicR]));
    }
  ...
  class AsciiCodec extends Encoding {
    ...
    decode(bytes, opts) {
      ...
      if (dart.notNull(allowInvalid)) {
        return dart.const_(new AsciiDecoder({allowInvalid: true})).convert(bytes);
      } else {
        return dart.const_(new AsciiDecoder({allowInvalid: false})).convert(bytes);
      }
    }
    get encoder() {
      return dart.const_(new AsciiEncoder());
    }
    get decoder() {
      return dart.notNull(this[_allowInvalid]) ? dart.const_(new AsciiDecoder({allowInvalid: true})) : dart.const_(new AsciiDecoder({allowInvalid: false}));
    }
  }
  ...
  const ASCII = dart.const_(new AsciiCodec());
  ...
  const Converter$ = dart.generic(function(S, T) {
    class Converter extends core.Object {
      ...
      fuse(other) {
        dart.as(other, Converter$(T, dart.dynamicR));
        return new (_FusedConverter$(S, T, dart.dynamicR))(this, other);
      }
      startChunkedConversion(sink) {
        dart.as(sink, core.Sink$(T));
        dart.throw_(new core.UnsupportedError(`This converter does not support chunked conversions: ${this}`));
      }
      bind(source) {
    ...
    Converter[dart.implements_] = () => [async.StreamTransformer$(S, T)];
    dart.setSignature(Converter, {
      constructors: () => ({Converter: [Converter$(S, T), []]}),
      methods: () => ({
        fuse: [Converter$(S, dart.dynamicR), [Converter$(T, dart.dynamicR)]],
    ...
    convert(string, start, end) {
      ...
      for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
        ...
        if ((dart.notNull(codeUnit) & ~dart.notNull(this[_subsetMask])) != 0) {
          dart.throw_(new core.ArgumentError("String contains invalid characters."));
        }
  ...
  StringConversionSinkMixin[dart.implements_] = () => [StringConversionSink];
  ...
  class _UnicodeSubsetEncoderSink extends StringConversionSinkBase {
    ...
    addSlice(source, start, end, isLast) {
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        ...
        if ((dart.notNull(codeUnit) & ~dart.notNull(this[_subsetMask])) != 0) {
          dart.throw_(new core.ArgumentError(`Source contains invalid character with code point: ${codeUnit}.`));
        }
      }
  ...
  dart.setSignature(_UnicodeSubsetEncoderSink, {
    ...
    methods: () => ({
      close: [dart.voidR, []],
      addSlice: [dart.voidR, [core.String, core.int, core.int, core.bool]]
    })
  });
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        ...
        if ((dart.notNull(byte) & ~dart.notNull(this[_subsetMask])) != 0) {
          if (!dart.notNull(this[_allowInvalid])) {
            dart.throw_(new core.FormatException(`Invalid value in input: ${byte}`));
          }
  ...
  const ChunkedConversionSink$ = dart.generic(function(T) {
    ...
    ChunkedConversionSink[dart.implements_] = () => [core.Sink$(T)];
    dart.setSignature(ChunkedConversionSink, {
      constructors: () => ({
        ChunkedConversionSink: [ChunkedConversionSink$(T), []],
        withCallback: [ChunkedConversionSink$(T), [dart.functionType(dart.voidR, [core.List$(T)])]]
      })
    });
  ...
  dart.setSignature(ByteConversionSink, {
    constructors: () => ({
      ...
      withCallback: [ByteConversionSink, [dart.functionType(dart.voidR, [core.List$(core.int)])]],
  ...
  dart.setSignature(ByteConversionSinkBase, {
    methods: () => ({addSlice: [dart.voidR, [core.List$(core.int), core.int, core.int, core.bool]]})
  });
    ...
    addSlice(source, start, end, isLast) {
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        if ((dart.notNull(source[dartx.get](i)) & ~dart.notNull(_ASCII_MASK)) != 0) {
          ...
          this[_utf8Sink].add(dart.const_(dart.list([239, 191, 189], core.int)));
  ...
  dart.setSignature(_ErrorHandlingAsciiDecoderSink, {
    ...
    methods: () => ({
      close: [dart.voidR, []],
      add: [dart.voidR, [core.List$(core.int)]]
    })
  });
  class _SimpleAsciiDecoderSink extends ByteConversionSinkBase {
    ...
    add(source) {
      for (let i = 0; dart.notNull(i) < dart.notNull(source[dartx.length]); i = dart.notNull(i) + 1) {
        if ((dart.notNull(source[dartx.get](i)) & ~dart.notNull(_ASCII_MASK)) != 0) {
          dart.throw_(new core.FormatException("Source contains non-ASCII bytes."));
        }
      }
  ...
  dart.setSignature(_ByteCallbackSink, {
    constructors: () => ({_ByteCallbackSink: [_ByteCallbackSink, [dart.functionType(dart.voidR, [core.List$(core.int)])]]}),
    methods: () => ({
      add: [dart.voidR, [core.Iterable$(core.int)]],
      close: [dart.voidR, []]
    }),
  ...
  const _ChunkedConversionCallback$ = dart.generic(function(T) {
    const _ChunkedConversionCallback = dart.typedef('_ChunkedConversionCallback', () => dart.functionType(dart.voidR, [T]));
  ...
  const _EventSinkAdapter$ = dart.generic(function(T) {
    ...
    _EventSinkAdapter[dart.implements_] = () => [ChunkedConversionSink$(T)];
  ...
  const _ConverterStreamEventSink$ = dart.generic(function(S, T) {
    ...
    _ConverterStreamEventSink[dart.implements_] = () => [async.EventSink$(S)];
  ...
  HtmlEscapeMode.UNKNOWN = dart.const_(new HtmlEscapeMode._('unknown', true, true, true, true));
  ...
  const HTML_ESCAPE = dart.const_(new HtmlEscape());
  HtmlEscapeMode.ATTRIBUTE = dart.const_(new HtmlEscapeMode._('attribute', false, true, false, false));
  HtmlEscapeMode.ELEMENT = dart.const_(new HtmlEscapeMode._('element', true, false, false, true));
  ...
  dart.setSignature(JsonUnsupportedObjectError, {
    constructors: () => ({JsonUnsupportedObjectError: [JsonUnsupportedObjectError, [dart.dynamicR], {cause: dart.dynamicR}]})
  });
  ...
  class JsonCodec extends Codec$(core.Object, core.String) {
    ...
    get encoder() {
      if (this[_toEncodable$] == null) return dart.const_(new JsonEncoder());
      return new JsonEncoder(dart.as(this[_toEncodable$], dart.functionType(core.Object, [core.Object])));
    }
    get decoder() {
      if (this[_reviver] == null) return dart.const_(new JsonDecoder());
  ...
  dart.setSignature(JsonCodec, {
    constructors: () => ({
      JsonCodec: [JsonCodec, [], {reviver: dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), toEncodable: dart.functionType(dart.dynamicR, [dart.dynamicR])}],
      withReviver: [JsonCodec, [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]]
    }),
    methods: () => ({
      decode: [dart.dynamicR, [core.String], {reviver: dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])}],
      encode: [core.String, [core.Object], {toEncodable: dart.functionType(dart.dynamicR, [dart.dynamicR])}]
    })
  });
  const JSON = dart.const_(new JsonCodec());
  const _Reviver = dart.typedef('_Reviver', () => dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]));
  const _ToEncodable = dart.typedef('_ToEncodable', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  ...
  dart.setSignature(JsonEncoder, {
    ...
    methods: () => ({
      ...
      fuse: [Converter$(core.Object, dart.dynamicR), [Converter$(core.String, dart.dynamicR)]]
    })
  });
  ...
  class JsonUtf8Encoder extends Converter$(core.Object, core.List$(core.int)) {
    ...
    convert(object) {
      ...
      dart.fn(addChunk, dart.voidR, [typed_data.Uint8List, core.int, core.int]);
      _JsonUtf8Stringifier.stringify(object, this[_indent], dart.as(this[_toEncodable$], dart.functionType(dart.dynamicR, [core.Object])), this[_bufferSize], addChunk);
  ...
  dart.setSignature(JsonUtf8Encoder, {
    constructors: () => ({JsonUtf8Encoder: [JsonUtf8Encoder, [], [core.String, dart.functionType(dart.dynamicR, [core.Object]), core.int]]}),
    methods: () => ({
      ...
      fuse: [Converter$(core.Object, dart.dynamicR), [Converter$(core.List$(core.int), dart.dynamicR)]]
    }),
  ...
  class _JsonEncoderSink extends ChunkedConversionSink$(core.Object) {
    ...
    add(o) {
      if (dart.notNull(this[_isDone])) {
        dart.throw_(new core.StateError("Only one call to add allowed"));
      }
      this[_isDone] = true;
      let stringSink = this[_sink].asStringSink();
      _JsonStringStringifier.printOn(o, stringSink, dart.as(this[_toEncodable$], dart.functionType(dart.dynamicR, [dart.dynamicR])), this[_indent]);
      stringSink.close();
    }
    close() {}
  }
  ...
  class _JsonUtf8EncoderSink extends ChunkedConversionSink$(core.Object) {
    ...
    add(object) {
      ...
      this[_isDone] = true;
      _JsonUtf8Stringifier.stringify(object, this[_indent], dart.as(this[_toEncodable$], dart.functionType(dart.dynamicR, [core.Object])), this[_bufferSize], dart.bind(this, _addChunk));
      this[_sink].close();
    }
    close() {
      if (!dart.notNull(this[_isDone])) {
  ...
  dart.setSignature(_JsonUtf8EncoderSink, {
    ...
    methods: () => ({
      [_addChunk]: [dart.voidR, [typed_data.Uint8List, core.int, core.int]],
      add: [dart.voidR, [core.Object]],
      close: [dart.voidR, []]
    })
  });
  ...
  dart.setSignature(JsonDecoder, {
    constructors: () => ({JsonDecoder: [JsonDecoder, [], [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]]}),
    methods: () => ({
      convert: [dart.dynamicR, [core.String]],
  ...
  function _parseJson(source, reviver) {
    if (!(typeof source == 'string')) dart.throw_(new core.ArgumentError(source));
    let parsed = null;
    try {
      parsed = dart.global.JSON.parse(source);
    } catch (e) {
      dart.throw_(new core.FormatException(String(e)));
    }
  ...
  dart.fn(_parseJson, dart.dynamicR, [core.String, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]);
  function _defaultToEncodable(object) {
    return dart.dsend(object, 'toJson');
  }
  dart.fn(_defaultToEncodable, core.Object, [dart.dynamicR]);
  ...
  class _JsonStringifier extends core.Object {
    ...
    writeStringContent(s) {
      ...
      for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
        ...
        if (dart.notNull(charCode) < 32) {
          if (dart.notNull(i) > dart.notNull(offset)) this.writeStringSlice(s, offset, i);
    ...
    [_checkCycle](object) {
      for (let i = 0; dart.notNull(i) < dart.notNull(this[_seen][dartx.length]); i = dart.notNull(i) + 1) {
        if (dart.notNull(core.identical(object, this[_seen][dartx.get](i)))) {
          dart.throw_(new JsonCyclicError(object));
        }
      }
    ...
    writeObject(object) {
      ...
      try {
        ...
        if (!dart.notNull(this.writeJsonValue(customJson))) {
          dart.throw_(new JsonUnsupportedObjectError(object));
        }
        this[_removeSeen](object);
      } catch (e) {
        dart.throw_(new JsonUnsupportedObjectError(object, {cause: e}));
      }
    ...
    writeMap(map) {
      ...
      }).bind(this), dart.voidR, [core.String, core.Object]));
      this.writeString('}');
    }
  }
  dart.setSignature(_JsonStringifier, {
    ...
    methods: () => ({
      writeStringContent: [dart.voidR, [core.String]],
      [_checkCycle]: [dart.voidR, [dart.dynamicR]],
      [_removeSeen]: [dart.voidR, [dart.dynamicR]],
      writeObject: [dart.voidR, [dart.dynamicR]],
      writeJsonValue: [core.bool, [dart.dynamicR]],
      writeList: [dart.voidR, [core.List]],
      writeMap: [dart.voidR, [core.Map$(core.String, core.Object)]]
    }),
  ...
  _JsonPrettyPrintMixin[dart.implements_] = () => [_JsonStringifier];
  dart.setSignature(_JsonPrettyPrintMixin, {
    methods: () => ({
      writeList: [dart.voidR, [core.List]],
      writeMap: [dart.voidR, [core.Map]]
    })
  });
  ...
  dart.setSignature(_JsonStringStringifier, {
    constructors: () => ({_JsonStringStringifier: [_JsonStringStringifier, [core.StringSink, dart.dynamicR]]}),
    methods: () => ({
      writeNumber: [dart.voidR, [core.num]],
      writeString: [dart.voidR, [core.String]],
      writeStringSlice: [dart.voidR, [core.String, core.int, core.int]],
      writeCharCode: [dart.voidR, [core.int]]
    }),
    statics: () => ({
      stringify: [core.String, [dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR]), core.String]],
      printOn: [dart.voidR, [dart.dynamicR, core.StringSink, dart.functionType(dart.dynamicR, [dart.dynamicR]), core.String]]
    }),
  ...
  dart.setSignature(_JsonStringStringifierPretty, {
    ...
    methods: () => ({writeIndentation: [dart.voidR, [core.int]]})
  });
  ...
  dart.setSignature(_JsonUtf8Stringifier, {
    constructors: () => ({_JsonUtf8Stringifier: [_JsonUtf8Stringifier, [dart.dynamicR, core.int, core.Function]]}),
    methods: () => ({
      flush: [dart.voidR, []],
      writeNumber: [dart.voidR, [core.num]],
      writeAsciiString: [dart.voidR, [core.String]],
      writeString: [dart.voidR, [core.String]],
      writeStringSlice: [dart.voidR, [core.String, core.int, core.int]],
      writeCharCode: [dart.voidR, [core.int]],
      writeMultiByteCharCode: [dart.voidR, [core.int]],
      writeFourByteCharCode: [dart.voidR, [core.int]],
      writeByte: [dart.voidR, [core.int]]
    }),
    statics: () => ({stringify: [dart.voidR, [core.Object, core.List$(core.int), dart.functionType(dart.dynamicR, [core.Object]), core.int, dart.functionType(dart.voidR, [typed_data.Uint8List, core.int, core.int])]]}),
    names: ['stringify']
  });
  ...
  dart.setSignature(_JsonUtf8StringifierPretty, {
    constructors: () => ({_JsonUtf8StringifierPretty: [_JsonUtf8StringifierPretty, [dart.dynamicR, core.List$(core.int), dart.dynamicR, dart.dynamicR]]}),
    methods: () => ({writeIndentation: [dart.voidR, [core.int]]})
  });
  ...
  const __CastType4 = dart.typedef('__CastType4', () => dart.functionType(dart.dynamicR, [core.Object]));
  class Latin1Codec extends Encoding {
    ...
    decode(bytes, opts) {
      ...
      if (allowInvalid == null) allowInvalid = this[_allowInvalid];
      if (dart.notNull(allowInvalid)) {
        return dart.const_(new Latin1Decoder({allowInvalid: true})).convert(bytes);
      } else {
        return dart.const_(new Latin1Decoder({allowInvalid: false})).convert(bytes);
      }
    }
    get encoder() {
      return dart.const_(new Latin1Encoder());
    }
    get decoder() {
      return dart.notNull(this[_allowInvalid]) ? dart.const_(new Latin1Decoder({allowInvalid: true})) : dart.const_(new Latin1Decoder({allowInvalid: false}));
    }
  }
  ...
  const LATIN1 = dart.const_(new Latin1Codec());
    ...
    addSlice(source, start, end, isLast) {
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        ...
        if (dart.notNull(char) > dart.notNull(_LATIN1_MASK) || dart.notNull(char) < 0) {
          dart.throw_(new core.FormatException("Source contains non-Latin-1 characters."));
        }
      }
      if (dart.notNull(start) < dart.notNull(end)) {
  ...
  dart.setSignature(_Latin1DecoderSink, {
    ...
    methods: () => ({
      close: [dart.voidR, []],
      add: [dart.voidR, [core.List$(core.int)]],
      [_addSliceToSink]: [dart.voidR, [core.List$(core.int), core.int, core.int, core.bool]]
    })
  });
    ...
    addSlice(source, start, end, isLast) {
      ...
      for (let i = start; dart.notNull(i) < dart.notNull(end); i = dart.notNull(i) + 1) {
        ...
        if (dart.notNull(char) > dart.notNull(_LATIN1_MASK) || dart.notNull(char) < 0) {
          ...
          this[_addSliceToSink](dart.const_(dart.list([65533], core.int)), 0, 1, false);
          start = dart.notNull(i) + 1;
        }
      }
      if (dart.notNull(start) < dart.notNull(end)) {
  ...
  dart.setSignature(_LineSplitterSink, {
    ...
    statics: () => ({_addSlice: [core.String, [core.String, core.int, core.int, core.bool, dart.functionType(dart.voidR, [core.String])]]}),
    names: ['_addSlice']
  });
  ...
  dart.setSignature(StringConversionSink, {
    constructors: () => ({
      ...
      withCallback: [StringConversionSink, [dart.functionType(dart.voidR, [core.String])]],
  ...
  dart.setSignature(ClosableStringSink, {
    constructors: () => ({fromStringSink: [ClosableStringSink, [core.StringSink, dart.functionType(dart.voidR, [])]]})
  });
  const _StringSinkCloseCallback = dart.typedef('_StringSinkCloseCallback', () => dart.functionType(dart.voidR, []));
  ...
  _ClosableStringSink[dart.implements_] = () => [ClosableStringSink];
  dart.setSignature(_ClosableStringSink, {
    ...
    methods: () => ({
      close: [dart.voidR, []],
      writeCharCode: [dart.voidR, [core.int]],
      write: [dart.voidR, [core.Object]],
      writeln: [dart.voidR, [], [core.Object]],
      writeAll: [dart.voidR, [core.Iterable], [core.String]]
    })
  });
  ...
  _StringConversionSinkAsStringSinkAdapter[dart.implements_] = () => [ClosableStringSink];
  ...
  dart.setSignature(_Utf8StringSinkAdapter, {
    ...
    methods: () => ({
      close: [dart.voidR, []],
      add: [dart.voidR, [core.List$(core.int)]],
      addSlice: [dart.voidR, [core.List$(core.int), core.int, core.int, core.bool]]
    })
  });
  ...
  const UTF8 = dart.const_(new Utf8Codec());
  ...
  dart.setSignature(Utf8Decoder, {
    ...
    methods: () => ({
      ...
      bind: [async.Stream$(core.String), [async.Stream$(core.List$(core.int))]],
      fuse: [Converter$(core.List$(core.int), dart.dynamicR), [Converter$(core.String, dart.dynamicR)]]
    })
  });
  ...
  class _Utf8Decoder extends core.Object {
    ...
    flush() {
      if (dart.notNull(this.hasPartialInput)) {
        if (!dart.notNull(this[_allowMalformed])) {
          dart.throw_(new core.FormatException("Unfinished UTF-8 octet sequence"));
        }
    ...
    convert(codeUnits, startIndex, endIndex) {
      ...
      dart.fn(scanOneByteCharacters, core.int, [dart.dynamicR, core.int]);
      ...
      dart.fn(addSingleBytes, dart.voidR, [core.int, core.int]);
      let i = startIndex;
      loop:
        while (true) {
          multibyte:
            if (dart.notNull(expectedUnits) > 0) {
              do {
                ...
                if ((dart.notNull(unit) & 192) != 128) {
                  expectedUnits = 0;
                  if (!dart.notNull(this[_allowMalformed])) {
                    dart.throw_(new core.FormatException(`Bad UTF-8 encoding 0x${unit[dartx.toRadixString](16)}`));
                  }
              ...
              if (dart.notNull(value) <= dart.notNull(_Utf8Decoder._LIMITS[dartx.get](dart.notNull(extraUnits) - 1))) {
                if (!dart.notNull(this[_allowMalformed])) {
                  dart.throw_(new core.FormatException(`Overlong encoding of 0x${value[dartx.toRadixString](16)}`));
                }
              ...
              if (dart.notNull(value) > dart.notNull(_FOUR_BYTE_LIMIT)) {
                if (!dart.notNull(this[_allowMalformed])) {
                  dart.throw_(new core.FormatException("Character outside valid Unicode range: " + `0x${value[dartx.toRadixString](16)}`));
                }
                value = UNICODE_REPLACEMENT_CHARACTER_RUNE;
              }
          ...
          while (dart.notNull(i) < dart.notNull(endIndex)) {
            ...
            if (dart.notNull(unit) < 0) {
              if (!dart.notNull(this[_allowMalformed])) {
                dart.throw_(new core.FormatException(`Negative UTF-8 code unit: -0x${(-dart.notNull(unit))[dartx.toRadixString](16)}`));
              }
              this[_stringSink].writeCharCode(UNICODE_REPLACEMENT_CHARACTER_RUNE);
            } else {
  ...
  dart.setSignature(_Utf8Decoder, {
    ...
    methods: () => ({
      close: [dart.voidR, []],
      flush: [dart.voidR, []],
      convert: [dart.voidR, [core.List$(core.int), core.int, core.int]]
    })
  });
  _Utf8Decoder._LIMITS = dart.const_(dart.list([_ONE_BYTE_LIMIT, _TWO_BYTE_LIMIT, _THREE_BYTE_LIMIT, _FOUR_BYTE_LIMIT], core.int));
  ...
  dart.fn(_convertJsonToDart, dart.dynamicR, [dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]);
  ...
  class _JsonMap extends core.Object {
    ...
    addAll(other) {
      other.forEach(dart.fn(((key, value) => {
        this.set(key, value);
      }).bind(this), dart.voidR, [dart.dynamicR, dart.dynamicR]));
    }
    containsValue(value) {
    ...
    forEach(f) {
      ...
      for (let i = 0; dart.notNull(i) < dart.notNull(keys[dartx.length]); i = dart.notNull(i) + 1) {
        ...
        if (!dart.notNull(core.identical(keys, this[_data]))) {
          dart.throw_(new core.ConcurrentModificationError(this));
        }
      }
    }
    toString() {
  ...
  _JsonMap[dart.implements_] = () => [collection.LinkedHashMap];
  dart.setSignature(_JsonMap, {
    constructors: () => ({_JsonMap: [_JsonMap, [dart.dynamicR]]}),
    methods: () => ({
      get: [dart.dynamicR, [core.Object]],
      set: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      addAll: [dart.voidR, [core.Map]],
      containsValue: [core.bool, [core.Object]],
      containsKey: [core.bool, [core.Object]],
      putIfAbsent: [dart.dynamicR, [dart.dynamicR, dart.functionType(dart.dynamicR, [])]],
      remove: [dart.dynamicR, [core.Object]],
      clear: [dart.voidR, []],
      forEach: [dart.voidR, [dart.functionType(dart.voidR, [dart.dynamicR, dart.dynamicR])]],
      [_computeKeys]: [core.List$(core.String), []],
      [_upgrade]: [core.Map, []],
      [_process]: [dart.dynamicR, [core.String]]
    }),
    statics: () => ({
      _hasProperty: [core.bool, [dart.dynamicR, core.String]],
      _getProperty: [dart.dynamicR, [dart.dynamicR, core.String]],
      _setProperty: [dart.dynamicR, [dart.dynamicR, core.String, dart.dynamicR]],
      _getPropertyNames: [core.List, [dart.dynamicR]],
      _isUnprocessed: [core.bool, [dart.dynamicR]],
      _newJavaScriptObject: [dart.dynamicR, []]
    }),
