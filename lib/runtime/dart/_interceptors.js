dart_library.library('dart/_interceptors', null, /* Imports */[
  ...
  const JSArray$ = dart.generic(function(E) {
    ...
    class JSArray extends core.Object {
      ...
      [dartx.checkGrowable](reason) {
        if (this.fixed$length) {
          dart.throw_(new core.UnsupportedError(dart.as(reason, core.String)));
        }
      }
      [dartx.add](value) {
        dart.as(value, E);
      ...
      [dartx.removeAt](index) {
        ...
        if (dart.notNull(index) < 0 || dart.notNull(index) >= dart.notNull(this[dartx.length])) {
          dart.throw_(new core.RangeError.value(index));
        }
      ...
      [dartx.removeLast]() {
        ...
        if (this[dartx.length] == 0) dart.throw_(new core.RangeError.value(-1));
      ...
      [dartx.sublist](start, end) {
        ...
        if (!(typeof start == 'number')) dart.throw_(new core.ArgumentError(start));
        if (dart.notNull(start) < 0 || dart.notNull(start) > dart.notNull(this[dartx.length])) {
          dart.throw_(new core.RangeError.range(start, 0, this[dartx.length]));
        }
        if (end == null) {
          end = this[dartx.length];
        } else {
          if (!(typeof end == 'number')) dart.throw_(new core.ArgumentError(end));
          if (dart.notNull(end) < dart.notNull(start) || dart.notNull(end) > dart.notNull(this[dartx.length])) {
            dart.throw_(new core.RangeError.range(end, start, this[dartx.length]));
          }
        }
      ...
      get [dartx.single]() {
        ...
        if (this[dartx.length] == 0) dart.throw_(new core.StateError("No elements"));
      ...
      [dartx.removeRange](start, end) {
        ...
        if (dart.notNull(start) < 0 || dart.notNull(start) > dart.notNull(receiverLength)) {
          dart.throw_(new core.RangeError.range(start, 0, receiverLength));
        }
        if (dart.notNull(end) < dart.notNull(start) || dart.notNull(end) > dart.notNull(receiverLength)) {
          dart.throw_(new core.RangeError.range(end, start, receiverLength));
        }
      ...
      set [dartx.length](newLength) {
        if (!(typeof newLength == 'number')) dart.throw_(new core.ArgumentError(newLength));
        if (dart.notNull(newLength) < 0) dart.throw_(new core.RangeError.value(newLength));
        this[dartx.checkGrowable]('set length');
        this.length = newLength;
      }
      [dartx.get](index) {
        if (!(typeof index == 'number')) dart.throw_(new core.ArgumentError(index));
        if (dart.notNull(index) >= dart.notNull(this[dartx.length]) || dart.notNull(index) < 0) dart.throw_(new core.RangeError.value(index));
    ...
    JSArray[dart.implements_] = () => [core.List$(E), JSIndexable];
    dart.setSignature(JSArray, {
      constructors: () => ({
        JSArray: [JSArray$(E), []],
        typed: [JSArray$(E), [dart.dynamicR]],
        markFixed: [JSArray$(E), [dart.dynamicR]],
        markGrowable: [JSArray$(E), [dart.dynamicR]]
      }),
      methods: () => ({
        [dartx.checkGrowable]: [dart.dynamicR, [dart.dynamicR]],
        [dartx.add]: [dart.voidR, [E]],
        [dartx.removeAt]: [E, [core.int]],
        [dartx.insert]: [dart.voidR, [core.int, E]],
        [dartx.insertAll]: [dart.voidR, [core.int, core.Iterable$(E)]],
        [dartx.setAll]: [dart.voidR, [core.int, core.Iterable$(E)]],
        [dartx.removeLast]: [E, []],
        [dartx.remove]: [core.bool, [core.Object]],
        [dartx.removeWhere]: [dart.voidR, [dart.functionType(core.bool, [E])]],
        [dartx.retainWhere]: [dart.voidR, [dart.functionType(core.bool, [E])]],
        [dartx.where]: [core.Iterable$(E), [dart.functionType(core.bool, [E])]],
        [dartx.expand]: [core.Iterable, [dart.functionType(core.Iterable, [E])]],
        [dartx.addAll]: [dart.voidR, [core.Iterable$(E)]],
        [dartx.clear]: [dart.voidR, []],
        [dartx.forEach]: [dart.voidR, [dart.functionType(dart.voidR, [E])]],
        [dartx.map]: [core.Iterable, [dart.functionType(dart.dynamicR, [E])]],
        ...
        [dartx.fold]: [dart.dynamicR, [dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR, E])]],
        ...
        [dartx.removeRange]: [dart.voidR, [core.int, core.int]],
        [dartx.setRange]: [dart.voidR, [core.int, core.int, core.Iterable$(E)], [core.int]],
        [dartx.fillRange]: [dart.voidR, [core.int, core.int], [E]],
        [dartx.replaceRange]: [dart.voidR, [core.int, core.int, core.Iterable$(E)]],
        [dartx.any]: [core.bool, [dart.functionType(core.bool, [E])]],
        [dartx.every]: [core.bool, [dart.functionType(core.bool, [E])]],
        [dartx.sort]: [dart.voidR, [], [dart.functionType(core.int, [E, E])]],
        [dartx.shuffle]: [dart.voidR, [], [math.Random]],
        ...
        [dartx.set]: [dart.voidR, [core.int, E]],
        [dartx.asMap]: [core.Map$(core.int, E), []]
      }),
      statics: () => ({markFixedList: [core.List, [core.List]]}),
      names: ['markFixedList']
    });
    JSArray[dart.metadata] = () => [dart.const_(new _js_helper.JsPeerInterface({name: 'Array'}))];
    return JSArray;
  });
  ...
  const JSMutableArray$ = dart.generic(function(E) {
    ...
    JSMutableArray[dart.implements_] = () => [JSMutableIndexable];
  ...
  class JSNumber extends Interceptor {
    ...
    [dartx.toInt]() {
      ...
      dart.throw_(new core.UnsupportedError('' + this));
    }
    [dartx.truncate]() {
    ...
    [dartx.clamp](lowerLimit, upperLimit) {
      if (dart.notNull(lowerLimit[dartx.compareTo](upperLimit)) > 0) {
        dart.throw_(new core.ArgumentError(lowerLimit));
      }
    ...
    [dartx.toStringAsFixed](fractionDigits) {
      ...
      if (dart.notNull(fractionDigits) < 0 || dart.notNull(fractionDigits) > 20) {
        dart.throw_(new core.RangeError(fractionDigits));
      }
    ...
    [dartx.toStringAsPrecision](precision) {
      ...
      if (dart.notNull(precision) < 1 || dart.notNull(precision) > 21) {
        dart.throw_(new core.RangeError(precision));
      }
    ...
    [dartx.toRadixString](radix) {
      ...
      if (dart.notNull(radix) < 2 || dart.notNull(radix) > 36) dart.throw_(new core.RangeError(radix));
    ...
    static _handleIEtoString(result) {
      ...
      if (match == null) {
        dart.throw_(new core.UnsupportedError(`Unexpected toString result: ${result}`));
      }
    ...
    [dartx['<<']](other) {
      if (dart.notNull(other) < 0) dart.throw_(new core.ArgumentError(other));
  ...
  JSNumber[dart.implements_] = () => [core.int, core.double];
  dart.setSignature(JSNumber, {
    ...
    methods: () => ({
      ...
      [dartx['*']]: [JSNumber, [core.num]],
      [dartx['%']]: [JSNumber, [core.num]],
      [_isInt32]: [core.bool, [dart.dynamicR]],
  ...
  JSNumber[dart.metadata] = () => [dart.const_(new _js_helper.JsPeerInterface({name: 'Number'}))];
  ...
  class JSString extends Interceptor {
    ...
    [dartx.codeUnitAt](index) {
      if (!(typeof index == 'number')) dart.throw_(new core.ArgumentError(index));
      if (dart.notNull(index) < 0) dart.throw_(new core.RangeError.value(index));
      if (dart.notNull(index) >= dart.notNull(this[dartx.length])) dart.throw_(new core.RangeError.value(index));
    ...
    [dartx['+']](other) {
      if (!(typeof other == 'string')) dart.throw_(new core.ArgumentError(other));
      return this + other;
    }
    ...
    [dartx.replaceFirst](from, to, startIndex) {
      ...
      if (dart.notNull(startIndex) < 0 || dart.notNull(startIndex) > dart.notNull(this[dartx.length])) {
        dart.throw_(new core.RangeError.range(startIndex, 0, this[dartx.length]));
      }
    ...
    [dartx.startsWith](pattern, index) {
      ...
      if (dart.notNull(index) < 0 || dart.notNull(index) > dart.notNull(this[dartx.length])) {
        dart.throw_(new core.RangeError.range(index, 0, this[dartx.length]));
      }
      if (typeof pattern == 'string') {
        let other = pattern;
        let otherLength = other[dartx.length];
    ...
    [dartx.substring](startIndex, endIndex) {
      ...
      if (dart.notNull(startIndex) < 0) dart.throw_(new core.RangeError.value(startIndex));
      if (dart.notNull(startIndex) > dart.notNull(endIndex)) dart.throw_(new core.RangeError.value(startIndex));
      if (dart.notNull(endIndex) > dart.notNull(this[dartx.length])) dart.throw_(new core.RangeError.value(endIndex));
    ...
    [dartx['*']](times) {
      ...
      if (times != times >>> 0) {
        dart.throw_(dart.const_(new core.OutOfMemoryError()));
      }
      let result = '';
      let s = this;
      while (true) {
    ...
    [dartx.lastIndexOf](pattern, start) {
      ...
      if (start == null) {
        ...
        dart.throw_(new core.ArgumentError(start));
  ...
  JSString[dart.implements_] = () => [core.String, JSIndexable];
  ...
  JSString[dart.metadata] = () => [dart.const_(new _js_helper.JsPeerInterface({name: 'String'}))];
  ...
  JSBool[dart.implements_] = () => [core.bool];
  dart.setSignature(JSBool, {
    constructors: () => ({JSBool: [JSBool, []]})
  });
  JSBool[dart.metadata] = () => [dart.const_(new _js_helper.JsPeerInterface({name: 'Boolean'}))];
  ...
  JavaScriptObject[dart.implements_] = () => [JSObject];
