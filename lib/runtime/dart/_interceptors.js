dart_library.library('dart/_interceptors', null, /* Imports */[
  ...
  class JSNumber extends Interceptor {
    ...
    [dartx.remainder](b) {
      ...
      return dart.as(this % b, JSNumber);
    }
    [dartx.abs]() {
      return dart.as(Math.abs(this), JSNumber);
    }
    get [dartx.sign]() {
    ...
    [dartx.toInt]() {
      ...
      if (dart.notNull(dart.as(isFinite(this), core.bool))) {
        return dart.as(this[dartx.truncateToDouble]() + 0, core.int);
      }
    ...
    [dartx['unary-']]() {
      return dart.as(-this, JSNumber);
    }
    [dartx['+']](other) {
      _js_helper.checkNull(other);
      return dart.as(this + other, JSNumber);
    }
    [dartx['-']](other) {
      _js_helper.checkNull(other);
      return dart.as(this - other, JSNumber);
    ...
    [_shlPositive](other) {
      return dart.notNull(dart.as(other > 31, core.bool)) ? 0 : dart.as(this << other >>> 0, core.int);
    }
    [dartx['>>']](other) {
      if (dart.notNull(other) < 0)
        dart.throw(new core.ArgumentError(other));
    ...
    [_shrOtherPositive](other) {
      return dart.notNull(dart.as(dart.dsend(this, '>', 0), core.bool)) ? this[_shrBothPositive](other) : dart.as(this >> (dart.notNull(other) > 31 ? 31 : other) >>> 0, core.int);
    }
    [_shrBothPositive](other) {
      return dart.notNull(dart.as(other > 31, core.bool)) ? 0 : dart.as(this >>> other, core.int);
    }
    [dartx['&']](other) {
      _js_helper.checkNull(other);
      return dart.as((this & other) >>> 0, core.int);
  ...
  class JSString extends Interceptor {
    ...
    [dartx['*']](times) {
      ...
      while (true) {
        if ((dart.notNull(times) & 1) == 1)
          result = dart.notNull(s) + dart.notNull(dart.as(result, core.String));
    ...
    get hashCode() {
      let hash = 0;
      for (let i = 0; dart.notNull(i) < dart.notNull(this[dartx.length]); i = dart.notNull(i) + 1) {
        hash = 536870911 & dart.notNull(dart.asInt(dart.notNull(hash) + dart.notNull(dart.as(this.charCodeAt(i), core.num))));
