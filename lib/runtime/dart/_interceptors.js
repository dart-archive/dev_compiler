dart_library.library('dart/_interceptors', null, /* Imports */[
  ...
  exports[dart.uri] = 'dart:_interceptors';
  const JSArray$ = dart.generic(function(E) {
    ...
    JSArray[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.JsPeerInterface({name: 'Array'}))]]);
    JSArray[dart.owner] = exports;
    return JSArray;
  });
  let JSArray = JSArray$();
  ...
  const JSMutableArray$ = dart.generic(function(E) {
    ...
    JSMutableArray[dart.owner] = exports;
  ...
  const JSFixedArray$ = dart.generic(function(E) {
    ...
    JSFixedArray[dart.owner] = exports;
    return JSFixedArray;
  });
  ...
  const JSExtendableArray$ = dart.generic(function(E) {
    ...
    JSExtendableArray[dart.owner] = exports;
  ...
  Interceptor[dart.owner] = exports;
  dart.defineExtensionNames([
    'compareTo',
    'isNegative',
    'isNaN',
  ...
  JSNumber[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.JsPeerInterface({name: 'Number'}))]]);
  JSNumber[dart.owner] = exports;
  ...
  JSString[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.JsPeerInterface({name: 'String'}))]]);
  JSString[dart.owner] = exports;
  ...
  JSBool[dart.metadata] = () => dart.map(['type', [dart.const(new _js_helper.JsPeerInterface({name: 'Boolean'}))]]);
  JSBool[dart.owner] = exports;
  dart.registerExtension(dart.global.Boolean, JSBool);
  class JSIndexable extends core.Object {}
  JSIndexable[dart.owner] = exports;
  class JSMutableIndexable extends JSIndexable {}
  JSMutableIndexable[dart.owner] = exports;
  class JSObject extends core.Object {}
  JSObject[dart.owner] = exports;
  ...
  JavaScriptObject[dart.owner] = exports;
  ...
  PlainJavaScriptObject[dart.owner] = exports;
  ...
  UnknownJavaScriptObject[dart.owner] = exports;
  // Exports:
