dart_library.library('dart/async', null, /* Imports */[
  ...
  dart.fn(_invokeErrorHandler, dart.dynamicR, [core.Function, core.Object, core.StackTrace]);
  ...
  AsyncError[dart.implements_] = () => [core.Error];
  dart.setSignature(AsyncError, {
    constructors: () => ({AsyncError: [AsyncError, [dart.dynamicR, core.StackTrace]]})
  });
  ...
  dart.setSignature(_UncaughtAsyncError, {
    constructors: () => ({_UncaughtAsyncError: [_UncaughtAsyncError, [dart.dynamicR, core.StackTrace]]}),
    statics: () => ({_getBestStackTrace: [core.StackTrace, [dart.dynamicR, core.StackTrace]]}),
    names: ['_getBestStackTrace']
  });
  const __CastType0 = dart.typedef('__CastType0', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  ...
  const Stream$ = dart.generic(function(T) {
    class Stream extends core.Object {
      ...
      static fromFuture(future) {
        ...
        }, dart.dynamicR, [T]), {onError: dart.fn((error, stackTrace) => {
      ...
      static periodic(period, computation) {
        ...
        dart.fn(startPeriodicTimer, dart.voidR, []);
        controller = StreamController$(T).new({sync: true, onListen: dart.fn(() => {
            watch.start();
            startPeriodicTimer();
          }, dart.voidR, []), onPause: dart.fn(() => {
            timer.cancel();
            timer = null;
            watch.stop();
          }, dart.voidR, []), onResume: dart.fn(() => {
            dart.assert(timer == null);
      ...
      static eventTransformed(source, mapSink) {
        return new (_BoundSinkStream$(dart.dynamicR, T))(source, mapSink);
      }
      get isBroadcast() {
        return false;
      }
      asBroadcastStream(opts) {
        ...
        dart.as(onListen, dart.functionType(dart.voidR, [StreamSubscription$(T)]));
        let onCancel = opts && 'onCancel' in opts ? opts.onCancel : null;
        dart.as(onCancel, dart.functionType(dart.voidR, [StreamSubscription$(T)]));
        return new (_AsBroadcastStream$(T))(this, dart.as(onListen, __CastType12), dart.as(onCancel, dart.functionType(dart.voidR, [StreamSubscription])));
      }
      where(test) {
      ...
      map(convert) {
        dart.as(convert, dart.functionType(dart.dynamicR, [T]));
        return new (_MapStream$(T, dart.dynamicR))(this, convert);
      }
      asyncMap(convert) {
        dart.as(convert, dart.functionType(dart.dynamicR, [T]));
        let controller = null;
        ...
        const onListen = (function() {
          ...
          }, dart.voidR, [T]), {onError: addError, onDone: dart.bind(controller, 'close')});
        }).bind(this);
        dart.fn(onListen, dart.voidR, []);
        if (dart.notNull(this.isBroadcast)) {
          controller = StreamController.broadcast({onListen: onListen, onCancel: dart.fn(() => {
              subscription.cancel();
            }, dart.voidR, []), sync: true});
        } else {
      ...
      asyncExpand(convert) {
        ...
        const onListen = (function() {
          ...
          }, dart.voidR, [T]), {onError: dart.bind(eventSink, _addError), onDone: dart.bind(controller, 'close')});
        }).bind(this);
        dart.fn(onListen, dart.voidR, []);
        if (dart.notNull(this.isBroadcast)) {
          controller = StreamController.broadcast({onListen: onListen, onCancel: dart.fn(() => {
      ...
      handleError(onError, opts) {
        ...
        dart.as(test, dart.functionType(core.bool, [dart.dynamicR]));
        return new (_HandleErrorStream$(T))(this, onError, test);
      }
      expand(convert) {
        dart.as(convert, dart.functionType(core.Iterable, [T]));
        return new (_ExpandStream$(T, dart.dynamicR))(this, convert);
      }
      pipe(streamConsumer) {
        dart.as(streamConsumer, StreamConsumer$(T));
        return streamConsumer.addStream(this).then(dart.fn(_ => streamConsumer.close(), Future, [dart.dynamicR]));
      }
      transform(streamTransformer) {
        dart.as(streamTransformer, StreamTransformer$(T, dart.dynamicR));
        ...
        subscription = this.listen(dart.fn(element => {
          ...
          if (dart.notNull(seenFirst)) {
            _runUserCode(dart.fn(() => combine(value, element), T, []), dart.fn(newValue => {
              dart.as(newValue, T);
              value = newValue;
            }, dart.dynamicR, [T]), dart.as(_cancelAndErrorClosure(subscription, result), __CastType14));
          } else {
            value = element;
            seenFirst = true;
          }
        }, dart.voidR, [T]), {onError: dart.bind(result, _completeError), onDone: dart.fn(() => {
            if (!dart.notNull(seenFirst)) {
              try {
                dart.throw_(_internal.IterableElementError.noElement());
              } catch (e) {
                let s = dart.stackTrace(e);
          ...
          }, dart.voidR, []), cancelOnError: true});
        return result;
      }
      fold(initialValue, combine) {
        dart.as(combine, dart.functionType(dart.dynamicR, [dart.dynamicR, T]));
        let result = new _Future();
        let value = initialValue;
        let subscription = null;
        subscription = this.listen(dart.fn(element => {
          dart.as(element, T);
          _runUserCode(dart.fn(() => combine(value, element), dart.dynamicR, []), dart.fn(newValue => {
            value = dart.as(newValue, dart.dynamicR);
          }), dart.as(_cancelAndErrorClosure(subscription, result), dart.functionType(dart.dynamicR, [dart.dynamicR, core.StackTrace])));
        }, dart.voidR, [T]), {onError: dart.fn((e, st) => {
      ...
      join(separator) {
        ...
        }, dart.voidR, [T]), {onError: dart.fn(e => {
      ...
      contains(needle) {
        ...
        subscription = this.listen(dart.fn(element => {
          ...
          }, dart.dynamicR, [core.bool]), dart.as(_cancelAndErrorClosure(subscription, future), dart.functionType(dart.dynamicR, [dart.dynamicR, core.StackTrace])));
        }, dart.voidR, [T]), {onError: dart.bind(future, _completeError), onDone: dart.fn(() => {
            future[_complete](false);
          }, dart.voidR, []), cancelOnError: true});
        return future;
      }
      forEach(action) {
        dart.as(action, dart.functionType(dart.voidR, [T]));
        let future = new _Future();
        let subscription = null;
        subscription = this.listen(dart.fn(element => {
          dart.as(element, T);
          _runUserCode(dart.fn(() => action(element), dart.voidR, []), dart.fn(_ => {
          }), dart.as(_cancelAndErrorClosure(subscription, future), dart.functionType(dart.dynamicR, [dart.dynamicR, core.StackTrace])));
        }, dart.voidR, [T]), {onError: dart.bind(future, _completeError), onDone: dart.fn(() => {
      ...
      get single() {
        ...
        subscription = this.listen(dart.fn(value => {
          ...
          if (dart.notNull(foundResult)) {
            try {
              dart.throw_(_internal.IterableElementError.tooMany());
            } catch (e) {
              let s = dart.stackTrace(e);
      ...
      elementAt(index) {
        if (!(typeof index == 'number') || dart.notNull(index) < 0) dart.throw_(new core.ArgumentError(index));
        let future = new (_Future$(T))();
        let subscription = null;
        let elementIndex = 0;
        subscription = this.listen(dart.fn(value => {
          ...
          }).bind(this), dart.voidR, []), cancelOnError: true});
        return future;
      }
      timeout(timeLimit, opts) {
        let onTimeout = opts && 'onTimeout' in opts ? opts.onTimeout : null;
        dart.as(onTimeout, dart.functionType(dart.voidR, [EventSink]));
        let controller = null;
        let subscription = null;
        let timer = null;
        let zone = null;
        ...
        dart.fn(onData, dart.voidR, [T]);
        function onError(error, stackTrace) {
          timer.cancel();
          dart.assert(dart.is(controller, _StreamController) || dart.is(controller, _BroadcastStreamController));
          let eventSink = dart.as(controller, _EventSink$(T));
          eventSink[_addError](error, stackTrace);
          timer = zone.createTimer(timeLimit, dart.as(timeout2, dart.functionType(dart.voidR, [])));
        }
        dart.fn(onError, dart.voidR, [dart.dynamicR, core.StackTrace]);
        function onDone() {
          timer.cancel();
          controller.close();
        }
        dart.fn(onDone, dart.voidR, []);
        const onListen = (function() {
          zone = Zone.current;
          if (onTimeout == null) {
            timeout2 = dart.fn(() => {
    ...
    dart.setSignature(Stream, {
      ...
      methods: () => ({
        asBroadcastStream: [Stream$(T), [], {onListen: dart.functionType(dart.voidR, [StreamSubscription$(T)]), onCancel: dart.functionType(dart.voidR, [StreamSubscription$(T)])}],
        where: [Stream$(T), [dart.functionType(core.bool, [T])]],
        map: [Stream$(), [dart.functionType(dart.dynamicR, [T])]],
        asyncMap: [Stream$(), [dart.functionType(dart.dynamicR, [T])]],
        asyncExpand: [Stream$(), [dart.functionType(Stream$(), [T])]],
        handleError: [Stream$(T), [core.Function], {test: dart.functionType(core.bool, [dart.dynamicR])}],
        expand: [Stream$(), [dart.functionType(core.Iterable, [T])]],
        pipe: [Future, [StreamConsumer$(T)]],
        transform: [Stream$(), [StreamTransformer$(T, dart.dynamicR)]],
        reduce: [Future$(T), [dart.functionType(T, [T, T])]],
        fold: [Future, [dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR, T])]],
        join: [Future$(core.String), [], [core.String]],
        contains: [Future$(core.bool), [core.Object]],
        forEach: [Future, [dart.functionType(dart.voidR, [T])]],
        ...
        timeout: [Stream$(), [core.Duration], {onTimeout: dart.functionType(dart.voidR, [EventSink])}]
      })
    });
    return Stream;
  });
  ...
  const _StreamImpl$ = dart.generic(function(T) {
    ...
    dart.setSignature(_StreamImpl, {
      methods: () => ({
        listen: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T])], {onError: core.Function, onDone: dart.functionType(dart.voidR, []), cancelOnError: core.bool}],
        [_createSubscription]: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]],
        [_onListen]: [dart.voidR, [StreamSubscription]]
      })
    });
    return _StreamImpl;
  });
  ...
  const _BufferingStreamSubscription$ = dart.generic(function(T) {
    class _BufferingStreamSubscription extends core.Object {
      ...
      [_close]() {
        ...
        if (dart.notNull(this[_canFire])) {
          ...
          this[_addPending](dart.const_(new _DelayedDone()));
        }
      }
      [_onPause]() {
    ...
    _BufferingStreamSubscription[dart.implements_] = () => [StreamSubscription$(T), _EventSink$(T), _EventDispatch$(T)];
    dart.setSignature(_BufferingStreamSubscription, {
      constructors: () => ({_BufferingStreamSubscription: [_BufferingStreamSubscription$(T), [dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]]}),
      methods: () => ({
        [_setPendingEvents]: [dart.voidR, [_PendingEvents]],
        ...
        pause: [dart.voidR, [], [Future]],
        resume: [dart.voidR, []],
        cancel: [Future, []],
        asFuture: [Future, [], [dart.dynamicR]],
        [_cancel]: [dart.voidR, []],
        [_incrementPauseCount]: [dart.voidR, []],
        [_decrementPauseCount]: [dart.voidR, []],
        [_add]: [dart.voidR, [T]],
        [_addError]: [dart.voidR, [core.Object, core.StackTrace]],
        [_close]: [dart.voidR, []],
        [_onPause]: [dart.voidR, []],
        [_onResume]: [dart.voidR, []],
        [_onCancel]: [Future, []],
        [_addPending]: [dart.voidR, [_DelayedEvent]],
        [_sendData]: [dart.voidR, [T]],
        [_sendError]: [dart.voidR, [core.Object, core.StackTrace]],
        [_sendDone]: [dart.voidR, []],
        [_guardCallback]: [dart.voidR, [dart.dynamicR]],
        [_checkState]: [dart.voidR, [core.bool]]
      })
    });
  ...
  const _ControllerSubscription$ = dart.generic(function(T) {
    ...
    dart.setSignature(_ControllerSubscription, {
      constructors: () => ({_ControllerSubscription: [_ControllerSubscription$(T), [_StreamControllerLifecycle$(T), dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]]})
    });
  ...
  const _BroadcastSubscription$ = dart.generic(function(T) {
    ...
    _BroadcastSubscription[dart.implements_] = () => [_BroadcastSubscriptionLink];
    dart.setSignature(_BroadcastSubscription, {
      constructors: () => ({_BroadcastSubscription: [_BroadcastSubscription$(T), [_StreamControllerLifecycle, dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]]}),
      methods: () => ({
        [_expectsEvent]: [core.bool, [core.int]],
        [_toggleEventId]: [dart.voidR, []],
        [_setRemoveAfterFiring]: [dart.voidR, []]
      })
    });
  ...
  const _BroadcastStreamController$ = dart.generic(function(T) {
    class _BroadcastStreamController extends core.Object {
      ...
      add(data) {
        dart.as(data, T);
        if (!dart.notNull(this[_mayAddEvent])) dart.throw_(this[_addEventError]());
        this[_sendData](data);
      }
      ...
      [_forEachListener](action) {
        dart.as(action, dart.functionType(dart.voidR, [_BufferingStreamSubscription$(T)]));
        if (dart.notNull(this[_isFiring])) {
          dart.throw_(new core.StateError("Cannot fire new event. Controller is already firing an event"));
        }
    ...
    _BroadcastStreamController[dart.implements_] = () => [StreamController$(T), _StreamControllerLifecycle$(T), _BroadcastSubscriptionLink, _EventSink$(T), _EventDispatch$(T)];
    dart.setSignature(_BroadcastStreamController, {
      ...
      methods: () => ({
        ...
        [_addListener]: [dart.voidR, [_BroadcastSubscription$(T)]],
        [_removeListener]: [dart.voidR, [_BroadcastSubscription$(T)]],
        [_subscribe]: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]],
        [_recordCancel]: [Future, [StreamSubscription$(T)]],
        [_recordPause]: [dart.voidR, [StreamSubscription$(T)]],
        [_recordResume]: [dart.voidR, [StreamSubscription$(T)]],
        [_addEventError]: [core.Error, []],
        add: [dart.voidR, [T]],
        addError: [dart.voidR, [core.Object], [core.StackTrace]],
        close: [Future, []],
        addStream: [Future, [Stream$(T)], {cancelOnError: core.bool}],
        [_add]: [dart.voidR, [T]],
        [_addError]: [dart.voidR, [core.Object, core.StackTrace]],
        [_close]: [dart.voidR, []],
        [_forEachListener]: [dart.voidR, [dart.functionType(dart.voidR, [_BufferingStreamSubscription$(T)])]],
        [_callOnCancel]: [dart.voidR, []]
      })
    });
  ...
  const _SyncBroadcastStreamController$ = dart.generic(function(T) {
    class _SyncBroadcastStreamController extends _BroadcastStreamController$(T) {
      ...
      [_sendData](data) {
        ...
        this[_forEachListener](dart.fn(subscription => {
          ...
          subscription[_add](data);
        }, dart.voidR, [_BufferingStreamSubscription$(T)]));
      }
      [_sendError](error, stackTrace) {
        if (dart.notNull(this[_isEmpty])) return;
        this[_forEachListener](dart.fn(subscription => {
      ...
      [_sendDone]() {
        if (!dart.notNull(this[_isEmpty])) {
          this[_forEachListener](dart.as(dart.fn(subscription => {
            dart.as(subscription, _BroadcastSubscription$(T));
            subscription[_close]();
          }, dart.voidR, [_BroadcastSubscription$(T)]), __CastType2));
        } else {
          dart.assert(this[_doneFuture] != null);
    ...
    dart.setSignature(_SyncBroadcastStreamController, {
      constructors: () => ({_SyncBroadcastStreamController: [_SyncBroadcastStreamController$(T), [dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, [])]]}),
      methods: () => ({
        [_sendData]: [dart.voidR, [T]],
        [_sendError]: [dart.voidR, [core.Object, core.StackTrace]],
        [_sendDone]: [dart.voidR, []]
  ...
  const _AsyncBroadcastStreamController$ = dart.generic(function(T) {
    class _AsyncBroadcastStreamController extends _BroadcastStreamController$(T) {
      ...
      [_sendDone]() {
        if (!dart.notNull(this[_isEmpty])) {
          for (let link = this[_next]; !dart.notNull(core.identical(link, this)); link = link[_next]) {
            let subscription = dart.as(link, _BroadcastSubscription$(T));
            subscription[_addPending](dart.const_(new _DelayedDone()));
          }
        } else {
          dart.assert(this[_doneFuture] != null);
          dart.assert(this[_doneFuture][_mayComplete]);
    ...
    dart.setSignature(_AsyncBroadcastStreamController, {
      constructors: () => ({_AsyncBroadcastStreamController: [_AsyncBroadcastStreamController$(T), [dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, [])]]}),
      methods: () => ({
        [_sendData]: [dart.voidR, [T]],
        [_sendError]: [dart.voidR, [core.Object, core.StackTrace]],
        [_sendDone]: [dart.voidR, []]
  ...
  const _AsBroadcastStreamController$ = dart.generic(function(T) {
    class _AsBroadcastStreamController extends _SyncBroadcastStreamController$(T) {
      ...
      close() {
        if (!dart.notNull(this.isClosed) && dart.notNull(this[_isFiring])) {
          this[_addPendingEvent](dart.const_(new _DelayedDone()));
          this[_state] = dart.notNull(this[_state]) | dart.notNull(_BroadcastStreamController._STATE_CLOSED);
          return super.done;
        }
    ...
    _AsBroadcastStreamController[dart.implements_] = () => [_EventDispatch$(T)];
    dart.setSignature(_AsBroadcastStreamController, {
      constructors: () => ({_AsBroadcastStreamController: [_AsBroadcastStreamController$(T), [dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, [])]]}),
      methods: () => ({
        [_addPendingEvent]: [dart.voidR, [_DelayedEvent]],
        add: [dart.voidR, [T]]
      })
    });
  ...
  const _DoneSubscription$ = dart.generic(function(T) {
    ...
    _DoneSubscription[dart.implements_] = () => [StreamSubscription$(T)];
    dart.setSignature(_DoneSubscription, {
      methods: () => ({
        ...
        pause: [dart.voidR, [], [Future]],
        resume: [dart.voidR, []],
        [_resume]: [dart.voidR, [dart.dynamicR]],
        cancel: [Future, []],
  ...
  const __CastType2$ = dart.generic(function(T) {
    const __CastType2 = dart.typedef('__CastType2', () => dart.functionType(dart.voidR, [_BufferingStreamSubscription$(T)]));
    return __CastType2;
  });
  ...
  class DeferredLibrary extends core.Object {
    ...
    load() {
      dart.throw_('DeferredLibrary not supported. ' + 'please use the `import "lib.dart" deferred as lib` syntax.');
    }
  }
  ...
  DeferredLibrary[dart.metadata] = () => [dart.const_(new core.Deprecated("Dart sdk v. 1.8"))];
  const _s = Symbol('_s');
  ...
  DeferredLoadException[dart.implements_] = () => [core.Exception];
  ...
  const Future$ = dart.generic(function(T) {
    class Future extends core.Object {
      ...
      static wait(futures, opts) {
        ...
        dart.as(cleanUp, dart.functionType(dart.voidR, [dart.dynamicR]));
        ...
        dart.fn(handleError, dart.voidR, [dart.dynamicR, dart.dynamicR]);
        for (let future of futures) {
          ...
          future.then(dart.fn(value => {
            remaining = dart.notNull(remaining) - 1;
            if (values != null) {
              values[dartx.set](pos, dart.as(value, dart.dynamicR));
              if (remaining == 0) {
              ...
              if (cleanUp != null && value != null) {
                Future$().sync(dart.fn(() => {
                  cleanUp(dart.as(value, dart.dynamicR));
                }));
              }
              if (remaining == 0 && !dart.notNull(eagerError)) {
                result[_completeError](error, stackTrace);
          ...
          }, dart.dynamicR, [core.Object]), {onError: handleError});
        }
        if (remaining == 0) {
          return Future$(core.List).value(dart.const_([]));
        }
        values = core.List.new(remaining);
        return result;
      }
      static forEach(input, f) {
        dart.as(f, dart.functionType(dart.dynamicR, [dart.dynamicR]));
        let iterator = input[dartx.iterator];
        return Future$().doWhile(dart.fn(() => {
          if (!dart.notNull(iterator.moveNext())) return false;
          return Future$().sync(dart.fn(() => dart.dcall(f, iterator.current))).then(dart.fn(_ => true, core.bool, [dart.dynamicR]));
        }));
      }
      static doWhile(f) {
        dart.as(f, dart.functionType(dart.dynamicR, []));
        ...
        }, dart.dynamicR, [core.bool]), {runGuarded: true});
    ...
    dart.setSignature(Future, {
      constructors: () => ({
        new: [Future$(T), [dart.functionType(dart.dynamicR, [])]],
        microtask: [Future$(T), [dart.functionType(dart.dynamicR, [])]],
        sync: [Future$(T), [dart.functionType(dart.dynamicR, [])]],
        value: [Future$(T), [], [dart.dynamicR]],
        error: [Future$(T), [core.Object], [core.StackTrace]],
        delayed: [Future$(T), [core.Duration], [dart.functionType(T, [])]]
      }),
      statics: () => ({
        wait: [Future$(core.List), [core.Iterable$(Future$())], {eagerError: core.bool, cleanUp: dart.functionType(dart.voidR, [dart.dynamicR])}],
        forEach: [Future$(), [core.Iterable, dart.functionType(dart.dynamicR, [dart.dynamicR])]],
        doWhile: [Future$(), [dart.functionType(dart.dynamicR, [])]]
      }),
  ...
  TimeoutException[dart.implements_] = () => [core.Exception];
  ...
  dart.fn(_completeWithErrorCallback, () => dart.definiteFunctionType(dart.voidR, [_Future, dart.dynamicR, dart.dynamicR]));
  ...
  const __CastType4 = dart.typedef('__CastType4', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  const _FutureOnValue$ = dart.generic(function(T) {
    const _FutureOnValue = dart.typedef('_FutureOnValue', () => dart.functionType(dart.dynamicR, [T]));
    return _FutureOnValue;
  });
  const _FutureOnValue = _FutureOnValue$();
  const _FutureErrorTest = dart.typedef('_FutureErrorTest', () => dart.functionType(core.bool, [dart.dynamicR]));
  const _FutureAction = dart.typedef('_FutureAction', () => dart.functionType(dart.dynamicR, []));
  const _Completer$ = dart.generic(function(T) {
    class _Completer extends core.Object {
      ...
      completeError(error, stackTrace) {
        if (stackTrace === void 0) stackTrace = null;
        error = _nonNullError(error);
        if (!dart.notNull(this.future[_mayComplete])) dart.throw_(new core.StateError("Future already completed"));
        let replacement = Zone.current.errorCallback(error, stackTrace);
        if (replacement != null) {
          error = _nonNullError(replacement.error);
          stackTrace = replacement.stackTrace;
    ...
    _Completer[dart.implements_] = () => [Completer$(T)];
    dart.setSignature(_Completer, {
      methods: () => ({completeError: [dart.voidR, [core.Object], [core.StackTrace]]})
    });
    return _Completer;
  });
  ...
  const _AsyncCompleter$ = dart.generic(function(T) {
    ...
    dart.setSignature(_AsyncCompleter, {
      methods: () => ({
        complete: [dart.voidR, [], [dart.dynamicR]],
        [_completeError]: [dart.voidR, [core.Object, core.StackTrace]]
      })
    });
  ...
  const _Future$ = dart.generic(function(T) {
    class _Future extends core.Object {
      ...
      then(f, opts) {
        dart.as(f, dart.functionType(dart.dynamicR, [T]));
        let onError = opts && 'onError' in opts ? opts.onError : null;
        let result = new (_Future$())();
      ...
      whenComplete(action) {
        dart.as(action, dart.functionType(dart.dynamicR, []));
        let result = new (_Future$(T))();
        if (!dart.notNull(core.identical(result[_zone], _ROOT_ZONE))) {
      ...
      [_markPendingCompletion]() {
        if (!dart.notNull(this[_mayComplete])) dart.throw_(new core.StateError("Future already completed"));
      ...
      static _chainForeignFuture(source, target) {
        ...
        source.then(dart.fn(value => {
          ...
          }, dart.dynamicR, [dart.dynamicR], [dart.dynamicR])});
      }
      ...
      static _propagateToListeners(source, listeners) {
        while (true) {
          ...
          if (dart.notNull(hasError) || dart.notNull(listener.handlesValue) || dart.notNull(listener.handlesComplete)) {
            ...
            dart.fn(handleError, dart.voidR, []);
            ...
            dart.fn(handleWhenCompleteCallback, dart.voidR, []);
            if (!dart.notNull(hasError)) {
      ...
      timeout(timeLimit, opts) {
        let onTimeout = opts && 'onTimeout' in opts ? opts.onTimeout : null;
        dart.as(onTimeout, dart.functionType(dart.dynamicR, []));
        ...
        }, dart.dynamicR, [T]), {onError: dart.fn((e, s) => {
            if (dart.notNull(timer.isActive)) {
              timer.cancel();
    ...
    _Future[dart.implements_] = () => [Future$(T)];
    dart.defineNamedConstructor(_Future, 'immediate');
    dart.defineNamedConstructor(_Future, 'immediateError');
    dart.setSignature(_Future, {
      constructors: () => ({
        _Future: [_Future$(T), []],
        immediate: [_Future$(T), [dart.dynamicR]],
        immediateError: [_Future$(T), [dart.dynamicR], [core.StackTrace]]
      }),
      methods: () => ({
        then: [Future, [dart.functionType(dart.dynamicR, [T])], {onError: core.Function}],
        catchError: [Future, [core.Function], {test: dart.functionType(core.bool, [dart.dynamicR])}],
        whenComplete: [Future$(T), [dart.functionType(dart.dynamicR, [])]],
        asStream: [Stream$(T), []],
        [_markPendingCompletion]: [dart.voidR, []],
        [_setValue]: [dart.voidR, [T]],
        [_setErrorObject]: [dart.voidR, [AsyncError]],
        [_setError]: [dart.voidR, [core.Object, core.StackTrace]],
        [_addListener]: [dart.voidR, [_FutureListener]],
        [_removeListeners]: [_FutureListener, []],
        [_complete]: [dart.voidR, [dart.dynamicR]],
        [_completeWithValue]: [dart.voidR, [dart.dynamicR]],
        [_completeError]: [dart.voidR, [dart.dynamicR], [core.StackTrace]],
        [_asyncComplete]: [dart.voidR, [dart.dynamicR]],
        [_asyncCompleteError]: [dart.voidR, [dart.dynamicR, core.StackTrace]],
        timeout: [Future, [core.Duration], {onTimeout: dart.functionType(dart.dynamicR, [])}]
      }),
      statics: () => ({
        _chainForeignFuture: [dart.voidR, [Future, _Future$()]],
        _chainCoreFuture: [dart.voidR, [_Future$(), _Future$()]],
        _propagateToListeners: [dart.voidR, [_Future$(), _FutureListener]]
      }),
  ...
  const __CastType8 = dart.typedef('__CastType8', () => dart.functionType(core.bool, [dart.dynamicR]));
  const __CastType10 = dart.typedef('__CastType10', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  const _AsyncCallback = dart.typedef('_AsyncCallback', () => dart.functionType(dart.voidR, []));
  ...
  dart.fn(_asyncRunCallbackLoop, dart.voidR, []);
  ...
  dart.fn(_asyncRunCallback, dart.voidR, []);
  ...
  dart.fn(_scheduleAsyncCallback, dart.voidR, [dart.dynamicR]);
  ...
  dart.fn(_schedulePriorityAsyncCallback, dart.voidR, [dart.dynamicR]);
  ...
  dart.fn(scheduleMicrotask, dart.voidR, [dart.functionType(dart.voidR, [])]);
  class _AsyncRun extends core.Object {
    ...
    static _initializeScheduleImmediate() {
      ...
      if (self.MutationObserver != null && self.document != null) {
        ...
        }, dart.dynamicR, [dart.functionType(dart.voidR, [])]);
  ...
  dart.setSignature(_AsyncRun, {
    statics: () => ({
      _scheduleImmediate: [dart.voidR, [dart.functionType(dart.voidR, [])]],
      _initializeScheduleImmediate: [core.Function, []],
      _scheduleImmediateJsOverride: [dart.voidR, [dart.functionType(dart.voidR, [])]],
      _scheduleImmediateWithSetImmediate: [dart.voidR, [dart.functionType(dart.voidR, [])]],
      _scheduleImmediateWithTimer: [dart.voidR, [dart.functionType(dart.voidR, [])]]
    }),
  ...
  const EventSink$ = dart.generic(function(T) {
    ...
    EventSink[dart.implements_] = () => [core.Sink$(T)];
    return EventSink;
  });
  ...
  const StreamSink$ = dart.generic(function(S) {
    ...
    StreamSink[dart.implements_] = () => [StreamConsumer$(S), EventSink$(S)];
    return StreamSink;
  });
  ...
  const StreamTransformer$ = dart.generic(function(S, T) {
    ...
    dart.setSignature(StreamTransformer, {
      constructors: () => ({
        ...
        fromHandlers: [StreamTransformer$(S, T), [], {handleData: dart.functionType(dart.voidR, [S, EventSink$(T)]), handleError: dart.functionType(dart.voidR, [core.Object, core.StackTrace, EventSink$(T)]), handleDone: dart.functionType(dart.voidR, [EventSink$(T)])}]
      })
    });
  ...
  const _ControllerEventSinkWrapper$ = dart.generic(function(T) {
    ...
    _ControllerEventSinkWrapper[dart.implements_] = () => [EventSink$(T)];
    dart.setSignature(_ControllerEventSinkWrapper, {
      ...
      methods: () => ({
        add: [dart.voidR, [T]],
        addError: [dart.voidR, [dart.dynamicR], [core.StackTrace]],
        close: [dart.voidR, []]
      })
    });
  ...
  const __CastType12 = dart.typedef('__CastType12', () => dart.functionType(dart.voidR, [StreamSubscription]));
  const __CastType14 = dart.typedef('__CastType14', () => dart.functionType(dart.dynamicR, [dart.dynamicR, core.StackTrace]));
  const __CastType17 = dart.typedef('__CastType17', () => dart.functionType(dart.voidR, []));
  const __CastType18 = dart.typedef('__CastType18', () => dart.functionType(dart.voidR, [EventSink]));
  const StreamController$ = dart.generic(function(T) {
    ...
    StreamController[dart.implements_] = () => [StreamSink$(T)];
    dart.setSignature(StreamController, {
      constructors: () => ({
        new: [StreamController$(T), [], {onListen: dart.functionType(dart.voidR, []), onPause: dart.functionType(dart.voidR, []), onResume: dart.functionType(dart.voidR, []), onCancel: dart.functionType(dart.dynamicR, []), sync: core.bool}],
        broadcast: [StreamController$(T), [], {onListen: dart.functionType(dart.voidR, []), onCancel: dart.functionType(dart.voidR, []), sync: core.bool}]
      })
    });
  ...
  const _StreamController$ = dart.generic(function(T) {
    class _StreamController extends core.Object {
      ...
      addStream(source, opts) {
        ...
        let cancelOnError = opts && 'cancelOnError' in opts ? opts.cancelOnError : true;
        if (!dart.notNull(this[_mayAddEvent])) dart.throw_(this[_badEventState]());
      ...
      [_closeUnchecked]() {
        ...
        if (dart.notNull(this.hasListener)) {
          ...
          this[_ensurePendingEvents]().add(dart.const_(new _DelayedDone()));
        }
      }
      [_add](value) {
        dart.as(value, T);
      ...
      [_subscribe](onData, onError, onDone, cancelOnError) {
        ...
        if (!dart.notNull(this[_isInitialState])) {
          dart.throw_(new core.StateError("Stream has already been listened to."));
        }
    ...
    _StreamController[dart.implements_] = () => [StreamController$(T), _StreamControllerLifecycle$(T), _EventSink$(T), _EventDispatch$(T)];
  ...
  const _SyncStreamControllerDispatch$ = dart.generic(function(T) {
    ...
    _SyncStreamControllerDispatch[dart.implements_] = () => [_StreamController$(T)];
  ...
  const _AsyncStreamControllerDispatch$ = dart.generic(function(T) {
    class _AsyncStreamControllerDispatch extends core.Object {
      ...
      [_sendDone]() {
        this[_subscription][_addPending](dart.const_(new _DelayedDone()));
      }
    }
    _AsyncStreamControllerDispatch[dart.implements_] = () => [_StreamController$(T)];
  ...
  const _AsyncStreamController$ = dart.generic(function(T) {
    ...
    dart.setSignature(_AsyncStreamController, {
      constructors: () => ({_AsyncStreamController: [_AsyncStreamController$(T), [dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, []), dart.functionType(dart.dynamicR, [])]]})
    });
  ...
  const _SyncStreamController$ = dart.generic(function(T) {
    ...
    dart.setSignature(_SyncStreamController, {
      constructors: () => ({_SyncStreamController: [_SyncStreamController$(T), [dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, []), dart.functionType(dart.voidR, []), dart.functionType(dart.dynamicR, [])]]})
    });
  ...
  const _NotificationHandler = dart.typedef('_NotificationHandler', () => dart.functionType(dart.dynamicR, []));
  ...
  const _StreamSinkWrapper$ = dart.generic(function(T) {
    ...
    _StreamSinkWrapper[dart.implements_] = () => [StreamSink$(T)];
  ...
  const _AddStreamState$ = dart.generic(function(T) {
    class _AddStreamState extends core.Object {
      ...
      static makeErrorHandler(controller) {
        return dart.fn((e, s) => {
          ...
          controller[_close]();
        }, dart.dynamicR, [dart.dynamicR, core.StackTrace]);
      }
      pause() {
    ...
    dart.setSignature(_AddStreamState, {
      ...
      statics: () => ({makeErrorHandler: [dart.dynamicR, [_EventSink]]}),
  ...
  const _StreamControllerAddStreamState$ = dart.generic(function(T) {
    ...
    dart.setSignature(_StreamControllerAddStreamState, {
      constructors: () => ({_StreamControllerAddStreamState: [_StreamControllerAddStreamState$(T), [_StreamController, dart.dynamicR, Stream, core.bool]]})
    });
  ...
  const _GeneratedStreamImpl$ = dart.generic(function(T) {
    class _GeneratedStreamImpl extends _StreamImpl$(T) {
      ...
      [_createSubscription](onData, onError, onDone, cancelOnError) {
        dart.as(onData, dart.functionType(dart.voidR, [T]));
        dart.as(onDone, dart.functionType(dart.voidR, []));
        if (dart.notNull(this[_isUsed])) dart.throw_(new core.StateError("Stream has already been listened to."));
        this[_isUsed] = true;
    ...
    dart.setSignature(_GeneratedStreamImpl, {
      ...
      methods: () => ({[_createSubscription]: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]]})
    });
  ...
  dart.setSignature(_PendingEvents, {
    methods: () => ({
      schedule: [dart.voidR, [_EventDispatch]],
      cancelSchedule: [dart.voidR, []]
    })
  });
  ...
  const _IterablePendingEvents$ = dart.generic(function(T) {
    class _IterablePendingEvents extends _PendingEvents {
      ...
      handleNext(dispatch) {
        if (this[_iterator] == null) {
          dart.throw_(new core.StateError("No events pending."));
        }
        let isDone = null;
        try {
    ...
    dart.setSignature(_IterablePendingEvents, {
      ...
      methods: () => ({
        handleNext: [dart.voidR, [_EventDispatch]],
        clear: [dart.voidR, []]
      })
    });
  ...
  const _DataHandler$ = dart.generic(function(T) {
    const _DataHandler = dart.typedef('_DataHandler', () => dart.functionType(dart.voidR, [T]));
    return _DataHandler;
  });
  const _DataHandler = _DataHandler$();
  const _DoneHandler = dart.typedef('_DoneHandler', () => dart.functionType(dart.voidR, []));
  function _nullDataHandler(value) {
  }
  dart.fn(_nullDataHandler, dart.voidR, [dart.dynamicR]);
  function _nullErrorHandler(error, stackTrace) {
    if (stackTrace === void 0) stackTrace = null;
    Zone.current.handleUncaughtError(error, stackTrace);
  }
  dart.fn(_nullErrorHandler, dart.voidR, [dart.dynamicR], [core.StackTrace]);
  function _nullDoneHandler() {
  }
  dart.fn(_nullDoneHandler, dart.voidR, []);
  ...
  const _DelayedData$ = dart.generic(function(T) {
    ...
    dart.setSignature(_DelayedData, {
      ...
      methods: () => ({perform: [dart.voidR, [_EventDispatch$(T)]]})
    });
    return _DelayedData;
  });
  ...
  dart.setSignature(_DelayedError, {
    constructors: () => ({_DelayedError: [_DelayedError, [dart.dynamicR, core.StackTrace]]}),
    methods: () => ({perform: [dart.voidR, [_EventDispatch]]})
  });
  class _DelayedDone extends core.Object {
    ...
    set next(_) {
      dart.throw_(new core.StateError("No events after a done."));
    }
  }
  _DelayedDone[dart.implements_] = () => [_DelayedEvent];
  ...
  dart.setSignature(_BroadcastLinkedList, {
    methods: () => ({
      [_unlink]: [dart.voidR, []],
      [_insertBefore]: [dart.voidR, [_BroadcastLinkedList]]
    })
  });
  const _broadcastCallback = dart.typedef('_broadcastCallback', () => dart.functionType(dart.voidR, [StreamSubscription]));
  ...
  const _AsBroadcastStream$ = dart.generic(function(T) {
    ...
    dart.setSignature(_AsBroadcastStream, {
      constructors: () => ({_AsBroadcastStream: [_AsBroadcastStream$(T), [Stream$(T), dart.functionType(dart.voidR, [StreamSubscription]), dart.functionType(dart.voidR, [StreamSubscription])]]}),
      methods: () => ({
        listen: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T])], {onError: core.Function, onDone: dart.functionType(dart.voidR, []), cancelOnError: core.bool}],
        [_onCancel]: [dart.voidR, []],
        [_onListen]: [dart.voidR, []],
        [_cancelSubscription]: [dart.voidR, []],
        [_pauseSubscription]: [dart.voidR, [Future]],
        [_resumeSubscription]: [dart.voidR, []]
      })
    });
  ...
  const _BroadcastSubscriptionWrapper$ = dart.generic(function(T) {
    class _BroadcastSubscriptionWrapper extends core.Object {
      ...
      onData(handleData) {
        dart.as(handleData, dart.functionType(dart.voidR, [T]));
        dart.throw_(new core.UnsupportedError("Cannot change handlers of asBroadcastStream source subscription."));
      }
      onError(handleError) {
        dart.throw_(new core.UnsupportedError("Cannot change handlers of asBroadcastStream source subscription."));
      }
    ...
    _BroadcastSubscriptionWrapper[dart.implements_] = () => [StreamSubscription$(T)];
  ...
  const _StreamIteratorImpl$ = dart.generic(function(T) {
    class _StreamIteratorImpl extends core.Object {
      ...
      moveNext() {
        ...
        if (this[_state] == _StreamIteratorImpl$()._STATE_MOVING) {
          dart.throw_(new core.StateError("Already waiting for next."));
        }
    ...
    _StreamIteratorImpl[dart.implements_] = () => [StreamIterator$(T)];
    dart.setSignature(_StreamIteratorImpl, {
      ...
      methods: () => ({
        ...
        [_clear]: [dart.voidR, []],
        cancel: [Future, []],
        [_onData]: [dart.voidR, [T]],
        [_onError]: [dart.voidR, [core.Object], [core.StackTrace]],
        [_onDone]: [dart.voidR, []]
      })
    });
  ...
  const __CastType20$ = dart.generic(function(T) {
    const __CastType20 = dart.typedef('__CastType20', () => dart.functionType(dart.voidR, [T]));
    return __CastType20;
  });
  const __CastType20 = __CastType20$();
  const __CastType22 = dart.typedef('__CastType22', () => dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]));
  const __CastType25 = dart.typedef('__CastType25', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  ...
  dart.fn(_runUserCode, dart.dynamicR, [dart.functionType(dart.dynamicR, []), dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.functionType(dart.dynamicR, [dart.dynamicR, core.StackTrace])]);
  function _cancelAndError(subscription, future, error, stackTrace) {
    ...
    if (dart.is(cancelFuture, Future)) {
      cancelFuture.whenComplete(dart.fn(() => future[_completeError](error, stackTrace), dart.voidR, []));
    } else {
      future[_completeError](error, stackTrace);
    }
  }
  dart.fn(_cancelAndError, dart.voidR, [StreamSubscription, _Future, dart.dynamicR, core.StackTrace]);
  ...
  dart.fn(_cancelAndErrorWithReplacement, dart.voidR, [StreamSubscription, _Future, dart.dynamicR, core.StackTrace]);
  function _cancelAndErrorClosure(subscription, future) {
    return dart.fn((error, stackTrace) => _cancelAndError(subscription, future, error, stackTrace), dart.voidR, [dart.dynamicR, core.StackTrace]);
  }
  dart.fn(_cancelAndErrorClosure, dart.dynamicR, [StreamSubscription, _Future]);
  function _cancelAndValue(subscription, future, value) {
    let cancelFuture = subscription.cancel();
    if (dart.is(cancelFuture, Future)) {
      cancelFuture.whenComplete(dart.fn(() => future[_complete](value), dart.voidR, []));
    } else {
      future[_complete](value);
    }
  }
  dart.fn(_cancelAndValue, dart.voidR, [StreamSubscription, _Future, dart.dynamicR]);
  ...
  const _ForwardingStream$ = dart.generic(function(S, T) {
    ...
    dart.setSignature(_ForwardingStream, {
      ...
      methods: () => ({
        listen: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T])], {onError: core.Function, onDone: dart.functionType(dart.voidR, []), cancelOnError: core.bool}],
        [_createSubscription]: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]],
        [_handleData]: [dart.voidR, [S, _EventSink$(T)]],
        [_handleError]: [dart.voidR, [dart.dynamicR, core.StackTrace, _EventSink$(T)]],
        [_handleDone]: [dart.voidR, [_EventSink$(T)]]
      })
    });
  ...
  const _ForwardingStreamSubscription$ = dart.generic(function(S, T) {
    ...
    dart.setSignature(_ForwardingStreamSubscription, {
      constructors: () => ({_ForwardingStreamSubscription: [_ForwardingStreamSubscription$(S, T), [_ForwardingStream$(S, T), dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]]}),
      methods: () => ({
        [_add]: [dart.voidR, [T]],
        [_handleData]: [dart.voidR, [S]],
        [_handleError]: [dart.voidR, [dart.dynamicR, core.StackTrace]],
        [_handleDone]: [dart.voidR, []]
      })
    });
  ...
  dart.fn(_addErrorWithReplacement, dart.voidR, [_EventSink, dart.dynamicR, dart.dynamicR]);
  ...
  const _WhereStream$ = dart.generic(function(T) {
    ...
    dart.setSignature(_WhereStream, {
      ...
      methods: () => ({[_handleData]: [dart.voidR, [T, _EventSink$(T)]]})
    });
    return _WhereStream;
  });
  ...
  const _MapStream$ = dart.generic(function(S, T) {
    ...
    dart.setSignature(_MapStream, {
      ...
      methods: () => ({[_handleData]: [dart.voidR, [S, _EventSink$(T)]]})
    });
    return _MapStream;
  });
  ...
  const _ErrorTest = dart.typedef('_ErrorTest', () => dart.functionType(core.bool, [dart.dynamicR]));
  const _HandleErrorStream$ = dart.generic(function(T) {
    ...
    dart.setSignature(_HandleErrorStream, {
      constructors: () => ({_HandleErrorStream: [_HandleErrorStream$(T), [Stream$(T), core.Function, dart.functionType(core.bool, [dart.dynamicR])]]}),
      methods: () => ({[_handleError]: [dart.voidR, [core.Object, core.StackTrace, _EventSink$(T)]]})
    });
  ...
  const _TakeStream$ = dart.generic(function(T) {
    class _TakeStream extends _ForwardingStream$(T, T) {
      _TakeStream(source, count) {
        ...
        super._ForwardingStream(source);
        if (!(typeof count == 'number')) dart.throw_(new core.ArgumentError(count));
      }
      [_handleData](inputEvent, sink) {
        dart.as(inputEvent, T);
        dart.as(sink, _EventSink$(T));
  ...
  const _SkipStream$ = dart.generic(function(T) {
    class _SkipStream extends _ForwardingStream$(T, T) {
      _SkipStream(source, count) {
        this[_remaining] = count;
        super._ForwardingStream(source);
        if (!(typeof count == 'number') || dart.notNull(count) < 0) dart.throw_(new core.ArgumentError(count));
      }
      [_handleData](inputEvent, sink) {
        dart.as(inputEvent, T);
        dart.as(sink, _EventSink$(T));
  ...
  const _EventSinkWrapper$ = dart.generic(function(T) {
    ...
    _EventSinkWrapper[dart.implements_] = () => [EventSink$(T)];
  ...
  const _SinkTransformerStreamSubscription$ = dart.generic(function(S, T) {
    class _SinkTransformerStreamSubscription extends _BufferingStreamSubscription$(T) {
      ...
      [_add](data) {
        ...
        if (dart.notNull(this[_isClosed])) {
          dart.throw_(new core.StateError("Stream is already closed"));
        }
        super[_add](data);
      }
      [_addError](error, stackTrace) {
    ...
    dart.setSignature(_SinkTransformerStreamSubscription, {
      constructors: () => ({_SinkTransformerStreamSubscription: [_SinkTransformerStreamSubscription$(S, T), [Stream$(S), _SinkMapper$(S, T), dart.functionType(dart.voidR, [T]), core.Function, dart.functionType(dart.voidR, []), core.bool]]}),
      methods: () => ({
        [_add]: [dart.voidR, [T]],
        [_handleData]: [dart.voidR, [S]],
        [_handleError]: [dart.voidR, [dart.dynamicR], [dart.dynamicR]],
        [_handleDone]: [dart.voidR, []]
      })
    });
  ...
  const _StreamSinkTransformer$ = dart.generic(function(S, T) {
    ...
    _StreamSinkTransformer[dart.implements_] = () => [StreamTransformer$(S, T)];
  ...
  const _BoundSinkStream$ = dart.generic(function(S, T) {
    class _BoundSinkStream extends Stream$(T) {
      ...
      listen(onData, opts) {
        ...
        let cancelOnError = opts && 'cancelOnError' in opts ? opts.cancelOnError : null;
        cancelOnError = core.identical(true, cancelOnError);
        let subscription = new (_SinkTransformerStreamSubscription$(dart.dynamicR, T))(this[_stream], this[_sinkMapper], onData, onError, onDone, cancelOnError);
        return subscription;
      }
    }
    dart.setSignature(_BoundSinkStream, {
      constructors: () => ({_BoundSinkStream: [_BoundSinkStream$(S, T), [Stream$(S), _SinkMapper$(S, T)]]}),
      methods: () => ({listen: [StreamSubscription$(T), [dart.functionType(dart.voidR, [T])], {onError: core.Function, onDone: dart.functionType(dart.voidR, []), cancelOnError: core.bool}]})
    });
    return _BoundSinkStream;
  });
  const _BoundSinkStream = _BoundSinkStream$();
  const _TransformDataHandler$ = dart.generic(function(S, T) {
    const _TransformDataHandler = dart.typedef('_TransformDataHandler', () => dart.functionType(dart.voidR, [S, EventSink$(T)]));
  ...
  const _TransformErrorHandler$ = dart.generic(function(T) {
    const _TransformErrorHandler = dart.typedef('_TransformErrorHandler', () => dart.functionType(dart.voidR, [core.Object, core.StackTrace, EventSink$(T)]));
  ...
  const _TransformDoneHandler$ = dart.generic(function(T) {
    const _TransformDoneHandler = dart.typedef('_TransformDoneHandler', () => dart.functionType(dart.voidR, [EventSink$(T)]));
  ...
  const _HandlerEventSink$ = dart.generic(function(S, T) {
    ...
    _HandlerEventSink[dart.implements_] = () => [EventSink$(S)];
  ...
  const _StreamHandlerTransformer$ = dart.generic(function(S, T) {
    ...
    dart.setSignature(_StreamHandlerTransformer, {
      constructors: () => ({_StreamHandlerTransformer: [_StreamHandlerTransformer$(S, T), [], {handleData: dart.functionType(dart.voidR, [S, EventSink$(T)]), handleError: dart.functionType(dart.voidR, [core.Object, core.StackTrace, EventSink$(T)]), handleDone: dart.functionType(dart.voidR, [EventSink$(T)])}]}),
      methods: () => ({bind: [Stream$(T), [Stream$(S)]]}),
      statics: () => ({
        _defaultHandleData: [dart.voidR, [dart.dynamicR, EventSink]],
        _defaultHandleError: [dart.voidR, [dart.dynamicR, core.StackTrace, EventSink]],
        _defaultHandleDone: [dart.voidR, [EventSink]]
      }),
  ...
  const _StreamSubscriptionTransformer$ = dart.generic(function(S, T) {
    ...
    _StreamSubscriptionTransformer[dart.implements_] = () => [StreamTransformer$(S, T)];
  ...
  const __CastType27$ = dart.generic(function(S, T) {
    const __CastType27 = dart.typedef('__CastType27', () => dart.functionType(dart.voidR, [S, EventSink$(T)]));
    return __CastType27;
  });
  const __CastType27 = __CastType27$();
  const __CastType30$ = dart.generic(function(T) {
    const __CastType30 = dart.typedef('__CastType30', () => dart.functionType(dart.voidR, [core.Object, core.StackTrace, EventSink$(T)]));
    return __CastType30;
  });
  ...
  dart.setSignature(Timer, {
    constructors: () => ({
      new: [Timer, [core.Duration, dart.functionType(dart.voidR, [])]],
      periodic: [Timer, [core.Duration, dart.functionType(dart.voidR, [Timer])]]
    }),
    statics: () => ({
      run: [dart.voidR, [dart.functionType(dart.voidR, [])]],
      _createTimer: [Timer, [core.Duration, dart.functionType(dart.voidR, [])]],
      _createPeriodicTimer: [Timer, [core.Duration, dart.functionType(dart.voidR, [Timer])]]
    }),
    names: ['run', '_createTimer', '_createPeriodicTimer']
  });
  const __CastType34 = dart.typedef('__CastType34', () => dart.functionType(dart.voidR, [Timer]));
  const ZoneCallback = dart.typedef('ZoneCallback', () => dart.functionType(dart.dynamicR, []));
  const ZoneUnaryCallback = dart.typedef('ZoneUnaryCallback', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  const ZoneBinaryCallback = dart.typedef('ZoneBinaryCallback', () => dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]));
  const HandleUncaughtErrorHandler = dart.typedef('HandleUncaughtErrorHandler', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.dynamicR, core.StackTrace]));
  const RunHandler = dart.typedef('RunHandler', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]));
  const RunUnaryHandler = dart.typedef('RunUnaryHandler', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]));
  const RunBinaryHandler = dart.typedef('RunBinaryHandler', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]));
  const RegisterCallbackHandler = dart.typedef('RegisterCallbackHandler', () => dart.functionType(ZoneCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]));
  const RegisterUnaryCallbackHandler = dart.typedef('RegisterUnaryCallbackHandler', () => dart.functionType(ZoneUnaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR])]));
  const RegisterBinaryCallbackHandler = dart.typedef('RegisterBinaryCallbackHandler', () => dart.functionType(ZoneBinaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]));
  ...
  const ScheduleMicrotaskHandler = dart.typedef('ScheduleMicrotaskHandler', () => dart.functionType(dart.voidR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]));
  const CreateTimerHandler = dart.typedef('CreateTimerHandler', () => dart.functionType(Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [])]));
  const CreatePeriodicTimerHandler = dart.typedef('CreatePeriodicTimerHandler', () => dart.functionType(Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [Timer])]));
  const PrintHandler = dart.typedef('PrintHandler', () => dart.functionType(dart.voidR, [Zone, ZoneDelegate, Zone, core.String]));
  ...
  dart.setSignature(ZoneSpecification, {
    constructors: () => ({
      new: [ZoneSpecification, [], {handleUncaughtError: dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.dynamicR, core.StackTrace]), run: dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]), runUnary: dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]), runBinary: dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]), registerCallback: dart.functionType(ZoneCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]), registerUnaryCallback: dart.functionType(ZoneUnaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR])]), registerBinaryCallback: dart.functionType(ZoneBinaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]), errorCallback: dart.functionType(AsyncError, [Zone, ZoneDelegate, Zone, core.Object, core.StackTrace]), scheduleMicrotask: dart.functionType(dart.voidR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]), createTimer: dart.functionType(Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [])]), createPeriodicTimer: dart.functionType(Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [Timer])]), print: dart.functionType(dart.voidR, [Zone, ZoneDelegate, Zone, core.String]), fork: dart.functionType(Zone, [Zone, ZoneDelegate, Zone, ZoneSpecification, core.Map])}],
  ...
  _ZoneSpecification[dart.implements_] = () => [ZoneSpecification];
  ...
  class _RootZone extends _Zone {
    ...
    get [_run]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootRun));
    }
    get [_runUnary]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootRunUnary));
    }
    get [_runBinary]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootRunBinary));
    }
    get [_registerCallback]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootRegisterCallback));
    }
    get [_registerUnaryCallback]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootRegisterUnaryCallback));
    }
    get [_registerBinaryCallback]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootRegisterBinaryCallback));
    }
    get [_errorCallback]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootErrorCallback));
    }
    get [_scheduleMicrotask]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootScheduleMicrotask));
    }
    get [_createTimer]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootCreateTimer));
    }
    get [_createPeriodicTimer]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootCreatePeriodicTimer));
    }
    get [_print]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootPrint));
    }
    get [_fork]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootFork));
    }
    get [_handleUncaughtError]() {
      return dart.const_(new _ZoneFunction(_ROOT_ZONE, _rootHandleUncaughtError));
    }
    get parent() {
      return null;
    }
  ...
  dart.setSignature(_RootZone, {
    ...
    methods: () => ({
      runGuarded: [dart.dynamicR, [dart.functionType(dart.dynamicR, [])]],
      runUnaryGuarded: [dart.dynamicR, [dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]],
      runBinaryGuarded: [dart.dynamicR, [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]],
      bindCallback: [ZoneCallback, [dart.functionType(dart.dynamicR, [])], {runGuarded: core.bool}],
      bindUnaryCallback: [ZoneUnaryCallback, [dart.functionType(dart.dynamicR, [dart.dynamicR])], {runGuarded: core.bool}],
      bindBinaryCallback: [ZoneBinaryCallback, [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])], {runGuarded: core.bool}],
      get: [dart.dynamicR, [core.Object]],
      handleUncaughtError: [dart.dynamicR, [dart.dynamicR, core.StackTrace]],
      fork: [Zone, [], {specification: ZoneSpecification, zoneValues: core.Map}],
      run: [dart.dynamicR, [dart.functionType(dart.dynamicR, [])]],
      runUnary: [dart.dynamicR, [dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]],
      runBinary: [dart.dynamicR, [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]],
      registerCallback: [ZoneCallback, [dart.functionType(dart.dynamicR, [])]],
      registerUnaryCallback: [ZoneUnaryCallback, [dart.functionType(dart.dynamicR, [dart.dynamicR])]],
      registerBinaryCallback: [ZoneBinaryCallback, [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]],
      errorCallback: [AsyncError, [core.Object, core.StackTrace]],
      scheduleMicrotask: [dart.voidR, [dart.functionType(dart.voidR, [])]],
      createTimer: [Timer, [core.Duration, dart.functionType(dart.voidR, [])]],
      createPeriodicTimer: [Timer, [core.Duration, dart.functionType(dart.voidR, [Timer])]],
      print: [dart.voidR, [core.String]]
    })
  });
  const _ROOT_ZONE = dart.const_(new _RootZone());
  ...
  _ZoneDelegate[dart.implements_] = () => [ZoneDelegate];
  dart.setSignature(_ZoneDelegate, {
    constructors: () => ({_ZoneDelegate: [_ZoneDelegate, [_Zone]]}),
    methods: () => ({
      handleUncaughtError: [dart.dynamicR, [Zone, dart.dynamicR, core.StackTrace]],
      run: [dart.dynamicR, [Zone, dart.functionType(dart.dynamicR, [])]],
      runUnary: [dart.dynamicR, [Zone, dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]],
      runBinary: [dart.dynamicR, [Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]],
      registerCallback: [ZoneCallback, [Zone, dart.functionType(dart.dynamicR, [])]],
      registerUnaryCallback: [ZoneUnaryCallback, [Zone, dart.functionType(dart.dynamicR, [dart.dynamicR])]],
      registerBinaryCallback: [ZoneBinaryCallback, [Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]],
      errorCallback: [AsyncError, [Zone, core.Object, core.StackTrace]],
      scheduleMicrotask: [dart.voidR, [Zone, dart.functionType(dart.dynamicR, [])]],
      createTimer: [Timer, [Zone, core.Duration, dart.functionType(dart.voidR, [])]],
      createPeriodicTimer: [Timer, [Zone, core.Duration, dart.functionType(dart.voidR, [Timer])]],
      print: [dart.voidR, [Zone, core.String]],
  ...
  function _rootHandleUncaughtError(self, parent, zone, error, stackTrace) {
    _schedulePriorityAsyncCallback(dart.fn(() => {
      dart.throw_(new _UncaughtAsyncError(error, stackTrace));
    }));
  }
  dart.fn(_rootHandleUncaughtError, dart.voidR, [Zone, ZoneDelegate, Zone, dart.dynamicR, core.StackTrace]);
  ...
  dart.fn(_rootRun, dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]);
  ...
  dart.fn(_rootRunUnary, dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]);
  ...
  dart.fn(_rootRunBinary, dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]);
  function _rootRegisterCallback(self, parent, zone, f) {
    return f;
  }
  dart.fn(_rootRegisterCallback, ZoneCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]);
  function _rootRegisterUnaryCallback(self, parent, zone, f) {
    return f;
  }
  dart.fn(_rootRegisterUnaryCallback, ZoneUnaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR])]);
  function _rootRegisterBinaryCallback(self, parent, zone, f) {
    return f;
  }
  dart.fn(_rootRegisterBinaryCallback, ZoneBinaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]);
  ...
  dart.fn(_rootScheduleMicrotask, dart.voidR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]);
  ...
  dart.fn(_rootCreateTimer, Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [])]);
  ...
  dart.fn(_rootCreatePeriodicTimer, Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [Timer])]);
  function _rootPrint(self, parent, zone, line) {
    _internal.printToConsole(line);
  }
  dart.fn(_rootPrint, dart.voidR, [Zone, ZoneDelegate, Zone, core.String]);
  function _printToZone(line) {
    Zone.current.print(line);
  }
  dart.fn(_printToZone, dart.voidR, [core.String]);
  function _rootFork(self, parent, zone, specification, zoneValues) {
    _internal.printToZone = _printToZone;
    if (specification == null) {
      specification = dart.const_(ZoneSpecification.new());
    } else if (!dart.is(specification, _ZoneSpecification)) {
      dart.throw_(new core.ArgumentError("ZoneSpecifications must be instantiated" + " with the provided constructor."));
    }
    let valueMap = null;
    if (zoneValues == null) {
  ...
  _RootZoneSpecification[dart.implements_] = () => [ZoneSpecification];
  ...
  function runZoned(body, opts) {
    ...
    if (onError != null) {
      ...
      }, dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.dynamicR, core.StackTrace]);
    }
  ...
  dart.fn(runZoned, dart.dynamicR, [dart.functionType(dart.dynamicR, [])], {zoneValues: core.Map, zoneSpecification: ZoneSpecification, onError: core.Function});
  const __CastType36 = dart.typedef('__CastType36', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.dynamicR, core.StackTrace]));
  const __CastType42 = dart.typedef('__CastType42', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]));
  const __CastType47 = dart.typedef('__CastType47', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.dynamicR]));
  const __CastType54 = dart.typedef('__CastType54', () => dart.functionType(dart.dynamicR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]), dart.dynamicR, dart.dynamicR]));
  const __CastType63 = dart.typedef('__CastType63', () => dart.functionType(ZoneCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]));
  const __CastType68 = dart.typedef('__CastType68', () => dart.functionType(ZoneUnaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR])]));
  const __CastType74 = dart.typedef('__CastType74', () => dart.functionType(ZoneBinaryCallback, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]));
  ...
  const __CastType87 = dart.typedef('__CastType87', () => dart.functionType(dart.voidR, [Zone, ZoneDelegate, Zone, dart.functionType(dart.dynamicR, [])]));
  const __CastType92 = dart.typedef('__CastType92', () => dart.functionType(Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [])]));
  const __CastType98 = dart.typedef('__CastType98', () => dart.functionType(Timer, [Zone, ZoneDelegate, Zone, core.Duration, dart.functionType(dart.voidR, [Timer])]));
  const __CastType105 = dart.typedef('__CastType105', () => dart.functionType(dart.voidR, [Zone, ZoneDelegate, Zone, core.String]));
  const __CastType110 = dart.typedef('__CastType110', () => dart.functionType(Zone, [Zone, ZoneDelegate, Zone, ZoneSpecification, core.Map]));
  const __CastType116 = dart.typedef('__CastType116', () => dart.functionType(dart.voidR, [Timer]));
  const __CastType118 = dart.typedef('__CastType118', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
