dart_library.library('dart/async', null, /* Imports */[
    ...
    class Stream extends core.Object {
      ...
      asyncExpand(convert) {
        ...
        let onListen = (function() {
          ...
          }, dart.dynamic, [T]), {onError: dart.as(dart.dload(eventSink, _addError), core.Function), onDone: dart.bind(controller, 'close')});
        }).bind(this);
        dart.fn(onListen, dart.void, []);
        if (dart.notNull(this.isBroadcast)) {
          controller = StreamController.broadcast({onListen: onListen, onCancel: dart.fn(() => {
  ...
  let _BroadcastStreamController$ = dart.generic(function(T) {
    class _BroadcastStreamController extends core.Object {
      ...
      [_recordCancel](sub) {
        ...
        if (dart.notNull(core.identical(dart.dload(subscription, _next), subscription)))
          return null;
        dart.assert(!dart.notNull(core.identical(dart.dload(subscription, _next), subscription)));
        if (dart.notNull(dart.as(dart.dload(subscription, _isFiring), core.bool))) {
          dart.dsend(subscription, _setRemoveAfterFiring);
        } else {
          dart.assert(!dart.notNull(core.identical(dart.dload(subscription, _next), subscription)));
  ...
  class _AsyncRun extends core.Object {
    static _scheduleImmediate(callback) {
      _AsyncRun.scheduleImmediateClosure(callback);
    }
  ...
  function _cancelAndError(subscription, future, error, stackTrace) {
    ...
    if (dart.is(cancelFuture, Future)) {
      dart.dsend(cancelFuture, 'whenComplete', dart.fn(() => future[_completeError](error, stackTrace), dart.void, []));
    } else {
  ...
  function _cancelAndValue(subscription, future, value) {
    let cancelFuture = subscription.cancel();
    if (dart.is(cancelFuture, Future)) {
      dart.dsend(cancelFuture, 'whenComplete', dart.fn(() => future[_complete](value), dart.void, []));
    } else {
