dart_library.library('dart/math', null, /* Imports */[
  ...
  let Point$ = dart.generic(function(T) {
    class Point extends core.Object {
      ...
      distanceTo(other) {
        ...
        return sqrt(dart.as(dart.dsend(dart.dsend(dx, '*', dx), '+', dart.dsend(dy, '*', dy)), core.num));
      }
  ...
  function atan2(a, b) {
    return dart.as(Math.atan2(_js_helper.checkNum(a), _js_helper.checkNum(b)), core.double);
  }
  ...
  function sin(x) {
    return dart.as(Math.sin(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(sin, core.double, [core.num]);
  function cos(x) {
    return dart.as(Math.cos(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(cos, core.double, [core.num]);
  function tan(x) {
    return dart.as(Math.tan(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(tan, core.double, [core.num]);
  function acos(x) {
    return dart.as(Math.acos(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(acos, core.double, [core.num]);
  function asin(x) {
    return dart.as(Math.asin(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(asin, core.double, [core.num]);
  function atan(x) {
    return dart.as(Math.atan(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(atan, core.double, [core.num]);
  function sqrt(x) {
    return dart.as(Math.sqrt(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(sqrt, core.double, [core.num]);
  function exp(x) {
    return dart.as(Math.exp(_js_helper.checkNum(x)), core.double);
  }
  dart.fn(exp, core.double, [core.num]);
  function log(x) {
    return dart.as(Math.log(_js_helper.checkNum(x)), core.double);
  }
