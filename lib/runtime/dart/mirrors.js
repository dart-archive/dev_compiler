dart_library.library('dart/mirrors', null, /* Imports */[
  ...
  function reflectClass(key) {
    if (!dart.is(key, core.Type) || dart.equals(key, dart.dynamicR)) {
      dart.throw_(new core.ArgumentError(`${key} does not denote a class`));
    }
  ...
  function reflectType(key) {
    if (dart.equals(key, dart.dynamicR)) {
  ...
  IsolateMirror[dart.implements_] = () => [Mirror];
  class DeclarationMirror extends core.Object {}
  DeclarationMirror[dart.implements_] = () => [Mirror];
  class ObjectMirror extends core.Object {}
  ObjectMirror[dart.implements_] = () => [Mirror];
  class InstanceMirror extends core.Object {}
  InstanceMirror[dart.implements_] = () => [ObjectMirror];
  class ClosureMirror extends core.Object {}
  ClosureMirror[dart.implements_] = () => [InstanceMirror];
  class LibraryMirror extends core.Object {}
  LibraryMirror[dart.implements_] = () => [DeclarationMirror, ObjectMirror];
  class LibraryDependencyMirror extends core.Object {}
  LibraryDependencyMirror[dart.implements_] = () => [Mirror];
  class CombinatorMirror extends core.Object {}
  CombinatorMirror[dart.implements_] = () => [Mirror];
  class TypeMirror extends core.Object {}
  TypeMirror[dart.implements_] = () => [DeclarationMirror];
  class ClassMirror extends core.Object {}
  ClassMirror[dart.implements_] = () => [TypeMirror, ObjectMirror];
  class FunctionTypeMirror extends core.Object {}
  FunctionTypeMirror[dart.implements_] = () => [ClassMirror];
  class TypeVariableMirror extends TypeMirror {}
  class TypedefMirror extends core.Object {}
  TypedefMirror[dart.implements_] = () => [TypeMirror];
  class MethodMirror extends core.Object {}
  MethodMirror[dart.implements_] = () => [DeclarationMirror];
  class VariableMirror extends core.Object {}
  VariableMirror[dart.implements_] = () => [DeclarationMirror];
  class ParameterMirror extends core.Object {}
  ParameterMirror[dart.implements_] = () => [VariableMirror];
  ...
  dart.setSignature(MirrorsUsed, {
    constructors: () => ({MirrorsUsed: [MirrorsUsed, [], {symbols: dart.dynamicR, targets: dart.dynamicR, metaTargets: dart.dynamicR, override: dart.dynamicR}]})
  });
  // Exports:
