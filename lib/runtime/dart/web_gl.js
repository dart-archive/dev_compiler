dart_library.library('dart/web_gl', null, /* Imports */[
  ...
  RenderingContext[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('WebGLRenderingContext')), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX)), dart.const(new _metadata.Experimental()), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLRenderingContext"))], 'fields', dart.map(['canvas', [dart.const(new _metadata.DomName('WebGLRenderingContext.canvas')), dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.Experimental())], 'drawingBufferHeight', [dart.const(new _metadata.DomName('WebGLRenderingContext.drawingBufferHeight')), dart.const(new _metadata.DocsEditable())], 'drawingBufferWidth', [dart.const(new _metadata.DomName('WebGLRenderingContext.drawingBufferWidth')), dart.const(new _metadata.DocsEditable())]])]);
  ...
  OesTextureHalfFloat[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESTextureHalfFloat')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESTextureHalfFloat"))]]);
  OesTextureHalfFloat[dart.owner] = exports;
  ...
  ActiveInfo[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLActiveInfo')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLActiveInfo"))], 'fields', dart.map(['name', [dart.const(new _metadata.DomName('WebGLActiveInfo.name')), dart.const(new _metadata.DocsEditable())], 'size', [dart.const(new _metadata.DomName('WebGLActiveInfo.size')), dart.const(new _metadata.DocsEditable())], 'type', [dart.const(new _metadata.DomName('WebGLActiveInfo.type')), dart.const(new _metadata.DocsEditable())]])]);
  ActiveInfo[dart.owner] = exports;
  ...
  AngleInstancedArrays[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('ANGLEInstancedArrays')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("ANGLEInstancedArrays"))]]);
  AngleInstancedArrays[dart.owner] = exports;
  ...
  Buffer[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLBuffer')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLBuffer"))]]);
  Buffer[dart.owner] = exports;
  ...
  CompressedTextureAtc[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLCompressedTextureATC')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLCompressedTextureATC"))]]);
  CompressedTextureAtc[dart.owner] = exports;
  ...
  CompressedTextureETC1[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLCompressedTextureETC1')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLCompressedTextureETC1"))]]);
  CompressedTextureETC1[dart.owner] = exports;
  ...
  CompressedTexturePvrtc[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLCompressedTexturePVRTC')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLCompressedTexturePVRTC"))]]);
  CompressedTexturePvrtc[dart.owner] = exports;
  ...
  CompressedTextureS3TC[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLCompressedTextureS3TC')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLCompressedTextureS3TC"))]]);
  CompressedTextureS3TC[dart.owner] = exports;
  ...
  ContextAttributes[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLContextAttributes')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLContextAttributes"))], 'fields', dart.map(['alpha', [dart.const(new _metadata.DomName('WebGLContextAttributes.alpha')), dart.const(new _metadata.DocsEditable())], 'antialias', [dart.const(new _metadata.DomName('WebGLContextAttributes.antialias')), dart.const(new _metadata.DocsEditable())], 'depth', [dart.const(new _metadata.DomName('WebGLContextAttributes.depth')), dart.const(new _metadata.DocsEditable())], 'failIfMajorPerformanceCaveat', [dart.const(new _metadata.DomName('WebGLContextAttributes.failIfMajorPerformanceCaveat')), dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.Experimental())], 'premultipliedAlpha', [dart.const(new _metadata.DomName('WebGLContextAttributes.premultipliedAlpha')), dart.const(new _metadata.DocsEditable())], 'preserveDrawingBuffer', [dart.const(new _metadata.DomName('WebGLContextAttributes.preserveDrawingBuffer')), dart.const(new _metadata.DocsEditable())], 'stencil', [dart.const(new _metadata.DomName('WebGLContextAttributes.stencil')), dart.const(new _metadata.DocsEditable())]])]);
  ContextAttributes[dart.owner] = exports;
  ...
  ContextEvent[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLContextEvent')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLContextEvent"))], 'fields', dart.map(['statusMessage', [dart.const(new _metadata.DomName('WebGLContextEvent.statusMessage')), dart.const(new _metadata.DocsEditable())]])]);
  ContextEvent[dart.owner] = exports;
  ...
  DebugRendererInfo[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLDebugRendererInfo')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLDebugRendererInfo"))]]);
  DebugRendererInfo[dart.owner] = exports;
  ...
  DebugShaders[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLDebugShaders')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLDebugShaders"))]]);
  DebugShaders[dart.owner] = exports;
  ...
  DepthTexture[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLDepthTexture')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLDepthTexture"))]]);
  DepthTexture[dart.owner] = exports;
  ...
  DrawBuffers[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLDrawBuffers')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLDrawBuffers"))]]);
  DrawBuffers[dart.owner] = exports;
  ...
  ExtBlendMinMax[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('EXTBlendMinMax')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("EXTBlendMinMax"))]]);
  ExtBlendMinMax[dart.owner] = exports;
  ...
  ExtFragDepth[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('EXTFragDepth')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("EXTFragDepth"))]]);
  ExtFragDepth[dart.owner] = exports;
  ...
  ExtShaderTextureLod[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('EXTShaderTextureLOD')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("EXTShaderTextureLOD"))]]);
  ExtShaderTextureLod[dart.owner] = exports;
  ...
  ExtTextureFilterAnisotropic[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('EXTTextureFilterAnisotropic')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("EXTTextureFilterAnisotropic"))]]);
  ExtTextureFilterAnisotropic[dart.owner] = exports;
  ...
  Framebuffer[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLFramebuffer')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLFramebuffer"))]]);
  Framebuffer[dart.owner] = exports;
  ...
  LoseContext[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLLoseContext')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLLoseContext,WebGLExtensionLoseContext"))]]);
  LoseContext[dart.owner] = exports;
  ...
  OesElementIndexUint[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESElementIndexUint')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESElementIndexUint"))]]);
  OesElementIndexUint[dart.owner] = exports;
  ...
  OesStandardDerivatives[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESStandardDerivatives')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESStandardDerivatives"))]]);
  OesStandardDerivatives[dart.owner] = exports;
  ...
  OesTextureFloat[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESTextureFloat')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESTextureFloat"))]]);
  OesTextureFloat[dart.owner] = exports;
  ...
  OesTextureFloatLinear[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESTextureFloatLinear')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESTextureFloatLinear"))]]);
  OesTextureFloatLinear[dart.owner] = exports;
  ...
  OesTextureHalfFloatLinear[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESTextureHalfFloatLinear')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESTextureHalfFloatLinear"))]]);
  OesTextureHalfFloatLinear[dart.owner] = exports;
  ...
  OesVertexArrayObject[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('OESVertexArrayObject')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("OESVertexArrayObject"))]]);
  OesVertexArrayObject[dart.owner] = exports;
  ...
  Program[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLProgram')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLProgram"))]]);
  Program[dart.owner] = exports;
  ...
  Renderbuffer[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLRenderbuffer')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("WebGLRenderbuffer"))]]);
  Renderbuffer[dart.owner] = exports;
  ...
  Shader[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLShader')), dart.const(new _js_helper.Native("WebGLShader"))]]);
  Shader[dart.owner] = exports;
  ...
  ShaderPrecisionFormat[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLShaderPrecisionFormat')), dart.const(new _js_helper.Native("WebGLShaderPrecisionFormat"))], 'fields', dart.map(['precision', [dart.const(new _metadata.DomName('WebGLShaderPrecisionFormat.precision')), dart.const(new _metadata.DocsEditable())], 'rangeMax', [dart.const(new _metadata.DomName('WebGLShaderPrecisionFormat.rangeMax')), dart.const(new _metadata.DocsEditable())], 'rangeMin', [dart.const(new _metadata.DomName('WebGLShaderPrecisionFormat.rangeMin')), dart.const(new _metadata.DocsEditable())]])]);
  ShaderPrecisionFormat[dart.owner] = exports;
  ...
  Texture[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLTexture')), dart.const(new _js_helper.Native("WebGLTexture"))]]);
  Texture[dart.owner] = exports;
  ...
  UniformLocation[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLUniformLocation')), dart.const(new _js_helper.Native("WebGLUniformLocation"))]]);
  UniformLocation[dart.owner] = exports;
  ...
  VertexArrayObject[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLVertexArrayObjectOES')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("WebGLVertexArrayObjectOES"))]]);
  VertexArrayObject[dart.owner] = exports;
  ...
  _WebGLRenderingContextBase[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('WebGLRenderingContextBase')), dart.const(new _metadata.Experimental())]]);
  _WebGLRenderingContextBase[dart.owner] = exports;
  // Exports:
