dart_library.library('dart/_internal', null, /* Imports */[
  ...
  const ListIterable$ = dart.generic(function(E) {
    class ListIterable extends collection.IterableBase$(E) {
      ...
      get first() {
        if (this.length == 0) dart.throw_(IterableElementError.noElement());
      ...
      get single() {
        if (this.length == 0) dart.throw_(IterableElementError.noElement());
        if (dart.notNull(this.length) > 1) dart.throw_(IterableElementError.tooMany());
        return this.elementAt(0);
      }
      contains(element) {
        let length = this.length;
      ...
      firstWhere(test, opts) {
        ...
        dart.throw_(IterableElementError.noElement());
      }
      lastWhere(test, opts) {
        dart.as(test, dart.functionType(core.bool, [E]));
        let orElse = opts && 'orElse' in opts ? opts.orElse : null;
        ...
        for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
          ...
          if (dart.notNull(test(element))) {
            if (dart.notNull(matchFound)) {
              dart.throw_(IterableElementError.tooMany());
            }
            matchFound = true;
            match = element;
          }
      ...
      map(f) {
        ...
        return new (MappedListIterable$(E, dart.dynamicR))(this, f);
      }
      reduce(combine) {
        dart.as(combine, dart.functionType(E, [dart.dynamicR, E]));
        let length = this.length;
        if (length == 0) dart.throw_(IterableElementError.noElement());
    ...
    ListIterable[dart.implements_] = () => [EfficientLength];
    dart.setSignature(ListIterable, {
      ...
      methods: () => ({
        ...
        reduce: [E, [dart.functionType(E, [dart.dynamicR, E])]],
    ...
    class SubListIterable extends ListIterable$(E) {
      SubListIterable(iterable, start, endOrLength) {
        ...
        if (this[_endOrLength] != null) {
          ...
          if (dart.notNull(this[_start]) > dart.notNull(this[_endOrLength])) {
            dart.throw_(new core.RangeError.range(this[_start], 0, this[_endOrLength], "start"));
          }
        }
      }
      get [_endIndex]() {
      ...
      elementAt(index) {
        ...
        if (dart.notNull(index) < 0 || dart.notNull(realIndex) >= dart.notNull(this[_endIndex])) {
          dart.throw_(core.RangeError.index(index, this, "index"));
        }
      ...
      toList(opts) {
        ...
        for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
          ...
          if (dart.notNull(this[_iterable][dartx.length]) < dart.notNull(end)) dart.throw_(new core.ConcurrentModificationError(this));
        }
  ...
  const ListIterator$ = dart.generic(function(E) {
    class ListIterator extends core.Object {
      ...
      moveNext() {
        ...
        if (this[_length] != length) {
          dart.throw_(new core.ConcurrentModificationError(this[_iterable]));
        }
    ...
    ListIterator[dart.implements_] = () => [core.Iterator$(E)];
  ...
  const EfficientLengthMappedIterable$ = dart.generic(function(S, T) {
    ...
    EfficientLengthMappedIterable[dart.implements_] = () => [EfficientLength];
  ...
  const MappedListIterable$ = dart.generic(function(S, T) {
    ...
    MappedListIterable[dart.implements_] = () => [EfficientLength];
  ...
  const ExpandIterator$ = dart.generic(function(S, T) {
    class ExpandIterator extends core.Object {
      ExpandIterator(iterator, f) {
        this[_iterator] = iterator;
        this[_f] = f;
        this[_currentExpansion] = dart.const_(new (EmptyIterator$(T))());
        this[_current] = null;
      }
      [_nextExpansion]() {}
      get current() {
    ...
    ExpandIterator[dart.implements_] = () => [core.Iterator$(T)];
    ...
    class TakeIterable extends collection.IterableBase$(E) {
      static new(iterable, takeCount) {
        if (!(typeof takeCount == 'number') || dart.notNull(takeCount) < 0) {
          dart.throw_(new core.ArgumentError(takeCount));
        }
        if (dart.is(iterable, EfficientLength)) {
  ...
  const EfficientLengthTakeIterable$ = dart.generic(function(E) {
    ...
    EfficientLengthTakeIterable[dart.implements_] = () => [EfficientLength];
    ...
    class SkipIterable extends collection.IterableBase$(E) {
      ...
      _(iterable, skipCount) {
        ...
        if (!(typeof this[_skipCount] == 'number')) {
          dart.throw_(new core.ArgumentError.value(this[_skipCount], "count is not an integer"));
        }
  ...
  const EfficientLengthSkipIterable$ = dart.generic(function(E) {
    ...
    EfficientLengthSkipIterable[dart.implements_] = () => [EfficientLength];
  ...
  const EmptyIterable$ = dart.generic(function(E) {
    class EmptyIterable extends collection.IterableBase$(E) {
      ...
      get iterator() {
        return dart.const_(new (EmptyIterator$(E))());
      }
      forEach(action) {
        dart.as(action, dart.functionType(dart.voidR, [E]));
      }
      ...
      elementAt(index) {
        dart.throw_(new core.RangeError.range(index, 0, 0, "index"));
      }
      contains(element) {
        return false;
      }
      ...
      map(f) {
        dart.as(f, dart.functionType(dart.dynamicR, [E]));
        return dart.const_(new (EmptyIterable$())());
      }
      reduce(combine) {
    ...
    EmptyIterable[dart.implements_] = () => [EfficientLength];
  ...
  const EmptyIterator$ = dart.generic(function(E) {
    ...
    EmptyIterator[dart.implements_] = () => [core.Iterator$(E)];
  ...
  const BidirectionalIterator$ = dart.generic(function(T) {
    ...
    BidirectionalIterator[dart.implements_] = () => [core.Iterator$(T)];
  ...
  const IterableMixinWorkaround$ = dart.generic(function(T) {
    class IterableMixinWorkaround extends core.Object {
      ...
      static forEach(iterable, f) {
        dart.as(f, dart.functionType(dart.voidR, [dart.dynamicR]));
        for (let e of iterable) {
          f(e);
        }
      }
      static any(iterable, f) {
        dart.as(f, dart.functionType(core.bool, [dart.dynamicR]));
        for (let e of iterable) {
      ...
      static reduce(iterable, combine) {
        dart.as(combine, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]));
        let iterator = iterable[dartx.iterator];
        if (!dart.notNull(iterator.moveNext())) dart.throw_(IterableElementError.noElement());
      ...
      static removeWhereList(list, test) {
        ...
        let retained = dart.list([], dart.dynamicR);
        ...
        for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
          ...
          if (length != list[dartx.length]) {
            dart.throw_(new core.ConcurrentModificationError(list));
          }
        }
      ...
      static single(iterable) {
        let it = iterable[dartx.iterator];
        if (!dart.notNull(it.moveNext())) dart.throw_(IterableElementError.noElement());
        let result = it.current;
        if (dart.notNull(it.moveNext())) dart.throw_(IterableElementError.tooMany());
        return result;
      }
      static firstWhere(iterable, test, orElse) {
        dart.as(test, dart.functionType(core.bool, [dart.dynamicR]));
        dart.as(orElse, dart.functionType(dart.dynamicR, []));
        for (let element of iterable) {
          if (dart.notNull(test(element))) return element;
        }
        if (orElse != null) return orElse();
      ...
      static elementAt(iterable, index) {
        ...
        dart.throw_(core.RangeError.index(index, iterable, "index", null, elementIndex));
      }
      ...
      static expand(iterable, f) {
        dart.as(f, dart.functionType(core.Iterable, [dart.dynamicR]));
      ...
      static sortList(list, compare) {
        dart.as(compare, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR]));
      ...
      static setRangeList(list, start, end, from, skipCount) {
        ...
        let length = dart.notNull(end) - dart.notNull(start);
        if (length == 0) return;
        if (dart.notNull(skipCount) < 0) dart.throw_(new core.ArgumentError(skipCount));
        let otherList = null;
        let otherStart = null;
        ...
        if (dart.notNull(otherStart) + dart.notNull(length) > dart.notNull(otherList[dartx.length])) {
          dart.throw_(IterableElementError.tooFew());
        }
    ...
    dart.setSignature(IterableMixinWorkaround, {
      methods: () => ({
        ...
        takeWhile: [core.Iterable$(T), [core.Iterable, dart.functionType(core.bool, [dart.dynamicR])]],
        skipList: [core.Iterable$(T), [core.List, core.int]],
        skipWhile: [core.Iterable$(T), [core.Iterable, dart.functionType(core.bool, [dart.dynamicR])]],
      ...
      statics: () => ({
        contains: [core.bool, [core.Iterable, dart.dynamicR]],
        forEach: [dart.voidR, [core.Iterable, dart.functionType(dart.voidR, [dart.dynamicR])]],
        any: [core.bool, [core.Iterable, dart.functionType(core.bool, [dart.dynamicR])]],
        every: [core.bool, [core.Iterable, dart.functionType(core.bool, [dart.dynamicR])]],
        reduce: [dart.dynamicR, [core.Iterable, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]],
        fold: [dart.dynamicR, [core.Iterable, dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]],
        removeWhereList: [dart.voidR, [core.List, dart.functionType(core.bool, [dart.dynamicR])]],
        isEmpty: [core.bool, [core.Iterable]],
        first: [dart.dynamicR, [core.Iterable]],
        last: [dart.dynamicR, [core.Iterable]],
        single: [dart.dynamicR, [core.Iterable]],
        firstWhere: [dart.dynamicR, [core.Iterable, dart.functionType(core.bool, [dart.dynamicR]), dart.functionType(dart.dynamicR, [])]],
        lastWhere: [dart.dynamicR, [core.Iterable, dart.functionType(core.bool, [dart.dynamicR]), dart.functionType(dart.dynamicR, [])]],
        lastWhereList: [dart.dynamicR, [core.List, dart.functionType(core.bool, [dart.dynamicR]), dart.functionType(dart.dynamicR, [])]],
        singleWhere: [dart.dynamicR, [core.Iterable, dart.functionType(core.bool, [dart.dynamicR])]],
        elementAt: [dart.dynamicR, [core.Iterable, core.int]],
        join: [core.String, [core.Iterable], [core.String]],
        joinList: [core.String, [core.List], [core.String]],
        map: [core.Iterable, [core.Iterable, dart.functionType(dart.dynamicR, [dart.dynamicR])]],
        mapList: [core.Iterable, [core.List, dart.functionType(dart.dynamicR, [dart.dynamicR])]],
        expand: [core.Iterable, [core.Iterable, dart.functionType(core.Iterable, [dart.dynamicR])]],
        sortList: [dart.voidR, [core.List, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR])]],
        shuffleList: [dart.voidR, [core.List, math.Random]],
        indexOfList: [core.int, [core.List, dart.dynamicR, core.int]],
        lastIndexOfList: [core.int, [core.List, dart.dynamicR, core.int]],
        _rangeCheck: [dart.voidR, [core.List, core.int, core.int]],
        setRangeList: [dart.voidR, [core.List, core.int, core.int, core.Iterable, core.int]],
        replaceRangeList: [dart.voidR, [core.List, core.int, core.int, core.Iterable]],
        fillRangeList: [dart.voidR, [core.List, core.int, core.int, dart.dynamicR]],
        insertAllList: [dart.voidR, [core.List, core.int, core.Iterable]],
        setAllList: [dart.voidR, [core.List, core.int, core.Iterable]],
  ...
  const FixedLengthListMixin$ = dart.generic(function(E) {
    class FixedLengthListMixin extends core.Object {
      ...
      add(value) {
        dart.as(value, E);
        dart.throw_(new core.UnsupportedError("Cannot add to a fixed-length list"));
      }
      insert(index, value) {
        dart.as(value, E);
        dart.throw_(new core.UnsupportedError("Cannot add to a fixed-length list"));
      ...
      remove(element) {
        dart.throw_(new core.UnsupportedError("Cannot remove from a fixed-length list"));
      }
      removeWhere(test) {
        dart.as(test, dart.functionType(core.bool, [E]));
        dart.throw_(new core.UnsupportedError("Cannot remove from a fixed-length list"));
      ...
      clear() {
        dart.throw_(new core.UnsupportedError("Cannot clear a fixed-length list"));
      }
      removeAt(index) {
        dart.throw_(new core.UnsupportedError("Cannot remove from a fixed-length list"));
      }
  ...
  const UnmodifiableListMixin$ = dart.generic(function(E) {
    class UnmodifiableListMixin extends core.Object {
      set(index, value) {
        dart.as(value, E);
        dart.throw_(new core.UnsupportedError("Cannot modify an unmodifiable list"));
        return value;
      }
      set length(newLength) {
        dart.throw_(new core.UnsupportedError("Cannot change the length of an unmodifiable list"));
      }
      setAll(at, iterable) {
        dart.as(iterable, core.Iterable$(E));
        dart.throw_(new core.UnsupportedError("Cannot modify an unmodifiable list"));
      ...
      add(value) {
        dart.as(value, E);
        dart.throw_(new core.UnsupportedError("Cannot add to an unmodifiable list"));
      }
      insert(index, value) {
        dart.as(value, E);
        dart.throw_(new core.UnsupportedError("Cannot add to an unmodifiable list"));
      ...
      remove(element) {
        dart.throw_(new core.UnsupportedError("Cannot remove from an unmodifiable list"));
      }
      removeWhere(test) {
        dart.as(test, dart.functionType(core.bool, [E]));
        dart.throw_(new core.UnsupportedError("Cannot remove from an unmodifiable list"));
      ...
      clear() {
        dart.throw_(new core.UnsupportedError("Cannot clear an unmodifiable list"));
      }
      removeAt(index) {
        dart.throw_(new core.UnsupportedError("Cannot remove from an unmodifiable list"));
      }
    ...
    UnmodifiableListMixin[dart.implements_] = () => [core.List$(E)];
    dart.setSignature(UnmodifiableListMixin, {
      methods: () => ({
        ...
        removeWhere: [dart.voidR, [dart.functionType(core.bool, [E])]],
        retainWhere: [dart.voidR, [dart.functionType(core.bool, [E])]],
        sort: [dart.voidR, [], [core.Comparator$(E)]],
  ...
  const ListMapView$ = dart.generic(function(E) {
    class ListMapView extends core.Object {
      ...
      forEach(f) {
        dart.as(f, dart.functionType(dart.voidR, [core.int, E]));
        let length = this[_values][dartx.length];
        for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
          f(i, this[_values][dartx.get](i));
          if (length != this[_values][dartx.length]) {
            dart.throw_(new core.ConcurrentModificationError(this[_values]));
          }
        }
      }
      set(key, value) {
    ...
    ListMapView[dart.implements_] = () => [core.Map$(core.int, E)];
    dart.setSignature(ListMapView, {
      ...
      methods: () => ({
        ...
        forEach: [dart.voidR, [dart.functionType(dart.voidR, [core.int, E])]],
        set: [dart.voidR, [core.int, E]],
        putIfAbsent: [E, [core.int, dart.functionType(E, [])]],
        remove: [E, [core.Object]],
        clear: [dart.voidR, []],
        addAll: [dart.voidR, [core.Map$(core.int, E)]]
      })
    });
    return ListMapView;
  });
  ...
  class Lists extends core.Object {
    ...
    static rangeCheck(a, start, length) {
      ...
      if (dart.notNull(start) + dart.notNull(length) > dart.notNull(a[dartx.length])) {
        ...
        dart.throw_(new core.RangeError.range(length, 0, dart.notNull(a[dartx.length]) - dart.notNull(start), "length", message));
      }
    }
  }
  dart.setSignature(Lists, {
    statics: () => ({
      copy: [dart.voidR, [core.List, core.int, core.List, core.int, core.int]],
      areEqual: [core.bool, [core.List, dart.dynamicR]],
      indexOf: [core.int, [core.List, core.Object, core.int, core.int]],
      lastIndexOf: [core.int, [core.List, core.Object, core.int]],
      indicesCheck: [dart.voidR, [core.List, core.int, core.int]],
      rangeCheck: [dart.voidR, [core.List, core.int, core.int]]
    }),
  ...
  dart.fn(printToConsole, dart.voidR, [core.String]);
  ...
  dart.setSignature(Sort, {
    statics: () => ({
      sort: [dart.voidR, [core.List, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR])]],
      sortRange: [dart.voidR, [core.List, core.int, core.int, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR])]],
      _doSort: [dart.voidR, [core.List, core.int, core.int, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR])]],
      _insertionSort: [dart.voidR, [core.List, core.int, core.int, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR])]],
      _dualPivotQuicksort: [dart.voidR, [core.List, core.int, core.int, dart.functionType(core.int, [dart.dynamicR, dart.dynamicR])]]
    }),
  ...
  class Symbol extends core.Object {
    ...
    static validatePublicSymbol(name) {
      ...
      if (dart.notNull(name[dartx.startsWith]('_'))) {
        dart.throw_(new core.ArgumentError(`"${name}" is a private identifier`));
      }
      dart.throw_(new core.ArgumentError(`"${name}" is not a valid (qualified) symbol name`));
    }
    static isValidSymbol(name) {
      return dart.notNull(name[dartx.isEmpty]) || dart.notNull(Symbol.symbolPattern.hasMatch(name));
    }
  }
  Symbol[dart.implements_] = () => [core.Symbol];
  ...
  const POWERS_OF_TEN = dart.const_([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 10000000.0, 100000000.0, 1000000000.0, 10000000000.0, 100000000000.0, 1000000000000.0, 10000000000000.0, 100000000000000.0, 1000000000000000.0, 10000000000000000.0, 100000000000000000.0, 1000000000000000000.0, 10000000000000000000.0, 100000000000000000000.0, 1e+21, 1e+22]);
