dart_library.library('dart/web_sql', null, /* Imports */[
  ...
  SqlDatabase[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('Database')), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.SAFARI)), dart.const(new _metadata.Experimental()), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("Database"))], 'fields', dart.map(['version', [dart.const(new _metadata.DomName('Database.version')), dart.const(new _metadata.DocsEditable())]])]);
  SqlDatabase[dart.owner] = exports;
  ...
  SqlError[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('SQLError')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("SQLError"))], 'fields', dart.map(['code', [dart.const(new _metadata.DomName('SQLError.code')), dart.const(new _metadata.DocsEditable())], 'message', [dart.const(new _metadata.DomName('SQLError.message')), dart.const(new _metadata.DocsEditable())]])]);
  SqlError[dart.owner] = exports;
  ...
  SqlResultSet[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('SQLResultSet')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("SQLResultSet"))], 'fields', dart.map(['insertId', [dart.const(new _metadata.DomName('SQLResultSet.insertId')), dart.const(new _metadata.DocsEditable())], 'rows', [dart.const(new _metadata.DomName('SQLResultSet.rows')), dart.const(new _metadata.DocsEditable())], 'rowsAffected', [dart.const(new _metadata.DomName('SQLResultSet.rowsAffected')), dart.const(new _metadata.DocsEditable())]])]);
  SqlResultSet[dart.owner] = exports;
  ...
  SqlResultSetRowList[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('SQLResultSetRowList')), dart.const(new _metadata.Experimental()), dart.const(new _js_helper.Native("SQLResultSetRowList"))], 'properties', dart.map(['length', [dart.const(new _metadata.DomName('SQLResultSetRowList.length')), dart.const(new _metadata.DocsEditable())]])]);
  SqlResultSetRowList[dart.owner] = exports;
