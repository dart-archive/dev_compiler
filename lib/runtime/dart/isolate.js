dart_library.library('dart/isolate', null, /* Imports */[
  ...
  IsolateSpawnException[dart.implements_] = () => [core.Exception];
  ...
  class Isolate extends core.Object {
    ...
    static spawnUri(uri, args, message, opts) {
      ...
      if (packageRoot != null) dart.throw_(new core.UnimplementedError("packageRoot"));
      try {
        if (dart.is(args, core.List)) {
          for (let i = 0; dart.notNull(i) < dart.notNull(args[dartx.length]); i = dart.notNull(i) + 1) {
            if (!(typeof args[dartx.get](i) == 'string')) {
              dart.throw_(new core.ArgumentError(`Args must be a list of Strings ${args}`));
            }
          }
        } else if (args != null) {
          dart.throw_(new core.ArgumentError(`Args must be a list of Strings ${args}`));
  ...
  dart.setSignature(Isolate, {
    ...
    methods: () => ({
      ...
      [_pause]: [dart.voidR, [Capability]],
      resume: [dart.voidR, [Capability]],
      addOnExitListener: [dart.voidR, [SendPort]],
      removeOnExitListener: [dart.voidR, [SendPort]],
      setErrorsFatal: [dart.voidR, [core.bool]],
      kill: [dart.voidR, [], [core.int]],
      ping: [dart.voidR, [SendPort], [core.int]],
      addErrorListener: [dart.voidR, [SendPort]],
      removeErrorListener: [dart.voidR, [SendPort]]
    }),
    statics: () => ({
      spawn: [async.Future$(Isolate), [dart.functionType(dart.voidR, [dart.dynamicR]), dart.dynamicR], {paused: core.bool}],
      spawnUri: [async.Future$(Isolate), [core.Uri, core.List$(core.String), dart.dynamicR], {paused: core.bool, packageRoot: core.Uri}]
    }),
  ...
  SendPort[dart.implements_] = () => [Capability];
  ...
  ReceivePort[dart.implements_] = () => [async.Stream];
  ...
  dart.setSignature(RawReceivePort, {
    constructors: () => ({new: [RawReceivePort, [], [dart.functionType(dart.voidR, [dart.dynamicR])]]})
  });
  ...
  _IsolateUnhandledException[dart.implements_] = () => [core.Exception];
  dart.setSignature(_IsolateUnhandledException, {
    constructors: () => ({_IsolateUnhandledException: [_IsolateUnhandledException, [dart.dynamicR, dart.dynamicR, core.StackTrace]]})
  });
  ...
  RemoteError[dart.implements_] = () => [core.Error];
  ...
  _RemoteStackTrace[dart.implements_] = () => [core.StackTrace];
