dart_library.library('dart/html_common', null, /* Imports */[
  ...
  class CssClassSetImpl extends core.Object {
    [_validateToken](value) {
      ...
      dart.throw_(new core.ArgumentError.value(value, 'value', 'Not a valid class token'));
    }
    toString() {
    ...
    addAll(iterable) {
      this.modify(dart.fn((s => s.addAll(iterable[dartx.map](dart.bind(this, _validateToken)))).bind(this), dart.voidR, [core.Set$(core.String)]));
    }
    removeAll(iterable) {
      this.modify(dart.fn((s => s.removeAll(iterable[dartx.map](dart.as(dart.bind(this, _validateToken), __CastType0)))).bind(this), dart.voidR, [core.Set$(core.String)]));
    }
    ...
    retainAll(iterable) {
      this.modify(dart.fn(s => s.retainAll(iterable), dart.voidR, [core.Set$(core.String)]));
    }
    removeWhere(test) {
      this.modify(dart.fn(s => s.removeWhere(test), dart.voidR, [core.Set$(core.String)]));
    }
    retainWhere(test) {
      this.modify(dart.fn(s => s.retainWhere(test), dart.voidR, [core.Set$(core.String)]));
    }
    ...
    clear() {
      this.modify(dart.fn(s => s.clear(), dart.voidR, [core.Set$(core.String)]));
    }
    modify(f) {
      let s = this.readClasses();
      let ret = f(s);
  ...
  CssClassSetImpl[dart.implements_] = () => [html.CssClassSet];
  dart.setSignature(CssClassSetImpl, {
    methods: () => ({
      [_validateToken]: [core.String, [core.String]],
      toggle: [core.bool, [core.String], [core.bool]],
      forEach: [dart.voidR, [dart.functionType(dart.voidR, [core.String])]],
      join: [core.String, [], [core.String]],
      map: [core.Iterable, [dart.functionType(dart.dynamicR, [core.String])]],
      ...
      fold: [dart.dynamicR, [dart.dynamicR, dart.functionType(dart.dynamicR, [dart.dynamicR, core.String])]],
      contains: [core.bool, [core.Object]],
      lookup: [core.String, [core.Object]],
      add: [core.bool, [core.String]],
      remove: [core.bool, [core.Object]],
      addAll: [dart.voidR, [core.Iterable$(core.String)]],
      removeAll: [dart.voidR, [core.Iterable$(core.Object)]],
      toggleAll: [dart.voidR, [core.Iterable$(core.String)], [core.bool]],
      retainAll: [dart.voidR, [core.Iterable$(core.Object)]],
      removeWhere: [dart.voidR, [dart.functionType(core.bool, [core.String])]],
      retainWhere: [dart.voidR, [dart.functionType(core.bool, [core.String])]],
      ...
      clear: [dart.voidR, []],
      modify: [dart.dynamicR, [dart.functionType(dart.dynamicR, [core.Set$(core.String)])]]
    })
  });
  ...
  class _StructuredClone extends core.Object {
    ...
    walk(e) {
      ...
      if (dart.is(e, core.RegExp)) {
        dart.throw_(new core.UnimplementedError('structured clone of RegExp'));
      }
      if (dart.is(e, dart.dynamicR)) return e;
      if (dart.is(e, dart.dynamicR)) return e;
      if (dart.is(e, dart.dynamicR)) return e;
      if (dart.is(e, dart.dynamicR)) return e;
      ...
      dart.throw_(new core.UnimplementedError('structured clone of other type'));
    }
    copyList(e, slot) {
      let i = 0;
  ...
  dart.setSignature(_StructuredClone, {
    methods: () => ({
      findSlot: [core.int, [dart.dynamicR]],
      readSlot: [dart.dynamicR, [core.int]],
      writeSlot: [dart.dynamicR, [core.int, dart.dynamicR]],
      cleanupSlots: [dart.dynamicR, []],
      walk: [dart.dynamicR, [dart.dynamicR]],
      copyList: [dart.dynamicR, [core.List, core.int]],
      convertDartToNative_PrepareForStructuredClone: [dart.dynamicR, [dart.dynamicR]]
    })
  });
  ...
  dart.setSignature(_AcceptStructuredClone, {
    methods: () => ({
      ...
      writeSlot: [dart.dynamicR, [core.int, dart.dynamicR]],
      walk: [dart.dynamicR, [dart.dynamicR]],
      convertNativeToDart_AcceptStructuredClone: [dart.dynamicR, [dart.dynamicR], {mustCopy: dart.dynamicR}]
    })
  });
  ...
  function convertNativeToDart_ContextAttributes(nativeContextAttributes) {
    if (dart.is(nativeContextAttributes, dart.dynamicR)) {
  ...
  function convertNativeToDart_ImageData(nativeImageData) {
    0;
    if (dart.is(nativeImageData, dart.dynamicR)) {
  ...
  const annotation_Creates_SerializedScriptValue = dart.const_(new _js_helper.Creates(_serializedScriptValue));
  const annotation_Returns_SerializedScriptValue = dart.const_(new _js_helper.Returns(_serializedScriptValue));
  ...
  dart.fn(convertNativeToDart_Dictionary, core.Map, [dart.dynamicR]);
  function convertDartToNative_Dictionary(dict, postCreate) {
    ...
    dict.forEach(dart.fn((key, value) => {
      object[key] = value;
    }, dart.voidR, [core.String, dart.dynamicR]));
    return object;
  }
  dart.fn(convertDartToNative_Dictionary, dart.dynamicR, [core.Map], [dart.functionType(dart.voidR, [dart.dynamicR])]);
  ...
  dart.fn(convertNativeToDart_DateTime, core.DateTime, [dart.dynamicR]);
  function convertDartToNative_DateTime(date) {
    return new Date(date.millisecondsSinceEpoch);
  }
  dart.fn(convertDartToNative_DateTime, dart.dynamicR, [core.DateTime]);
  ...
  dart.fn(convertNativeToDart_AcceptStructuredClone, dart.dynamicR, [dart.dynamicR], {mustCopy: dart.dynamicR});
  ...
  dart.setSignature(_StructuredCloneDart2Js, {
    methods: () => ({
      newJsMap: [dart.dynamicR, []],
      putIntoMap: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      newJsList: [dart.dynamicR, [dart.dynamicR]],
      cloneNotRequired: [core.bool, [dart.dynamicR]]
    })
  });
  ...
  dart.setSignature(_AcceptStructuredCloneDart2Js, {
    methods: () => ({
      newJsList: [dart.dynamicR, [dart.dynamicR]],
      newDartList: [dart.dynamicR, [dart.dynamicR]],
      identicalInJs: [core.bool, [dart.dynamicR, dart.dynamicR]],
      forEachJsField: [dart.voidR, [dart.dynamicR, dart.dynamicR]]
    })
  });
  function isJavaScriptDate(value) {
    return value instanceof Date;
  }
  dart.fn(isJavaScriptDate, core.bool, [dart.dynamicR]);
  function isJavaScriptRegExp(value) {
    return value instanceof RegExp;
  }
  dart.fn(isJavaScriptRegExp, core.bool, [dart.dynamicR]);
  function isJavaScriptArray(value) {
    return value instanceof Array;
  }
  dart.fn(isJavaScriptArray, core.bool, [dart.dynamicR]);
  function isJavaScriptSimpleObject(value) {
    let proto = Object.getPrototypeOf(value);
    return proto === Object.prototype || proto === null;
  }
  dart.fn(isJavaScriptSimpleObject, core.bool, [dart.dynamicR]);
  function isImmutableJavaScriptArray(value) {
    return !!value.immutable$list;
  }
  dart.fn(isImmutableJavaScriptArray, core.bool, [dart.dynamicR]);
  function isJavaScriptPromise(value) {
    return typeof Promise != "undefined" && value instanceof Promise;
  }
  dart.fn(isJavaScriptPromise, core.bool, [dart.dynamicR]);
  function convertNativePromiseToDartFuture(promise) {
    let completer = async.Completer.new();
    let then = dart.dcall(/* Unimplemented unknown name */convertDartClosureToJS, dart.fn(result => completer.complete(result), dart.voidR, [dart.dynamicR]), 1);
    let error = dart.dcall(/* Unimplemented unknown name */convertDartClosureToJS, dart.fn(result => completer.completeError(result), dart.voidR, [dart.dynamicR]), 1);
    let newPromise = promise.then(then).catch(error);
    return completer.future;
  }
  dart.fn(convertNativePromiseToDartFuture, async.Future, [dart.dynamicR]);
  ...
  dart.defineLazyClass(exports, {
    get FilteredElementList() {
      class FilteredElementList extends collection.ListBase$(html.Element) {
        ...
        set length(newLength) {
          ...
          if (dart.notNull(newLength) >= dart.notNull(len)) {
            ...
            dart.throw_(new core.ArgumentError("Invalid list length"));
          }
        ...
        sort(compare) {
          ...
          dart.throw_(new core.UnsupportedError('Cannot sort filtered list'));
        }
        setRange(start, end, iterable, skipCount) {
          if (skipCount === void 0) skipCount = 0;
          dart.throw_(new core.UnsupportedError('Cannot setRange on filtered list'));
        }
        fillRange(start, end, fillValue) {
          if (fillValue === void 0) fillValue = null;
          dart.throw_(new core.UnsupportedError('Cannot fillRange on filtered list'));
        }
        replaceRange(start, end, iterable) {
          dart.throw_(new core.UnsupportedError('Cannot replaceRange on filtered list'));
        }
        removeRange(start, end) {
          core.List.from(this[_iterable][dartx.skip](start)[dartx.take](dart.notNull(end) - dart.notNull(start)))[dartx.forEach](dart.fn(el => dart.dsend(el, 'remove'), dart.voidR, [dart.dynamicR]));
        }
        clear() {
      ...
      FilteredElementList[dart.implements_] = () => [NodeListWrapper];
      dart.setSignature(FilteredElementList, {
        constructors: () => ({FilteredElementList: [exports.FilteredElementList, [html.Node]]}),
        methods: () => ({
          forEach: [dart.voidR, [dart.functionType(dart.voidR, [html.Element])]],
          set: [dart.voidR, [core.int, html.Element]],
          add: [dart.voidR, [html.Element]],
          addAll: [dart.voidR, [core.Iterable$(html.Element)]],
          sort: [dart.voidR, [], [dart.functionType(core.int, [html.Element, html.Element])]],
          setRange: [dart.voidR, [core.int, core.int, core.Iterable$(html.Element)], [core.int]],
          fillRange: [dart.voidR, [core.int, core.int], [html.Element]],
          replaceRange: [dart.voidR, [core.int, core.int, core.Iterable$(html.Element)]],
          removeLast: [html.Element, []],
          insert: [dart.voidR, [core.int, html.Element]],
          insertAll: [dart.voidR, [core.int, core.Iterable$(html.Element)]],
  ...
  class Lists extends core.Object {
    ...
    static getRange(a, start, end, accumulator) {
      if (dart.notNull(start) < 0) dart.throw_(new core.RangeError.value(start));
      if (dart.notNull(end) < dart.notNull(start)) dart.throw_(new core.RangeError.value(end));
      if (dart.notNull(end) > dart.notNull(a[dartx.length])) dart.throw_(new core.RangeError.value(end));
