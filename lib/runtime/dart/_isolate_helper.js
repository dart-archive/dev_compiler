dart_library.library('dart/_isolate_helper', null, /* Imports */[
  ...
  class _Serializer extends core.Object {
    _Serializer(opts) {
      ...
      this.serializedObjectIds = core.Map$(dart.dynamicR, core.int).identity();
    ...
    unsupported(x, message) {
      ...
      dart.throw_(new core.UnsupportedError(`${message} ${x}`));
    }
    ...
    serializeMap(x) {
      ...
      return ['map', x.keys[dartx.map](dart.as(serializeTearOff, __CastType0))[dartx.toList](), x.values[dartx.map](dart.as(serializeTearOff, dart.functionType(dart.dynamicR, [dart.dynamicR])))[dartx.toList]()];
    }
    serializeJSObject(x) {
  ...
  dart.setSignature(_Serializer, {
    constructors: () => ({_Serializer: [_Serializer, [], {serializeSendPorts: dart.dynamicR}]}),
    methods: () => ({
      serialize: [dart.dynamicR, [dart.dynamicR]],
      unsupported: [dart.voidR, [dart.dynamicR], [core.String]],
      makeRef: [dart.dynamicR, [core.int]],
      isPrimitive: [core.bool, [dart.dynamicR]],
      serializePrimitive: [dart.dynamicR, [dart.dynamicR]],
      serializeByteBuffer: [dart.dynamicR, [_native_typed_data.NativeByteBuffer]],
      serializeTypedData: [dart.dynamicR, [_native_typed_data.NativeTypedData]],
      serializeJSIndexable: [dart.dynamicR, [_interceptors.JSIndexable]],
      serializeArray: [dart.dynamicR, [_interceptors.JSArray]],
      serializeArrayInPlace: [dart.dynamicR, [_interceptors.JSArray]],
      serializeMap: [dart.dynamicR, [core.Map]],
      serializeJSObject: [dart.dynamicR, [_interceptors.JSObject]],
      serializeWorkerSendPort: [dart.dynamicR, [_WorkerSendPort]],
      serializeJsSendPort: [dart.dynamicR, [_NativeJsSendPort]],
      serializeCapability: [dart.dynamicR, [CapabilityImpl]],
      serializeClosure: [dart.dynamicR, [core.Function]],
      serializeDartObject: [dart.dynamicR, [dart.dynamicR]]
    })
  });
  ...
  class _Deserializer extends core.Object {
    ...
    deserialize(x) {
      ...
      if (!dart.is(x, _interceptors.JSArray)) dart.throw_(new core.ArgumentError(`Bad serialized message: ${x}`));
      switch (dart.dload(x, 'first')) {
        ...
        default:
        {
          dart.throw_(`couldn't deserialize: ${x}`);
        }
      }
    }
    isPrimitive(x) {
  ...
  dart.setSignature(_Deserializer, {
    constructors: () => ({_Deserializer: [_Deserializer, [], {adjustSendPorts: dart.dynamicR}]}),
    methods: () => ({
      deserialize: [dart.dynamicR, [dart.dynamicR]],
      isPrimitive: [core.bool, [dart.dynamicR]],
      deserializePrimitive: [dart.dynamicR, [dart.dynamicR]],
      deserializeRef: [dart.dynamicR, [dart.dynamicR]],
      deserializeByteBuffer: [_native_typed_data.NativeByteBuffer, [dart.dynamicR]],
      deserializeTypedData: [_native_typed_data.NativeTypedData, [dart.dynamicR]],
      deserializeArrayInPlace: [core.List, [_interceptors.JSArray]],
      deserializeFixed: [core.List, [dart.dynamicR]],
      deserializeExtendable: [core.List, [dart.dynamicR]],
      deserializeMutable: [core.List, [dart.dynamicR]],
      deserializeConst: [core.List, [dart.dynamicR]],
      deserializeMap: [core.Map, [dart.dynamicR]],
      deserializeSendPort: [isolate.SendPort, [dart.dynamicR]],
      deserializeRawSendPort: [isolate.SendPort, [dart.dynamicR]],
      deserializeJSObject: [dart.dynamicR, [dart.dynamicR]],
      deserializeClosure: [core.Function, [dart.dynamicR]],
      deserializeDartObject: [dart.dynamicR, [dart.dynamicR]]
    })
  });
  ...
  dart.fn(_callInIsolate, () => dart.definiteFunctionType(dart.dynamicR, [_IsolateContext, core.Function]));
  ...
  function startRootIsolate(entry, args) {
    ...
    if (!dart.is(args, core.List)) {
      dart.throw_(new core.ArgumentError(`Arguments to main must be a List: ${args}`));
    }
  ...
  dart.fn(startRootIsolate, dart.voidR, [dart.dynamicR, dart.dynamicR]);
  ...
  class _Manager extends core.Object {
    ...
    _Manager(entry) {
      ...
      this.managers = core.Map$(core.int, dart.dynamicR).new();
  ...
  dart.setSignature(_Manager, {
    ...
    methods: () => ({
      [_nativeDetectEnvironment]: [dart.voidR, []],
      [_nativeInitWorkerMessageHandler]: [dart.voidR, []],
      maybeCloseWorker: [dart.voidR, []]
    }),
    statics: () => ({_serializePrintMessage: [dart.dynamicR, [dart.dynamicR]]}),
  ...
  class _IsolateContext extends core.Object {
    ...
    [_addRegistration](portId, port) {
      if (dart.notNull(this.ports.containsKey(portId))) {
        dart.throw_(core.Exception.new("Registry: ports must be registered only once."));
      }
  ...
  _IsolateContext[dart.implements_] = () => [_foreign_helper.IsolateContext];
  dart.setSignature(_IsolateContext, {
    constructors: () => ({_IsolateContext: [_IsolateContext, []]}),
    methods: () => ({
      addPause: [dart.voidR, [isolate.Capability, isolate.Capability]],
      removePause: [dart.voidR, [isolate.Capability]],
      addDoneListener: [dart.voidR, [isolate.SendPort]],
      removeDoneListener: [dart.voidR, [isolate.SendPort]],
      setErrorsFatal: [dart.voidR, [isolate.Capability, core.bool]],
      handlePing: [dart.voidR, [isolate.SendPort, core.int]],
      handleKill: [dart.voidR, [isolate.Capability, core.int]],
      addErrorListener: [dart.voidR, [isolate.SendPort]],
      removeErrorListener: [dart.voidR, [isolate.SendPort]],
      handleUncaughtError: [dart.voidR, [dart.dynamicR, core.StackTrace]],
      eval: [dart.dynamicR, [core.Function]],
      [_setGlobals]: [dart.voidR, []],
      handleControlMessage: [dart.voidR, [dart.dynamicR]],
      lookup: [RawReceivePortImpl, [core.int]],
      [_addRegistration]: [dart.voidR, [core.int, RawReceivePortImpl]],
      register: [dart.voidR, [core.int, RawReceivePortImpl]],
      registerWeak: [dart.voidR, [core.int, RawReceivePortImpl]],
      [_updateGlobalState]: [dart.voidR, []],
      kill: [dart.voidR, []],
      unregister: [dart.voidR, [core.int]]
    })
  });
  ...
  class _EventLoop extends core.Object {
    ...
    checkOpenReceivePortsFromCommandLine() {
      if (exports._globalState.rootContext != null && dart.notNull(exports._globalState.isolates.containsKey(exports._globalState.rootContext.id)) && dart.notNull(exports._globalState.fromCommandLine) && dart.notNull(exports._globalState.rootContext.ports.isEmpty)) {
        dart.throw_(core.Exception.new("Program exited with open ReceivePorts."));
      }
    }
    runIteration() {
  ...
  dart.setSignature(_EventLoop, {
    ...
    methods: () => ({
      enqueue: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      prequeue: [dart.voidR, [_IsolateEvent]],
      dequeue: [_IsolateEvent, []],
      checkOpenReceivePortsFromCommandLine: [dart.voidR, []],
      runIteration: [core.bool, []],
      [_runHelper]: [dart.voidR, []],
      run: [dart.voidR, []]
    })
  });
  ...
  dart.setSignature(_MainManagerStub, {
    methods: () => ({postMessage: [dart.voidR, [dart.dynamicR]]})
  });
  ...
  const _MainFunction = dart.typedef('_MainFunction', () => dart.functionType(dart.dynamicR, []));
  const _MainFunctionArgs = dart.typedef('_MainFunctionArgs', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  const _MainFunctionArgsMessage = dart.typedef('_MainFunctionArgsMessage', () => dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR]));
  class IsolateNatives extends core.Object {
    ...
    static computeThisScriptFromTrace() {
      ...
      if (stack == null) {
        ...
        if (stack == null) dart.throw_(new core.UnsupportedError('No stack trace'));
      }
      ...
      matches = stack.match(pattern);
      if (matches != null) return matches[1];
      dart.throw_(new core.UnsupportedError(`Cannot extract URI from "${stack}"`));
    }
    ...
    static _processWorkerMessage(sender, e) {
      ...
      switch (dart.dindex(msg, 'command')) {
        ...
        case 'error':
        {
          dart.throw_(dart.dindex(msg, 'msg'));
        }
      }
    }
    static handleSpawnWorkerRequest(msg) {
      ...
      }, dart.dynamicR, [core.List]), {onError: dart.fn(errorMessage => {
          dart.dsend(replyPort, 'send', [_SPAWN_FAILED_SIGNAL, errorMessage]);
        }, dart.dynamicR, [core.String])});
    }
    static _log(msg) {
      if (dart.notNull(exports._globalState.isWorker)) {
        ...
        try {
          ...
          let trace = dart.stackTrace(e);
          dart.throw_(core.Exception.new(trace));
        }
    ...
    static spawnFunction(topLevelFunction, message, startPaused) {
      ...
      if (name == null) {
        dart.throw_(new core.UnsupportedError("only top-level functions can be spawned."));
      }
      let isLight = false;
    ...
    static spawn(functionName, uri, args, message, isLight, isSpawnUri, startPaused) {
      ...
      if (dart.notNull(exports._globalState.useWorkers) && !dart.notNull(isLight)) {
        IsolateNatives._startWorker(functionName, uri, args, message, isSpawnUri, startPaused, signalReply, dart.fn(message => completer.completeError(message), dart.voidR, [core.String]));
      } else {
    ...
    static _startNonWorker(functionName, uri, args, message, isSpawnUri, startPaused, replyPort) {
      if (uri != null) {
        dart.throw_(new core.UnsupportedError("Currently spawnUri is not supported without web workers."));
      }
    ...
    static _startIsolate(topLevel, args, message, isSpawnUri, startPaused, replyTo) {
      ...
      dart.fn(runStartFunction, dart.voidR, []);
  ...
  dart.setSignature(IsolateNatives, {
    statics: () => ({
      ...
      _getEventData: [dart.dynamicR, [dart.dynamicR]],
      _processWorkerMessage: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      handleSpawnWorkerRequest: [dart.dynamicR, [dart.dynamicR]],
      _log: [dart.dynamicR, [dart.dynamicR]],
      _consoleLog: [dart.voidR, [dart.dynamicR]],
      _getJSFunctionFromName: [dart.dynamicR, [core.String]],
      _getJSFunctionName: [core.String, [core.Function]],
      _allocate: [dart.dynamicR, [dart.dynamicR]],
      spawnFunction: [async.Future$(core.List), [dart.functionType(dart.voidR, [dart.dynamicR]), dart.dynamicR, core.bool]],
      spawnUri: [async.Future$(core.List), [core.Uri, core.List$(core.String), dart.dynamicR, core.bool]],
      spawn: [async.Future$(core.List), [core.String, core.String, core.List$(core.String), dart.dynamicR, core.bool, core.bool, core.bool]],
      _startWorker: [dart.voidR, [core.String, core.String, core.List$(core.String), dart.dynamicR, core.bool, core.bool, isolate.SendPort, dart.functionType(dart.voidR, [core.String])]],
      _startNonWorker: [dart.voidR, [core.String, core.String, core.List$(core.String), dart.dynamicR, core.bool, core.bool, isolate.SendPort]],
      _startIsolate: [dart.voidR, [core.Function, core.List$(core.String), dart.dynamicR, core.bool, core.bool, isolate.SendPort]],
      _spawnWorker: [dart.voidR, [dart.dynamicR, core.String, core.List$(core.String), dart.dynamicR, core.bool, core.bool, isolate.SendPort, dart.functionType(dart.voidR, [core.String])]],
      workerOnError: [core.bool, [dart.dynamicR, core.String, dart.functionType(dart.voidR, [core.String])]]
    }),
  ...
  class _BaseSendPort extends core.Object {
    ...
    [_checkReplyTo](replyTo) {
      if (replyTo != null && !dart.is(replyTo, _NativeJsSendPort) && !dart.is(replyTo, _WorkerSendPort)) {
        dart.throw_(core.Exception.new("SendPort.send: Illegal replyTo port type"));
      }
    }
  }
  _BaseSendPort[dart.implements_] = () => [isolate.SendPort];
  dart.setSignature(_BaseSendPort, {
    constructors: () => ({_BaseSendPort: [_BaseSendPort, [core.int]]}),
    methods: () => ({[_checkReplyTo]: [dart.voidR, [isolate.SendPort]]})
  });
  ...
  _WorkerSendPort[dart.implements_] = () => [isolate.SendPort];
  ...
  RawReceivePortImpl[dart.implements_] = () => [isolate.RawReceivePort];
  ...
  ReceivePortImpl[dart.implements_] = () => [isolate.ReceivePort];
  ...
  dart.setSignature(ReceivePortImpl, {
    ...
    methods: () => ({
      listen: [async.StreamSubscription, [dart.functionType(dart.voidR, [dart.dynamicR])], {onError: core.Function, onDone: dart.functionType(dart.voidR, []), cancelOnError: core.bool}],
      close: [dart.voidR, []]
    })
  });
  ...
  class TimerImpl extends core.Object {
    TimerImpl(milliseconds, callback) {
      ...
      if (milliseconds == 0 && (!dart.notNull(hasTimer()) || dart.notNull(exports._globalState.isWorker))) {
        ...
        dart.fn(internalCallback, dart.voidR, []);
        this[_handle] = 1;
        ...
        dart.throw_(new core.UnsupportedError("Timer greater than 0."));
      }
    }
    periodic(milliseconds, callback) {
      ...
      if (dart.notNull(hasTimer())) {
        ...
        dart.throw_(new core.UnsupportedError("Periodic timer."));
      }
    }
    cancel() {
      if (dart.notNull(hasTimer())) {
        if (dart.notNull(this[_inEventLoop])) {
          dart.throw_(new core.UnsupportedError("Timer in event loop cannot be canceled."));
        }
        ...
        dart.throw_(new core.UnsupportedError("Canceling a timer."));
      }
    }
    get isActive() {
  ...
  TimerImpl[dart.implements_] = () => [async.Timer];
  dart.defineNamedConstructor(TimerImpl, 'periodic');
  dart.setSignature(TimerImpl, {
    constructors: () => ({
      TimerImpl: [TimerImpl, [core.int, dart.functionType(dart.voidR, [])]],
      periodic: [TimerImpl, [core.int, dart.functionType(dart.voidR, [async.Timer])]]
    }),
    methods: () => ({cancel: [dart.voidR, []]})
  });
  function hasTimer() {
  ...
  CapabilityImpl[dart.implements_] = () => [isolate.Capability];
