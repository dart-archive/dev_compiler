dart_library.library('dart/_isolate_helper', null, /* Imports */[
  ...
  exports[dart.uri] = 'dart:_isolate_helper';
  ...
  class _Serializer extends core.Object {
    ...
    serializeMap(x) {
      ...
      return ['map', x[dartx.keys][dartx.map](dart.as(serializeTearOff, dart.functionType(dart.dynamic, [dart.dynamic])))[dartx.toList](), x[dartx.values][dartx.map](dart.as(serializeTearOff, dart.functionType(dart.dynamic, [dart.dynamic])))[dartx.toList]()];
    }
    serializeJSObject(x) {
  ...
  _Serializer[dart.owner] = exports;
  ...
  _Deserializer[dart.owner] = exports;
  ...
  _IsolateContext[dart.owner] = exports;
  ...
  _IsolateEvent[dart.owner] = exports;
  ...
  _MainManagerStub[dart.owner] = exports;
  ...
  IsolateNatives[dart.owner] = exports;
  ...
  _BaseSendPort[dart.owner] = exports;
  ...
  _NativeJsSendPort[dart.owner] = exports;
  ...
  _WorkerSendPort[dart.owner] = exports;
  ...
  RawReceivePortImpl[dart.owner] = exports;
  ...
  ReceivePortImpl[dart.owner] = exports;
  ...
  CapabilityImpl[dart.owner] = exports;
  // Exports:
