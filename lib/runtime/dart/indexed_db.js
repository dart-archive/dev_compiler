dart_library.library('dart/indexed_db', null, /* Imports */[
  ...
  exports[dart.uri] = 'dart:indexed_db';
  ...
  _KeyRangeFactoryProvider[dart.owner] = exports;
  ...
  Cursor[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('IDBCursor')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBCursor"))], 'fields', dart.map(['direction', [dart.const(new _metadata.DomName('IDBCursor.direction')), dart.const(new _metadata.DocsEditable())], 'key', [dart.const(new _metadata.DomName('IDBCursor.key')), dart.const(new _metadata.DocsEditable()), _annotation_Creates_IDBKey, _annotation_Returns_IDBKey], 'primaryKey', [dart.const(new _metadata.DomName('IDBCursor.primaryKey')), dart.const(new _metadata.DocsEditable()), _annotation_Creates_IDBKey, _annotation_Returns_IDBKey], 'source', [dart.const(new _metadata.DomName('IDBCursor.source')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Creates('Null')), dart.const(new _js_helper.Returns('ObjectStore|Index|Null'))]])]);
  Cursor[dart.owner] = exports;
  ...
  CursorWithValue[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('IDBCursorWithValue')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBCursorWithValue"))], 'fields', dart.map(['_get_value', [dart.const(new _js_helper.JSName('value')), dart.const(new _metadata.DomName('IDBCursorWithValue.value')), dart.const(new _metadata.DocsEditable()), html_common.annotation_Creates_SerializedScriptValue, html_common.annotation_Returns_SerializedScriptValue]]), 'properties', dart.map(['value', [dart.const(new _metadata.DomName('IDBCursorWithValue.value')), dart.const(new _metadata.DocsEditable())]])]);
  CursorWithValue[dart.owner] = exports;
  ...
  Database[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('IDBDatabase')), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX, '15')), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const(new _metadata.Experimental()), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBDatabase"))], 'fields', dart.map(['name', [dart.const(new _metadata.DomName('IDBDatabase.name')), dart.const(new _metadata.DocsEditable())], 'objectStoreNames', [dart.const(new _metadata.DomName('IDBDatabase.objectStoreNames')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Returns('DomStringList')), dart.const(new _js_helper.Creates('DomStringList'))], 'version', [dart.const(new _metadata.DomName('IDBDatabase.version')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Creates('int|String|Null')), dart.const(new _js_helper.Returns('int|String|Null'))]]), 'properties', dart.map(['onAbort', [dart.const(new _metadata.DomName('IDBDatabase.onabort')), dart.const(new _metadata.DocsEditable())], 'onClose', [dart.const(new _metadata.DomName('IDBDatabase.onclose')), dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.Experimental())], 'onError', [dart.const(new _metadata.DomName('IDBDatabase.onerror')), dart.const(new _metadata.DocsEditable())], 'onVersionChange', [dart.const(new _metadata.DomName('IDBDatabase.onversionchange')), dart.const(new _metadata.DocsEditable())]])]);
  Database[dart.owner] = exports;
  ...
  IdbFactory[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('IDBFactory')), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX, '15')), dart.const(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const(new _metadata.Experimental()), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBFactory"))]]);
  IdbFactory[dart.owner] = exports;
  ...
  Index[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('IDBIndex')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBIndex"))], 'fields', dart.map(['keyPath', [dart.const(new _metadata.DomName('IDBIndex.keyPath')), dart.const(new _metadata.DocsEditable()), html_common.annotation_Creates_SerializedScriptValue], 'multiEntry', [dart.const(new _metadata.DomName('IDBIndex.multiEntry')), dart.const(new _metadata.DocsEditable())], 'name', [dart.const(new _metadata.DomName('IDBIndex.name')), dart.const(new _metadata.DocsEditable())], 'objectStore', [dart.const(new _metadata.DomName('IDBIndex.objectStore')), dart.const(new _metadata.DocsEditable())], 'unique', [dart.const(new _metadata.DomName('IDBIndex.unique')), dart.const(new _metadata.DocsEditable())]])]);
  Index[dart.owner] = exports;
  ...
  KeyRange[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('IDBKeyRange')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBKeyRange"))], 'fields', dart.map(['lower', [dart.const(new _metadata.DomName('IDBKeyRange.lower')), dart.const(new _metadata.DocsEditable()), html_common.annotation_Creates_SerializedScriptValue], 'lowerOpen', [dart.const(new _metadata.DomName('IDBKeyRange.lowerOpen')), dart.const(new _metadata.DocsEditable())], 'upper', [dart.const(new _metadata.DomName('IDBKeyRange.upper')), dart.const(new _metadata.DocsEditable()), html_common.annotation_Creates_SerializedScriptValue], 'upperOpen', [dart.const(new _metadata.DomName('IDBKeyRange.upperOpen')), dart.const(new _metadata.DocsEditable())]])]);
  KeyRange[dart.owner] = exports;
  ...
  ObjectStore[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('IDBObjectStore')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBObjectStore"))], 'fields', dart.map(['autoIncrement', [dart.const(new _metadata.DomName('IDBObjectStore.autoIncrement')), dart.const(new _metadata.DocsEditable())], 'indexNames', [dart.const(new _metadata.DomName('IDBObjectStore.indexNames')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Returns('DomStringList')), dart.const(new _js_helper.Creates('DomStringList'))], 'keyPath', [dart.const(new _metadata.DomName('IDBObjectStore.keyPath')), dart.const(new _metadata.DocsEditable()), html_common.annotation_Creates_SerializedScriptValue], 'name', [dart.const(new _metadata.DomName('IDBObjectStore.name')), dart.const(new _metadata.DocsEditable())], 'transaction', [dart.const(new _metadata.DomName('IDBObjectStore.transaction')), dart.const(new _metadata.DocsEditable())]])]);
  ObjectStore[dart.owner] = exports;
  ...
  Request[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('IDBRequest')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBRequest"))], 'fields', dart.map(['error', [dart.const(new _metadata.DomName('IDBRequest.error')), dart.const(new _metadata.DocsEditable())], 'readyState', [dart.const(new _metadata.DomName('IDBRequest.readyState')), dart.const(new _metadata.DocsEditable())], '_get_result', [dart.const(new _js_helper.JSName('result')), dart.const(new _metadata.DomName('IDBRequest.result')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Creates('Null'))], 'source', [dart.const(new _metadata.DomName('IDBRequest.source')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Creates('Null'))], 'transaction', [dart.const(new _metadata.DomName('IDBRequest.transaction')), dart.const(new _metadata.DocsEditable())]]), 'properties', dart.map(['result', [dart.const(new _metadata.DomName('IDBRequest.result')), dart.const(new _metadata.DocsEditable())], 'onError', [dart.const(new _metadata.DomName('IDBRequest.onerror')), dart.const(new _metadata.DocsEditable())], 'onSuccess', [dart.const(new _metadata.DomName('IDBRequest.onsuccess')), dart.const(new _metadata.DocsEditable())]])]);
  Request[dart.owner] = exports;
  ...
  OpenDBRequest[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('IDBOpenDBRequest')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBOpenDBRequest,IDBVersionChangeRequest"))], 'properties', dart.map(['onBlocked', [dart.const(new _metadata.DomName('IDBOpenDBRequest.onblocked')), dart.const(new _metadata.DocsEditable())], 'onUpgradeNeeded', [dart.const(new _metadata.DomName('IDBOpenDBRequest.onupgradeneeded')), dart.const(new _metadata.DocsEditable())]])]);
  OpenDBRequest[dart.owner] = exports;
  ...
  Transaction[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DomName('IDBTransaction')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBTransaction"))], 'fields', dart.map(['db', [dart.const(new _metadata.DomName('IDBTransaction.db')), dart.const(new _metadata.DocsEditable())], 'error', [dart.const(new _metadata.DomName('IDBTransaction.error')), dart.const(new _metadata.DocsEditable())], 'mode', [dart.const(new _metadata.DomName('IDBTransaction.mode')), dart.const(new _metadata.DocsEditable())]]), 'properties', dart.map(['onAbort', [dart.const(new _metadata.DomName('IDBTransaction.onabort')), dart.const(new _metadata.DocsEditable())], 'onComplete', [dart.const(new _metadata.DomName('IDBTransaction.oncomplete')), dart.const(new _metadata.DocsEditable())], 'onError', [dart.const(new _metadata.DomName('IDBTransaction.onerror')), dart.const(new _metadata.DocsEditable())]])]);
  Transaction[dart.owner] = exports;
  ...
  VersionChangeEvent[dart.metadata] = () => dart.map(['type', [dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.DomName('IDBVersionChangeEvent')), dart.const(new _metadata.Unstable()), dart.const(new _js_helper.Native("IDBVersionChangeEvent"))], 'fields', dart.map(['dataLoss', [dart.const(new _metadata.DomName('IDBVersionChangeEvent.dataLoss')), dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.Experimental())], 'dataLossMessage', [dart.const(new _metadata.DomName('IDBVersionChangeEvent.dataLossMessage')), dart.const(new _metadata.DocsEditable()), dart.const(new _metadata.Experimental())], 'newVersion', [dart.const(new _metadata.DomName('IDBVersionChangeEvent.newVersion')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Creates('int|String|Null')), dart.const(new _js_helper.Returns('int|String|Null'))], 'oldVersion', [dart.const(new _metadata.DomName('IDBVersionChangeEvent.oldVersion')), dart.const(new _metadata.DocsEditable()), dart.const(new _js_helper.Creates('int|String|Null')), dart.const(new _js_helper.Returns('int|String|Null'))]])]);
  VersionChangeEvent[dart.owner] = exports;
