dart_library.library('dart/collection', null, /* Imports */[
  ...
  const HashMap$ = dart.generic(function(K, V) {
    class HashMap extends core.Object {
      ...
      static from(other) {
        ...
        }, dart.voidR, [dart.dynamicR, dart.dynamicR]));
        return result;
      }
    ...
    HashMap[dart.implements_] = () => [core.Map$(K, V)];
    dart.setSignature(HashMap, {
      constructors: () => ({
        ...
        fromIterable: [HashMap$(K, V), [core.Iterable], {key: dart.functionType(K, [dart.dynamicR]), value: dart.functionType(V, [dart.dynamicR])}],
  ...
  const SetMixin$ = dart.generic(function(E) {
    class SetMixin extends core.Object {
      ...
      map(f) {
        ...
        return new (_internal.EfficientLengthMappedIterable$(E, dart.dynamicR))(this, f);
      }
      get single() {
        if (dart.notNull(this.length) > 1) dart.throw_(_internal.IterableElementError.tooMany());
        let it = this.iterator;
        if (!dart.notNull(it.moveNext())) dart.throw_(_internal.IterableElementError.noElement());
      ...
      expand(f) {
        ...
        return new (_internal.ExpandIterable$(E, dart.dynamicR))(this, f);
      }
      forEach(f) {
      ...
      elementAt(index) {
        if (!(typeof index == 'number')) dart.throw_(new core.ArgumentError.notNull("index"));
        ...
        dart.throw_(core.RangeError.index(index, this, "index", null, elementIndex));
      }
    }
    SetMixin[dart.implements_] = () => [core.Set$(E)];
  ...
  const HashSet$ = dart.generic(function(E) {
    ...
    HashSet[dart.implements_] = () => [core.Set$(E)];
  ...
  const IterableMixin$ = dart.generic(function(E) {
    class IterableMixin extends core.Object {
      map(f) {
        dart.as(f, dart.functionType(dart.dynamicR, [E]));
        return _internal.MappedIterable$(E, dart.dynamicR).new(this, f);
      }
      where(f) {
        dart.as(f, dart.functionType(core.bool, [E]));
        return new (_internal.WhereIterable$(E))(this, f);
      ...
      get single() {
        ...
        if (!dart.notNull(it.moveNext())) dart.throw_(_internal.IterableElementError.noElement());
        let result = it.current;
        if (dart.notNull(it.moveNext())) dart.throw_(_internal.IterableElementError.tooMany());
        return result;
      }
      firstWhere(test, opts) {
        dart.as(test, dart.functionType(core.bool, [E]));
    ...
    IterableMixin[dart.implements_] = () => [core.Iterable$(E)];
  ...
  const IterableBase$ = dart.generic(function(E) {
    class IterableBase extends core.Object {
      ...
      static _iterablePartsToStrings(iterable, parts) {
        ...
        let ultimate = null;
        if (!dart.notNull(it.moveNext())) {
          if (dart.notNull(count) <= dart.notNull(HEAD_COUNT) + dart.notNull(TAIL_COUNT)) return;
    ...
    IterableBase[dart.implements_] = () => [core.Iterable$(E)];
    dart.setSignature(IterableBase, {
      ...
      statics: () => ({
        ...
        _iterablePartsToStrings: [dart.voidR, [core.Iterable, core.List]]
      }),
  ...
  const HasNextIterator$ = dart.generic(function(E) {
    class HasNextIterator extends core.Object {
      ...
      next() {
        if (!dart.notNull(this.hasNext)) dart.throw_(new core.StateError("No more elements"));
  ...
  const LinkedHashMap$ = dart.generic(function(K, V) {
    ...
    LinkedHashMap[dart.implements_] = () => [HashMap$(K, V)];
    dart.setSignature(LinkedHashMap, {
      constructors: () => ({
        ...
        fromIterable: [LinkedHashMap$(K, V), [core.Iterable], {key: dart.functionType(K, [dart.dynamicR]), value: dart.functionType(V, [dart.dynamicR])}],
  ...
  const LinkedHashSet$ = dart.generic(function(E) {
    ...
    LinkedHashSet[dart.implements_] = () => [HashSet$(E)];
  ...
  const LinkedList$ = dart.generic(function(E) {
    class LinkedList extends IterableBase$(E) {
      ...
      addAll(entries) {
        ...
        entries[dartx.forEach](dart.fn((entry => this[_insertAfter](this[_previous], entry)).bind(this), dart.voidR, [E]));
      }
      remove(entry) {
        dart.as(entry, E);
      ...
      get first() {
        if (dart.notNull(core.identical(this[_next], this))) {
          dart.throw_(new core.StateError('No such element'));
        }
      ...
      get single() {
        ...
        if (!dart.notNull(core.identical(this[_previous], this[_next]))) {
          dart.throw_(new core.StateError('Too many elements'));
        }
        return dart.as(this[_next], E);
      }
      forEach(action) {
        dart.as(action, dart.functionType(dart.voidR, [E]));
      ...
      [_insertAfter](entry, newEntry) {
        ...
        if (newEntry.list != null) {
          dart.throw_(new core.StateError('LinkedListEntry is already in a LinkedList'));
        }
        this[_modificationCount] = dart.notNull(this[_modificationCount]) + 1;
        newEntry[_list] = this;
    ...
    LinkedList[dart.implements_] = () => [_LinkedListLink];
    dart.setSignature(LinkedList, {
      ...
      methods: () => ({
        ...
        clear: [dart.voidR, []],
        forEach: [dart.voidR, [dart.functionType(dart.voidR, [E])]],
        [_insertAfter]: [dart.voidR, [_LinkedListLink, E]],
        [_unlink]: [dart.voidR, [LinkedListEntry$(E)]]
      })
    });
  ...
  const _LinkedListIterator$ = dart.generic(function(E) {
    ...
    _LinkedListIterator[dart.implements_] = () => [core.Iterator$(E)];
  ...
  const LinkedListEntry$ = dart.generic(function(E) {
    ...
    LinkedListEntry[dart.implements_] = () => [_LinkedListLink];
    dart.setSignature(LinkedListEntry, {
      methods: () => ({
        unlink: [dart.voidR, []],
        insertAfter: [dart.voidR, [E]],
        insertBefore: [dart.voidR, [E]]
      })
    });
  ...
  const ListMixin$ = dart.generic(function(E) {
    class ListMixin extends core.Object {
      ...
      get first() {
        if (this[dartx.length] == 0) dart.throw_(_internal.IterableElementError.noElement());
        return this.get(0);
      }
      get last() {
        if (this[dartx.length] == 0) dart.throw_(_internal.IterableElementError.noElement());
      ...
      get single() {
        if (this[dartx.length] == 0) dart.throw_(_internal.IterableElementError.noElement());
        if (dart.notNull(this[dartx.length]) > 1) dart.throw_(_internal.IterableElementError.tooMany());
        return this.get(0);
      }
      contains(element) {
        let length = this.length;
      ...
      map(f) {
        dart.as(f, dart.functionType(dart.dynamicR, [E]));
        return new (_internal.MappedListIterable$(E, dart.dynamicR))(this, f);
      }
      expand(f) {
        dart.as(f, dart.functionType(core.Iterable, [E]));
        return new (_internal.ExpandIterable$(E, dart.dynamicR))(this, f);
      ...
      reduce(combine) {
        dart.as(combine, dart.functionType(E, [E, E]));
        let length = this.length;
        if (length == 0) dart.throw_(_internal.IterableElementError.noElement());
      ...
      static _filter(source, test, retainMatching) {
        ...
        for (let i = 0; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
          ...
          if (length != source[dartx.length]) {
            dart.throw_(new core.ConcurrentModificationError(source));
          }
        }
      ...
      setRange(start, end, iterable, skipCount) {
        ...
        if (dart.notNull(otherStart) + dart.notNull(length) > dart.notNull(otherList[dartx.length])) {
          dart.throw_(_internal.IterableElementError.tooFew());
        }
      ...
      insert(index, element) {
        ...
        if (!(typeof index == 'number')) dart.throw_(new core.ArgumentError(index));
        this.length = dart.notNull(this.length) + 1;
    ...
    ListMixin[dart.implements_] = () => [core.List$(E)];
    dart.setSignature(ListMixin, {
      ...
      statics: () => ({_filter: [dart.voidR, [core.List, dart.functionType(core.bool, [dart.dynamicR]), core.bool]]}),
      names: ['_filter']
    });
  ...
  const __CastType0 = dart.typedef('__CastType0', () => dart.functionType(core.int, [dart.dynamicR, dart.dynamicR]));
  const MapMixin$ = dart.generic(function(K, V) {
    class MapMixin extends core.Object {
      forEach(action) {
        dart.as(action, dart.functionType(dart.voidR, [K, V]));
    ...
    MapMixin[dart.implements_] = () => [core.Map$(K, V)];
  ...
  const _UnmodifiableMapMixin$ = dart.generic(function(K, V) {
    class _UnmodifiableMapMixin extends core.Object {
      set(key, value) {
        dart.as(key, K);
        dart.as(value, V);
        dart.throw_(new core.UnsupportedError("Cannot modify unmodifiable map"));
        return value;
      }
      addAll(other) {
        dart.as(other, core.Map$(K, V));
    ...
    _UnmodifiableMapMixin[dart.implements_] = () => [core.Map$(K, V)];
  ...
  const _MapBaseValueIterable$ = dart.generic(function(V) {
    ...
    _MapBaseValueIterable[dart.implements_] = () => [_internal.EfficientLength];
  ...
  const _MapBaseValueIterator$ = dart.generic(function(V) {
    ...
    _MapBaseValueIterator[dart.implements_] = () => [core.Iterator$(V)];
  ...
  const MapView$ = dart.generic(function(K, V) {
    ...
    MapView[dart.implements_] = () => [core.Map$(K, V)];
  ...
  class Maps extends core.Object {
    ...
    static _fillMapWithIterables(map, keys, values) {
      ...
      if (dart.notNull(hasNextKey) || dart.notNull(hasNextValue)) {
        dart.throw_(new core.ArgumentError("Iterables do not have same length."));
      }
    }
  }
  dart.setSignature(Maps, {
    statics: () => ({
      containsValue: [core.bool, [core.Map, dart.dynamicR]],
      containsKey: [core.bool, [core.Map, dart.dynamicR]],
      putIfAbsent: [dart.dynamicR, [core.Map, dart.dynamicR, dart.functionType(dart.dynamicR, [])]],
      clear: [dart.dynamicR, [core.Map]],
      forEach: [dart.dynamicR, [core.Map, dart.functionType(dart.voidR, [dart.dynamicR, dart.dynamicR])]],
      ...
      _id: [dart.dynamicR, [dart.dynamicR]],
      _fillMapWithMappedIterable: [dart.voidR, [core.Map, core.Iterable, dart.functionType(dart.dynamicR, [dart.dynamicR]), dart.functionType(dart.dynamicR, [dart.dynamicR])]],
      _fillMapWithIterables: [dart.voidR, [core.Map, core.Iterable, core.Iterable]]
    }),
  ...
  const Queue$ = dart.generic(function(E) {
    ...
    Queue[dart.implements_] = () => [core.Iterable$(E), _internal.EfficientLength];
  ...
  const DoubleLinkedQueueEntry$ = dart.generic(function(E) {
    ...
    dart.setSignature(DoubleLinkedQueueEntry, {
      ...
      methods: () => ({
        [_link]: [dart.voidR, [DoubleLinkedQueueEntry$(E), DoubleLinkedQueueEntry$(E)]],
        append: [dart.voidR, [E]],
        prepend: [dart.voidR, [E]],
        remove: [E, []],
  ...
  const DoubleLinkedQueue$ = dart.generic(function(E) {
    class DoubleLinkedQueue extends IterableBase$(E) {
      ...
      forEachEntry(f) {
        dart.as(f, dart.functionType(dart.voidR, [DoubleLinkedQueueEntry$(E)]));
        let entry = this[_sentinel][_next];
        while (!dart.notNull(core.identical(entry, this[_sentinel]))) {
    ...
    DoubleLinkedQueue[dart.implements_] = () => [Queue$(E)];
    dart.setSignature(DoubleLinkedQueue, {
      ...
      methods: () => ({
        ...
        removeFirst: [E, []],
        remove: [core.bool, [core.Object]],
        [_filter]: [dart.voidR, [dart.functionType(core.bool, [E]), core.bool]],
        removeWhere: [dart.voidR, [dart.functionType(core.bool, [E])]],
        retainWhere: [dart.voidR, [dart.functionType(core.bool, [E])]],
        lastEntry: [DoubleLinkedQueueEntry$(E), []],
        firstEntry: [DoubleLinkedQueueEntry$(E), []],
        clear: [dart.voidR, []],
        forEachEntry: [dart.voidR, [dart.functionType(dart.voidR, [DoubleLinkedQueueEntry$(E)])]]
      })
    });
  ...
  const _DoubleLinkedQueueIterator$ = dart.generic(function(E) {
    ...
    _DoubleLinkedQueueIterator[dart.implements_] = () => [core.Iterator$(E)];
  ...
  const ListQueue$ = dart.generic(function(E) {
    class ListQueue extends IterableBase$(E) {
      ...
      get first() {
        if (this[_head] == this[_tail]) dart.throw_(_internal.IterableElementError.noElement());
    ...
    ListQueue[dart.implements_] = () => [Queue$(E)];
    dart.setSignature(ListQueue, {
      ...
      methods: () => ({
        ...
        addAll: [dart.voidR, [core.Iterable$(E)]],
        remove: [core.bool, [core.Object]],
        [_filterWhere]: [dart.voidR, [dart.functionType(core.bool, [E]), core.bool]],
        removeWhere: [dart.voidR, [dart.functionType(core.bool, [E])]],
        retainWhere: [dart.voidR, [dart.functionType(core.bool, [E])]],
        clear: [dart.voidR, []],
        addLast: [dart.voidR, [E]],
        ...
        removeFirst: [E, []],
        removeLast: [E, []],
        [_checkModification]: [dart.voidR, [core.int]],
        [_add]: [dart.voidR, [E]],
  ...
  const _ListQueueIterator$ = dart.generic(function(E) {
    ...
    _ListQueueIterator[dart.implements_] = () => [core.Iterator$(E)];
  ...
  const _SplayTree$ = dart.generic(function(K) {
    ...
    dart.setSignature(_SplayTree, {
      methods: () => ({
        ...
        [_addNewRoot]: [dart.voidR, [_SplayTreeNode$(K), core.int]],
        [_clear]: [dart.voidR, []]
      })
    });
    return _SplayTree;
  ...
  const SplayTreeMap$ = dart.generic(function(K, V) {
    class SplayTreeMap extends _SplayTree$(K) {
      ...
      get(key) {
        if (key == null) dart.throw_(new core.ArgumentError(key));
      ...
      set(key, value) {
        ((() => {
          ...
          this[_addNewRoot](new (_SplayTreeMapNode$(K, dart.dynamicR))(key, value), comp);
        }).bind(this))();
        return value;
      }
      putIfAbsent(key, ifAbsent) {
    ...
    SplayTreeMap[dart.implements_] = () => [core.Map$(K, V)];
    ...
    dart.setSignature(SplayTreeMap, {
      constructors: () => ({
        ...
        fromIterable: [SplayTreeMap$(K, V), [core.Iterable], {key: dart.functionType(K, [dart.dynamicR]), value: dart.functionType(V, [dart.dynamicR]), compare: dart.functionType(core.int, [K, K]), isValidKey: dart.functionType(core.bool, [core.Object])}],
  ...
  const _SplayTreeIterator$ = dart.generic(function(T) {
    class _SplayTreeIterator extends core.Object {
      ...
      moveNext() {
        if (this[_modificationCount] != this[_tree][_modificationCount]) {
          dart.throw_(new core.ConcurrentModificationError(this[_tree]));
        }
    ...
    _SplayTreeIterator[dart.implements_] = () => [core.Iterator$(T)];
    ...
    dart.setSignature(_SplayTreeIterator, {
      constructors: () => ({
        ...
        startAt: [_SplayTreeIterator$(T), [_SplayTree, dart.dynamicR]]
      }),
      methods: () => ({
        [_findLeftMostDescendent]: [dart.voidR, [_SplayTreeNode]],
        [_rebuildWorkList]: [dart.voidR, [_SplayTreeNode]],
        moveNext: [core.bool, []]
      })
    });
  ...
  const _SplayTreeKeyIterable$ = dart.generic(function(K) {
    ...
    _SplayTreeKeyIterable[dart.implements_] = () => [_internal.EfficientLength];
  ...
  const _SplayTreeValueIterable$ = dart.generic(function(K, V) {
    ...
    _SplayTreeValueIterable[dart.implements_] = () => [_internal.EfficientLength];
  ...
  const _SplayTreeNodeIterator$ = dart.generic(function(K) {
    ...
    dart.setSignature(_SplayTreeNodeIterator, {
      constructors: () => ({
        ...
        startAt: [_SplayTreeNodeIterator$(K), [_SplayTree$(K), dart.dynamicR]]
      }),
  ...
  const SplayTreeSet$ = dart.generic(function(E) {
    class SplayTreeSet extends dart.mixin(_SplayTree$(E), IterableMixin$(E), SetMixin$(E)) {
      ...
      get first() {
        if (this[_count] == 0) dart.throw_(_internal.IterableElementError.noElement());
      ...
      get single() {
        if (this[_count] == 0) dart.throw_(_internal.IterableElementError.noElement());
        if (dart.notNull(this[_count]) > 1) dart.throw_(_internal.IterableElementError.tooMany());
  ...
  const _HashMap$ = dart.generic(function(K, V) {
    class _HashMap extends core.Object {
      ...
      containsValue(value) {
        return this[_computeKeys]()[dartx.any](dart.fn((each => dart.equals(this.get(each), value)).bind(this), core.bool, [dart.dynamicR]));
      }
      addAll(other) {
        dart.as(other, core.Map$(K, V));
        other.forEach(dart.fn(((key, value) => {
    ...
    _HashMap[dart.implements_] = () => [HashMap$(K, V)];
    dart.setSignature(_HashMap, {
      ...
      methods: () => ({
        ...
        [_addHashTableEntry]: [dart.voidR, [dart.dynamicR, K, V]],
        [_removeHashTableEntry]: [V, [dart.dynamicR, core.Object]],
        [_computeHashCode]: [core.int, [dart.dynamicR]],
        [_getBucket]: [core.List, [dart.dynamicR, dart.dynamicR]],
        [_findBucketIndex]: [core.int, [dart.dynamicR, dart.dynamicR]]
      }),
      statics: () => ({
        _isStringKey: [core.bool, [dart.dynamicR]],
        _isNumericKey: [core.bool, [dart.dynamicR]],
        _hasTableEntry: [core.bool, [dart.dynamicR, dart.dynamicR]],
        _getTableEntry: [dart.dynamicR, [dart.dynamicR, dart.dynamicR]],
        _setTableEntry: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
        _deleteTableEntry: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
        _newHashTable: [dart.dynamicR, []]
      }),
      ...
      forEach(f) {
        ...
        for (let i = 0, length = keys.length; dart.notNull(i) < dart.notNull(length); i = dart.notNull(i) + 1) {
          ...
          if (keys !== dart.dload(this[_map], _keys)) {
            dart.throw_(new core.ConcurrentModificationError(this[_map]));
          }
        }
      }
    }
    HashMapKeyIterable[dart.implements_] = () => [_internal.EfficientLength];
    dart.setSignature(HashMapKeyIterable, {
      constructors: () => ({HashMapKeyIterable: [HashMapKeyIterable$(E), [dart.dynamicR]]}),
      methods: () => ({forEach: [dart.voidR, [dart.functionType(dart.voidR, [E])]]})
    });
  ...
  const HashMapKeyIterator$ = dart.generic(function(E) {
    ...
    HashMapKeyIterator[dart.implements_] = () => [core.Iterator$(E)];
    dart.setSignature(HashMapKeyIterator, {
      constructors: () => ({HashMapKeyIterator: [HashMapKeyIterator$(E), [dart.dynamicR, core.List]]}),
      methods: () => ({moveNext: [core.bool, []]})
    });
  ...
  const _LinkedHashMap$ = dart.generic(function(K, V) {
    ...
    _LinkedHashMap[dart.implements_] = () => [LinkedHashMap$(K, V), _js_helper.InternalMap];
    dart.setSignature(_LinkedHashMap, {
      ...
      methods: () => ({
        ...
        [_addHashTableEntry]: [dart.voidR, [dart.dynamicR, K, V]],
        [_removeHashTableEntry]: [V, [dart.dynamicR, core.Object]],
        [_modified]: [dart.voidR, []],
        [_newLinkedCell]: [LinkedHashMapCell, [K, V]],
        [_unlinkCell]: [dart.voidR, [LinkedHashMapCell]],
        [_computeHashCode]: [core.int, [dart.dynamicR]],
        [_getBucket]: [core.List, [dart.dynamicR, dart.dynamicR]],
        [_findBucketIndex]: [core.int, [dart.dynamicR, dart.dynamicR]]
      }),
  ...
  dart.setSignature(LinkedHashMapCell, {
    constructors: () => ({LinkedHashMapCell: [LinkedHashMapCell, [dart.dynamicR, dart.dynamicR]]})
  });
  const LinkedHashMapKeyIterable$ = dart.generic(function(E) {
    ...
    LinkedHashMapKeyIterable[dart.implements_] = () => [_internal.EfficientLength];
    dart.setSignature(LinkedHashMapKeyIterable, {
      constructors: () => ({LinkedHashMapKeyIterable: [LinkedHashMapKeyIterable$(E), [dart.dynamicR]]}),
      methods: () => ({forEach: [dart.voidR, [dart.functionType(dart.voidR, [E])]]})
    });
  ...
  const LinkedHashMapKeyIterator$ = dart.generic(function(E) {
    ...
    LinkedHashMapKeyIterator[dart.implements_] = () => [core.Iterator$(E)];
    dart.setSignature(LinkedHashMapKeyIterator, {
      constructors: () => ({LinkedHashMapKeyIterator: [LinkedHashMapKeyIterator$(E), [dart.dynamicR, core.int]]}),
      methods: () => ({moveNext: [core.bool, []]})
    });
  ...
  const _HashSet$ = dart.generic(function(E) {
    ...
    _HashSet[dart.implements_] = () => [HashSet$(E)];
    dart.setSignature(_HashSet, {
      ...
      methods: () => ({
        ...
        [_addHashTableEntry]: [core.bool, [dart.dynamicR, E]],
        [_removeHashTableEntry]: [core.bool, [dart.dynamicR, core.Object]],
        [_computeHashCode]: [core.int, [dart.dynamicR]],
        [_getBucket]: [core.List, [dart.dynamicR, dart.dynamicR]],
        [_findBucketIndex]: [core.int, [dart.dynamicR, dart.dynamicR]]
      }),
      statics: () => ({
        _isStringElement: [core.bool, [dart.dynamicR]],
        _isNumericElement: [core.bool, [dart.dynamicR]],
        _hasTableEntry: [core.bool, [dart.dynamicR, dart.dynamicR]],
        _setTableEntry: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
        _deleteTableEntry: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
        _newHashTable: [dart.dynamicR, []]
  ...
  const HashSetIterator$ = dart.generic(function(E) {
    class HashSetIterator extends core.Object {
      ...
      moveNext() {
        ...
        if (elements !== dart.dload(this[_set], _elements)) {
          dart.throw_(new core.ConcurrentModificationError(this[_set]));
    ...
    HashSetIterator[dart.implements_] = () => [core.Iterator$(E)];
    dart.setSignature(HashSetIterator, {
      constructors: () => ({HashSetIterator: [HashSetIterator$(E), [dart.dynamicR, core.List]]}),
      methods: () => ({moveNext: [core.bool, []]})
    });
  ...
  const _LinkedHashSet$ = dart.generic(function(E) {
    class _LinkedHashSet extends _HashSetBase$(E) {
      ...
      [_unsupported](operation) {
        dart.throw_(`LinkedHashSet: unsupported ${operation}`);
      }
      get iterator() {
      ...
      get first() {
        if (this[_first] == null) dart.throw_(new core.StateError("No elements"));
        return dart.as(this[_first][_element], E);
      }
      get last() {
        if (this[_last] == null) dart.throw_(new core.StateError("No elements"));
    ...
    _LinkedHashSet[dart.implements_] = () => [LinkedHashSet$(E)];
    dart.setSignature(_LinkedHashSet, {
      constructors: () => ({_LinkedHashSet: [_LinkedHashSet$(E), []]}),
      methods: () => ({
        [_newSet]: [core.Set$(E), []],
        [_unsupported]: [dart.voidR, [core.String]],
        contains: [core.bool, [core.Object]],
        [_contains]: [core.bool, [core.Object]],
        lookup: [E, [core.Object]],
        [_lookup]: [E, [core.Object]],
        ...
        [_unlinkCell]: [dart.voidR, [LinkedHashSetCell]],
        [_computeHashCode]: [core.int, [dart.dynamicR]],
        [_getBucket]: [core.List, [dart.dynamicR, dart.dynamicR]],
        [_findBucketIndex]: [core.int, [dart.dynamicR, dart.dynamicR]]
      }),
  ...
  dart.setSignature(LinkedHashSetCell, {
    constructors: () => ({LinkedHashSetCell: [LinkedHashSetCell, [dart.dynamicR]]})
  });
  const LinkedHashSetIterator$ = dart.generic(function(E) {
    ...
    LinkedHashSetIterator[dart.implements_] = () => [core.Iterator$(E)];
    dart.setSignature(LinkedHashSetIterator, {
      constructors: () => ({LinkedHashSetIterator: [LinkedHashSetIterator$(E), [dart.dynamicR, core.int]]}),
      methods: () => ({moveNext: [core.bool, []]})
    });
