dart_library.library('dart/html', null, /* Imports */[
  ...
  class EventTarget extends DartHtmlDomObject {
    ...
    static _() {
      dart.throw_(new core.UnsupportedError("Not supported"));
    }
  ...
  dart.setSignature(EventTarget, {
    ...
    methods: () => ({
      addEventListener: [dart.voidR, [core.String, EventListener], [core.bool]],
      removeEventListener: [dart.voidR, [core.String, EventListener], [core.bool]],
      [_addEventListener]: [dart.voidR, [], [core.String, EventListener, core.bool]],
      [_addEventListener_1]: [dart.voidR, [dart.dynamicR, EventListener, dart.dynamicR]],
      [_addEventListener_2]: [dart.voidR, [dart.dynamicR, EventListener]],
      [_addEventListener_3]: [dart.voidR, [dart.dynamicR]],
      [_addEventListener_4]: [dart.voidR, []],
      dispatchEvent: [core.bool, [Event]],
      [_dispatchEvent_1]: [core.bool, [Event]],
      [_removeEventListener]: [dart.voidR, [], [core.String, EventListener, core.bool]],
      [_removeEventListener_1]: [dart.voidR, [dart.dynamicR, EventListener, dart.dynamicR]],
      [_removeEventListener_2]: [dart.voidR, [dart.dynamicR, EventListener]],
      [_removeEventListener_3]: [dart.voidR, [dart.dynamicR]],
      [_removeEventListener_4]: [dart.voidR, []]
    }),
    statics: () => ({internalCreateEventTarget: [EventTarget, []]}),
    names: ['internalCreateEventTarget']
  });
  EventTarget[dart.metadata] = () => [dart.const_(new _metadata.DomName('EventTarget')), dart.const_(new _js_helper.Native("EventTarget"))];
    ...
    insertAllBefore(newNodes, refChild) {
      if (dart.is(newNodes, _ChildNodeListLazy)) {
        ...
        if (dart.notNull(core.identical(otherList[_this], this))) {
          dart.throw_(new core.ArgumentError(newNodes));
        }
  ...
  dart.setSignature(Node, {
    ...
    methods: () => ({
      ...
      [_clearChildren]: [dart.voidR, []],
      append: [Node, [Node]],
      [_append_1]: [Node, [Node]],
      clone: [Node, [core.bool]],
      [_clone_1]: [Node, [dart.dynamicR]],
  ...
  Node[dart.metadata] = () => [dart.const_(new _metadata.DomName('Node')), dart.const_(new _js_helper.Native("Node"))];
  ...
  class Element extends Node {
    ...
    [_insertAdjacentNode](where, node) {
      switch (where[dartx.toLowerCase]()) {
        ...
        default:
        {
          dart.throw_(new core.ArgumentError(`Invalid position ${where}`));
        }
      }
    }
    matches(selectors) {
    ...
    static _offsetToHelper(current, parent) {
      ...
      if (current == null || dart.notNull(sameAsParent)) {
        ...
        dart.throw_(new core.ArgumentError("Specified element is not a transitive offset " + "parent of this element."));
      }
    ...
    createFragment(html, opts) {
      ...
      if (treeSanitizer == null) {
        ...
        dart.throw_(new core.ArgumentError('validator can only be passed if treeSanitizer is null'));
      }
  ...
  Element[dart.implements_] = () => [ParentNode, ChildNode];
  ...
  dart.setSignature(Element, {
    ...
    methods: () => ({
      ...
      appendText: [dart.voidR, [core.String]],
      appendHtml: [dart.voidR, [core.String], {validator: NodeValidator, treeSanitizer: NodeTreeSanitizer}],
      attached: [dart.voidR, []],
      detached: [dart.voidR, []],
      enteredView: [dart.voidR, []],
      leftView: [dart.voidR, []],
      attributeChanged: [dart.voidR, [core.String, core.String, core.String]],
      scrollIntoView: [dart.voidR, [], [ScrollAlignment]],
      insertAdjacentHtml: [dart.voidR, [core.String, core.String], {validator: NodeValidator, treeSanitizer: NodeTreeSanitizer}],
      [_insertAdjacentHtml]: [dart.voidR, [core.String, core.String]],
      [_insertAdjacentNode]: [dart.voidR, [core.String, Node]],
      ...
      setInnerHtml: [dart.voidR, [core.String], {validator: NodeValidator, treeSanitizer: NodeTreeSanitizer}],
      click: [dart.voidR, []],
      [_click_1]: [dart.voidR, []],
      blur: [dart.voidR, []],
      [_blur_1]: [dart.voidR, []],
      ...
      [_getAttribute_1]: [core.String, [dart.dynamicR]],
      getAttributeNS: [core.String, [core.String, core.String]],
      [_getAttributeNS_1]: [core.String, [dart.dynamicR, dart.dynamicR]],
      ...
      [_getElementsByClassName_1]: [HtmlCollection, [dart.dynamicR]],
      [_getElementsByTagName]: [HtmlCollection, [core.String]],
      [_getElementsByTagName_1]: [HtmlCollection, [dart.dynamicR]],
      [_hasAttribute]: [core.bool, [core.String]],
      [_hasAttribute_1]: [core.bool, [dart.dynamicR]],
      [_hasAttributeNS]: [core.bool, [core.String, core.String]],
      [_hasAttributeNS_1]: [core.bool, [dart.dynamicR, dart.dynamicR]],
      [_removeAttribute]: [dart.voidR, [core.String]],
      [_removeAttribute_1]: [dart.voidR, [dart.dynamicR]],
      [_removeAttributeNS]: [dart.voidR, [core.String, core.String]],
      [_removeAttributeNS_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      requestFullscreen: [dart.voidR, []],
      [_requestFullscreen_1]: [dart.voidR, []],
      requestPointerLock: [dart.voidR, []],
      [_requestPointerLock_1]: [dart.voidR, []],
      [_scrollIntoView]: [dart.voidR, [], [core.bool]],
      [_scrollIntoView_1]: [dart.voidR, [dart.dynamicR]],
      [_scrollIntoView_2]: [dart.voidR, []],
      [_scrollIntoViewIfNeeded]: [dart.voidR, [], [core.bool]],
      [_scrollIntoViewIfNeeded_1]: [dart.voidR, [dart.dynamicR]],
      [_scrollIntoViewIfNeeded_2]: [dart.voidR, []],
      setAttribute: [dart.voidR, [core.String, core.String]],
      [_setAttribute_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      setAttributeNS: [dart.voidR, [core.String, core.String, core.String]],
      [_setAttributeNS_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      querySelector: [Element, [core.String]],
      [_querySelector_1]: [Element, [dart.dynamicR]],
      [_querySelectorAll]: [NodeList, [core.String]],
      [_querySelectorAll_1]: [NodeList, [dart.dynamicR]]
    }),
    statics: () => ({
      ...
      _safeTagName: [core.String, [dart.dynamicR]],
  ...
  Element[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Element')), dart.const_(new _js_helper.Native("Element"))];
  ...
  HtmlElement[dart.metadata] = () => [dart.const_(new _js_helper.Native("HTMLElement"))];
  ...
  AnchorElement[dart.implements_] = () => [UrlUtils];
  ...
  AnchorElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLAnchorElement')), dart.const_(new _js_helper.Native("HTMLAnchorElement"))];
  ...
  BaseElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLBaseElement')), dart.const_(new _js_helper.Native("HTMLBaseElement"))];
  ...
  BodyElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLBodyElement')), dart.const_(new _js_helper.Native("HTMLBodyElement"))];
  ...
  class Event extends DartHtmlDomObject {
    ...
    get matchingTarget() {
      if (this[_selector] == null) {
        dart.throw_(new core.UnsupportedError('Cannot call matchingTarget if this Event did' + ' not arise as a result of event delegation.'));
      }
      ...
      dart.throw_(new core.StateError('No selector matched for populating matchedTarget.'));
    }
    static _() {
      dart.throw_(new core.UnsupportedError("Not supported"));
    }
  ...
  dart.setSignature(Event, {
    ...
    methods: () => ({
      [_initEvent]: [dart.voidR, [core.String, core.bool, core.bool]],
      [_initEvent_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      preventDefault: [dart.voidR, []],
      [_preventDefault_1]: [dart.voidR, []],
      stopImmediatePropagation: [dart.voidR, []],
      [_stopImmediatePropagation_1]: [dart.voidR, []],
      stopPropagation: [dart.voidR, []],
      [_stopPropagation_1]: [dart.voidR, []]
    }),
    statics: () => ({internalCreateEvent: [Event, []]}),
    names: ['internalCreateEvent']
  });
  Event[dart.metadata] = () => [dart.const_(new _metadata.DomName('Event')), dart.const_(new _js_helper.Native("Event,InputEvent,ClipboardEvent"))];
  BodyElement.blurEvent = dart.const_(new (EventStreamProvider$(Event))('blur'));
  BodyElement.errorEvent = dart.const_(new (EventStreamProvider$(Event))('error'));
  BodyElement.focusEvent = dart.const_(new (EventStreamProvider$(Event))('focus'));
  BodyElement.loadEvent = dart.const_(new (EventStreamProvider$(Event))('load'));
  BodyElement.resizeEvent = dart.const_(new (EventStreamProvider$(Event))('resize'));
  BodyElement.scrollEvent = dart.const_(new (EventStreamProvider$(Event))('scroll'));
  ...
  CharacterData[dart.implements_] = () => [ChildNode];
  ...
  dart.setSignature(CharacterData, {
    ...
    methods: () => ({
      appendData: [dart.voidR, [core.String]],
      [_appendData_1]: [dart.voidR, [dart.dynamicR]],
      deleteData: [dart.voidR, [core.int, core.int]],
      [_deleteData_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      insertData: [dart.voidR, [core.int, core.String]],
      [_insertData_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      replaceData: [dart.voidR, [core.int, core.int, core.String]],
      [_replaceData_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      substringData: [core.String, [core.int, core.int]],
      [_substringData_1]: [core.String, [dart.dynamicR, dart.dynamicR]]
    }),
    statics: () => ({internalCreateCharacterData: [CharacterData, []]}),
    names: ['internalCreateCharacterData']
  });
  CharacterData[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('CharacterData')), dart.const_(new _js_helper.Native("CharacterData"))];
  ...
  dart.setSignature(ChildNode, {
    ...
    methods: () => ({remove: [dart.voidR, []]})
  });
  ChildNode[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('ChildNode')), dart.const_(new _metadata.Experimental())];
  ...
  Comment[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Comment')), dart.const_(new _js_helper.Native("Comment"))];
  ...
  dart.setSignature(Console, {
    ...
    methods: () => ({
      assertCondition: [dart.voidR, [core.bool, core.Object]],
      clear: [dart.voidR, [core.Object]],
      count: [dart.voidR, [core.Object]],
      debug: [dart.voidR, [core.Object]],
      dir: [dart.voidR, [core.Object]],
      dirxml: [dart.voidR, [core.Object]],
      error: [dart.voidR, [core.Object]],
      group: [dart.voidR, [core.Object]],
      groupCollapsed: [dart.voidR, [core.Object]],
      groupEnd: [dart.voidR, []],
      info: [dart.voidR, [core.Object]],
      log: [dart.voidR, [core.Object]],
      markTimeline: [dart.voidR, [core.Object]],
      profile: [dart.voidR, [core.String]],
      profileEnd: [dart.voidR, [core.String]],
      table: [dart.voidR, [core.Object]],
      time: [dart.voidR, [core.String]],
      timeEnd: [dart.voidR, [core.String]],
      timeStamp: [dart.voidR, [core.Object]],
      trace: [dart.voidR, [core.Object]],
      warn: [dart.voidR, [core.Object]]
    }),
    statics: () => ({internalCreateConsole: [Console, []]}),
    names: ['internalCreateConsole']
  });
  Console[dart.metadata] = () => [dart.const_(new _metadata.DomName('Console'))];
  ...
  dart.setSignature(ConsoleBase, {
    ...
    methods: () => ({
      timeline: [dart.voidR, [core.String]],
      [_timeline_1]: [dart.voidR, [dart.dynamicR]],
      timelineEnd: [dart.voidR, [core.String]],
      [_timelineEnd_1]: [dart.voidR, [dart.dynamicR]]
    }),
    statics: () => ({internalCreateConsoleBase: [ConsoleBase, []]}),
    names: ['internalCreateConsoleBase']
  });
  ConsoleBase[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('ConsoleBase')), dart.const_(new _metadata.Experimental()), dart.const_(new _js_helper.Native("ConsoleBase"))];
  class CssStyleDeclarationBase extends core.Object {
    getPropertyValue(propertyName) {
      return dart.throw_(new core.StateError('getProperty not overridden in dart:html'));
    }
    setProperty(propertyName, value, priority) {
      if (priority === void 0) priority = null;
      return dart.throw_(new core.StateError('setProperty not overridden in dart:html'));
    }
    get alignContent() {
  ...
  dart.setSignature(CssStyleDeclarationBase, {
    methods: () => ({
      ...
      setProperty: [dart.voidR, [core.String, core.String], [core.String]]
    })
  });
  ...
  dart.setSignature(CssStyleDeclaration, {
    ...
    methods: () => ({
      ...
      [_setPropertyHelper]: [dart.voidR, [core.String, core.String], [core.String]],
      [__getter__]: [core.Object, [core.String]],
      [__getter___1]: [core.Object, [dart.dynamicR]],
      [__setter__]: [dart.voidR, [core.String, core.String]],
      [__setter___1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      getPropertyPriority: [core.String, [core.String]],
      [_getPropertyPriority_1]: [core.String, [dart.dynamicR]],
      [_getPropertyValue]: [core.String, [core.String]],
      [_getPropertyValue_1]: [core.String, [dart.dynamicR]],
      item: [core.String, [core.int]],
      [_item_1]: [core.String, [dart.dynamicR]],
      removeProperty: [core.String, [core.String]],
      [_removeProperty_1]: [core.String, [dart.dynamicR]]
    }),
    statics: () => ({
      _readCache: [core.String, [core.String]],
      _writeCache: [dart.voidR, [core.String, dart.dynamicR]],
  ...
  CssStyleDeclaration[dart.metadata] = () => [dart.const_(new _metadata.DomName('CSSStyleDeclaration')), dart.const_(new _js_helper.Native("CSSStyleDeclaration,MSStyleCSSProperties,CSS2Properties"))];
  ...
  class _CssStyleDeclarationSet extends dart.mixin(core.Object, CssStyleDeclarationBase) {
    ...
    setProperty(propertyName, value, priority) {
      if (priority === void 0) priority = null;
      this[_elementCssStyleDeclarationSetIterable][dartx.forEach](dart.fn(e => e.setProperty(propertyName, value, priority), dart.voidR, [CssStyleDeclaration]));
    }
  }
  ...
  DivElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLDivElement')), dart.const_(new _js_helper.Native("HTMLDivElement"))];
  ...
  class Document extends Node {
    ...
    [_createElement](localName_OR_tagName, typeExtension) {
      ...
      dart.throw_(new core.ArgumentError("Incorrect number or type of arguments"));
    }
  ...
  dart.setSignature(Document, {
    ...
    methods: () => ({
      ...
      [_caretRangeFromPoint_1]: [Range, [dart.dynamicR, dart.dynamicR]],
      createDocumentFragment: [DocumentFragment, []],
      [_createDocumentFragment_1]: [DocumentFragment, []],
      [_createElement]: [Element, [core.String], [core.String]],
      [_createElement_1]: [Element, [dart.dynamicR]],
      [_createElement_2]: [Element, [dart.dynamicR, dart.dynamicR]],
      [_createElementNS]: [Element, [core.String, core.String], [core.String]],
      [_createElementNS_1]: [Element, [dart.dynamicR, dart.dynamicR]],
      [_createElementNS_2]: [Element, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_createEvent]: [Event, [core.String]],
      [_createEvent_1]: [Event, [dart.dynamicR]],
      createRange: [Range, []],
      [_createRange_1]: [Range, []],
      [_createTextNode]: [Text, [core.String]],
      [_createTextNode_1]: [Text, [dart.dynamicR]],
      [_elementFromPoint]: [Element, [core.int, core.int]],
      [_elementFromPoint_1]: [Element, [dart.dynamicR, dart.dynamicR]],
      execCommand: [core.bool, [core.String, core.bool, core.String]],
      [_execCommand_1]: [core.bool, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      exitFullscreen: [dart.voidR, []],
      [_exitFullscreen_1]: [dart.voidR, []],
      exitPointerLock: [dart.voidR, []],
      [_exitPointerLock_1]: [dart.voidR, []],
      [_getCssCanvasContext]: [core.Object, [core.String, core.String, core.int, core.int]],
      [_getCssCanvasContext_1]: [core.Object, [dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      getElementById: [Element, [core.String]],
      [_getElementById_1]: [Element, [dart.dynamicR]],
      getElementsByClassName: [HtmlCollection, [core.String]],
      [_getElementsByClassName_1]: [HtmlCollection, [dart.dynamicR]],
      getElementsByName: [NodeList, [core.String]],
      [_getElementsByName_1]: [NodeList, [dart.dynamicR]],
      getElementsByTagName: [HtmlCollection, [core.String]],
      [_getElementsByTagName_1]: [HtmlCollection, [dart.dynamicR]],
      importNode: [Node, [Node], [core.bool]],
      [_importNode_1]: [Node, [Node, dart.dynamicR]],
      [_importNode_2]: [Node, [Node]],
      queryCommandEnabled: [core.bool, [core.String]],
      [_queryCommandEnabled_1]: [core.bool, [dart.dynamicR]],
      queryCommandIndeterm: [core.bool, [core.String]],
      [_queryCommandIndeterm_1]: [core.bool, [dart.dynamicR]],
      queryCommandState: [core.bool, [core.String]],
      [_queryCommandState_1]: [core.bool, [dart.dynamicR]],
      queryCommandSupported: [core.bool, [core.String]],
      [_queryCommandSupported_1]: [core.bool, [dart.dynamicR]],
      queryCommandValue: [core.String, [core.String]],
      [_queryCommandValue_1]: [core.String, [dart.dynamicR]],
      transformDocumentToTreeView: [dart.voidR, [core.String]],
      [_transformDocumentToTreeView_1]: [dart.voidR, [dart.dynamicR]],
      [_webkitExitFullscreen]: [dart.voidR, []],
      [_webkitExitFullscreen_1]: [dart.voidR, []],
      querySelector: [Element, [core.String]],
      [_querySelector_1]: [Element, [dart.dynamicR]],
      [_querySelectorAll]: [NodeList, [core.String]],
      [_querySelectorAll_1]: [NodeList, [dart.dynamicR]],
  ...
  Document[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Document')), dart.const_(new _js_helper.Native("Document"))];
  Document.pointerLockChangeEvent = dart.const_(new (EventStreamProvider$(Event))('pointerlockchange'));
  Document.pointerLockErrorEvent = dart.const_(new (EventStreamProvider$(Event))('pointerlockerror'));
  Document.readyStateChangeEvent = dart.const_(new (EventStreamProvider$(Event))('readystatechange'));
  Document.selectionChangeEvent = dart.const_(new (EventStreamProvider$(Event))('selectionchange'));
  ...
  class DocumentFragment extends Node {
    ...
    static svg(svgContent, opts) {
      let validator = opts && 'validator' in opts ? opts.validator : null;
      let treeSanitizer = opts && 'treeSanitizer' in opts ? opts.treeSanitizer : null;
      dart.throw_('SVG not supported in DDC');
    }
    get [_children]() {
      return dart.throw_(new core.UnimplementedError('Use _docChildren instead'));
    }
    get children() {
  ...
  DocumentFragment[dart.implements_] = () => [ParentNode];
  ...
  dart.setSignature(DocumentFragment, {
    ...
    methods: () => ({
      ...
      setInnerHtml: [dart.voidR, [core.String], {validator: NodeValidator, treeSanitizer: NodeTreeSanitizer}],
      appendText: [dart.voidR, [core.String]],
      appendHtml: [dart.voidR, [core.String], {validator: NodeValidator, NodeTreeSanitizer: dart.dynamicR, treeSanitizer: dart.dynamicR}],
      query: [Element, [core.String]],
      queryAll: [ElementList$(Element), [core.String]],
      getElementById: [Element, [core.String]],
      [_getElementById_1]: [Element, [dart.dynamicR]],
  ...
  DocumentFragment[dart.metadata] = () => [dart.const_(new _metadata.DomName('DocumentFragment')), dart.const_(new _js_helper.Native("DocumentFragment"))];
  ...
  dart.setSignature(DomImplementation, {
    ...
    methods: () => ({
      ...
      [_createDocument_1]: [Document, [dart.dynamicR, dart.dynamicR, Node]],
      createDocumentType: [Node, [core.String, core.String, core.String]],
      [_createDocumentType_1]: [Node, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      createHtmlDocument: [HtmlDocument, [core.String]],
      [_createHtmlDocument_1]: [HtmlDocument, [dart.dynamicR]],
      hasFeature: [core.bool, [core.String, core.String]],
      [_hasFeature_1]: [core.bool, [dart.dynamicR, dart.dynamicR]]
    }),
    statics: () => ({internalCreateDomImplementation: [DomImplementation, []]}),
    names: ['internalCreateDomImplementation']
  });
  DomImplementation[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('DOMImplementation')), dart.const_(new _js_helper.Native("DOMImplementation"))];
  ...
  dart.setSignature(DomTokenList, {
    ...
    methods: () => ({
      add: [dart.voidR, [core.String]],
      [_add_1]: [dart.voidR, [dart.dynamicR]],
      contains: [core.bool, [core.String]],
      [_contains_1]: [core.bool, [dart.dynamicR]],
      item: [core.String, [core.int]],
      [_item_1]: [core.String, [dart.dynamicR]],
      remove: [dart.voidR, [core.String]],
      [_remove_1]: [dart.voidR, [dart.dynamicR]],
      toggle: [core.bool, [core.String], [core.bool]],
      [_toggle_1]: [core.bool, [dart.dynamicR, dart.dynamicR]],
      [_toggle_2]: [core.bool, [dart.dynamicR]]
    }),
    statics: () => ({internalCreateDomTokenList: [DomTokenList, []]}),
    names: ['internalCreateDomTokenList']
  });
  DomTokenList[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('DOMTokenList')), dart.const_(new _js_helper.Native("DOMTokenList"))];
  ...
  class _ChildrenElementList extends collection.ListBase$(Element) {
    ...
    set length(newLength) {
      dart.throw_(new core.UnsupportedError('Cannot resize element lists'));
    }
    add(value) {
    ...
    sort(compare) {
      ...
      dart.throw_(new core.UnsupportedError('Cannot sort element lists'));
    }
    shuffle(random) {
      if (random === void 0) random = null;
      dart.throw_(new core.UnsupportedError('Cannot shuffle element lists'));
    }
    removeWhere(test) {
    ...
    setRange(start, end, iterable, skipCount) {
      ...
      dart.throw_(new core.UnimplementedError());
    }
    ...
    insert(index, element) {
      if (dart.notNull(index) < 0 || dart.notNull(index) > dart.notNull(this.length)) {
        dart.throw_(new core.RangeError.range(index, 0, this.length));
      }
    ...
    get first() {
      ...
      if (result == null) dart.throw_(new core.StateError("No elements"));
      return result;
    }
    get last() {
    ...
    get single() {
      if (dart.notNull(this.length) > 1) dart.throw_(new core.StateError("More than one element"));
      return this.first;
    }
    get rawList() {
  ...
  _ChildrenElementList[dart.implements_] = () => [html_common.NodeListWrapper];
  ...
  dart.setSignature(_ChildrenElementList, {
    ...
    methods: () => ({
      ...
      set: [dart.voidR, [core.int, Element]],
      add: [Element, [Element]],
      addAll: [dart.voidR, [core.Iterable$(Element)]],
      sort: [dart.voidR, [], [dart.functionType(core.int, [Element, Element])]],
      removeWhere: [dart.voidR, [dart.functionType(core.bool, [Element])]],
      retainWhere: [dart.voidR, [dart.functionType(core.bool, [Element])]],
      [_filter]: [dart.voidR, [dart.functionType(core.bool, [dart.dynamicR]), core.bool]],
      setRange: [dart.voidR, [core.int, core.int, core.Iterable$(Element)], [core.int]],
      replaceRange: [dart.voidR, [core.int, core.int, core.Iterable$(Element)]],
      fillRange: [dart.voidR, [core.int, core.int], [Element]],
      insert: [dart.voidR, [core.int, Element]],
      setAll: [dart.voidR, [core.int, core.Iterable$(Element)]],
  ...
  class _FrozenElementList extends collection.ListBase$(Element) {
    ...
    set(index, value) {
      dart.throw_(new core.UnsupportedError('Cannot modify list'));
      return value;
    }
    set length(newLength) {
      dart.throw_(new core.UnsupportedError('Cannot modify list'));
    ...
    sort(compare) {
      if (compare === void 0) compare = null;
      dart.throw_(new core.UnsupportedError('Cannot sort list'));
    }
    shuffle(random) {
      if (random === void 0) random = null;
      dart.throw_(new core.UnsupportedError('Cannot shuffle list'));
    }
    get first() {
  ...
  _FrozenElementList[dart.implements_] = () => [ElementList$(Element), html_common.NodeListWrapper];
  ...
  dart.setSignature(_FrozenElementList, {
    ...
    methods: () => ({
      get: [Element, [core.int]],
      set: [dart.voidR, [core.int, Element]],
      sort: [dart.voidR, [], [core.Comparator$(Element)]]
    })
  });
  ...
  Element._tagsForWhichCreateContextualFragmentIsNotSupported = dart.const_(['HEAD', 'AREA', 'BASE', 'BASEFONT', 'BR', 'COL', 'COLGROUP', 'EMBED', 'FRAME', 'FRAMESET', 'HR', 'IMAGE', 'IMG', 'INPUT', 'ISINDEX', 'LINK', 'META', 'PARAM', 'SOURCE', 'STYLE', 'TITLE', 'WBR']);
  Element.beforeCopyEvent = dart.const_(new (EventStreamProvider$(Event))('beforecopy'));
  Element.beforeCutEvent = dart.const_(new (EventStreamProvider$(Event))('beforecut'));
  Element.beforePasteEvent = dart.const_(new (EventStreamProvider$(Event))('beforepaste'));
  Element.copyEvent = dart.const_(new (EventStreamProvider$(Event))('copy'));
  Element.cutEvent = dart.const_(new (EventStreamProvider$(Event))('cut'));
  Element.pasteEvent = dart.const_(new (EventStreamProvider$(Event))('paste'));
  Element.searchEvent = dart.const_(new (EventStreamProvider$(Event))('search'));
  Element.selectStartEvent = dart.const_(new (EventStreamProvider$(Event))('selectstart'));
  Element.fullscreenChangeEvent = dart.const_(new (EventStreamProvider$(Event))('webkitfullscreenchange'));
  Element.fullscreenErrorEvent = dart.const_(new (EventStreamProvider$(Event))('webkitfullscreenerror'));
  ...
  dart.setSignature(ScrollAlignment, {
    constructors: () => ({_internal: [ScrollAlignment, [dart.dynamicR]]})
  });
  ScrollAlignment.TOP = dart.const_(new ScrollAlignment._internal('TOP'));
  ScrollAlignment.CENTER = dart.const_(new ScrollAlignment._internal('CENTER'));
  ScrollAlignment.BOTTOM = dart.const_(new ScrollAlignment._internal('BOTTOM'));
  Event.AT_TARGET = 2;
  ...
  HeadElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLHeadElement')), dart.const_(new _js_helper.Native("HTMLHeadElement"))];
  ...
  History[dart.implements_] = () => [HistoryBase];
  ...
  dart.setSignature(History, {
    ...
    methods: () => ({
      ...
      [_back_1]: [dart.voidR, []],
      forward: [dart.voidR, []],
      [_forward_1]: [dart.voidR, []],
      go: [dart.voidR, [core.int]],
      [_go_1]: [dart.voidR, [dart.dynamicR]],
      pushState: [dart.voidR, [dart.dynamicR, core.String], [core.String]],
      [_pushState_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_pushState_2]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      replaceState: [dart.voidR, [dart.dynamicR, core.String], [core.String]],
      [_replaceState_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_replaceState_2]: [dart.voidR, [dart.dynamicR, dart.dynamicR]]
    }),
    statics: () => ({internalCreateHistory: [History, []]}),
    names: ['internalCreateHistory']
  });
  History[dart.metadata] = () => [dart.const_(new _metadata.DomName('History')), dart.const_(new _js_helper.Native("History"))];
  const ImmutableListMixin$ = dart.generic(function(E) {
    class ImmutableListMixin extends core.Object {
      ...
      add(value) {
        dart.as(value, E);
        dart.throw_(new core.UnsupportedError("Cannot add to immutable List."));
      }
      addAll(iterable) {
      ...
      sort(compare) {
        ...
        dart.throw_(new core.UnsupportedError("Cannot sort immutable List."));
      }
      shuffle(random) {
        if (random === void 0) random = null;
        dart.throw_(new core.UnsupportedError("Cannot shuffle immutable List."));
      }
      insert(index, element) {
        dart.as(element, E);
        dart.throw_(new core.UnsupportedError("Cannot add to immutable List."));
      ...
      setAll(index, iterable) {
        dart.as(iterable, core.Iterable$(E));
        dart.throw_(new core.UnsupportedError("Cannot modify an immutable List."));
      }
      removeAt(pos) {
        dart.throw_(new core.UnsupportedError("Cannot remove from immutable List."));
      }
      removeLast() {
        dart.throw_(new core.UnsupportedError("Cannot remove from immutable List."));
      }
      ...
      setRange(start, end, iterable, skipCount) {
        dart.as(iterable, core.Iterable$(E));
        if (skipCount === void 0) skipCount = 0;
        dart.throw_(new core.UnsupportedError("Cannot setRange on immutable List."));
      }
      removeRange(start, end) {
        dart.throw_(new core.UnsupportedError("Cannot removeRange on immutable List."));
      }
      replaceRange(start, end, iterable) {
        dart.as(iterable, core.Iterable$(E));
        dart.throw_(new core.UnsupportedError("Cannot modify an immutable List."));
    ...
    ImmutableListMixin[dart.implements_] = () => [core.List$(E)];
  ...
  class HtmlCollection extends dart.mixin(DartHtmlDomObject, collection.ListMixin$(Node), ImmutableListMixin$(Node)) {
    ...
    get(index) {
      if (index >>> 0 !== index || index >= this.length) dart.throw_(core.RangeError.index(index, this));
      return dart.as(wrap_jso(this.raw[index]), Node);
    }
    set(index, value) {
      dart.throw_(new core.UnsupportedError("Cannot assign element of immutable List."));
      return value;
    }
    set length(value) {
      dart.throw_(new core.UnsupportedError("Cannot resize immutable List."));
    }
    get first() {
      if (dart.notNull(this.length) > 0) {
        return dart.as(wrap_jso(this.raw[0]), Node);
      }
      dart.throw_(new core.StateError("No elements"));
    }
    get last() {
      let len = this.length;
    ...
    get single() {
      ...
      if (len == 0) dart.throw_(new core.StateError("No elements"));
      dart.throw_(new core.StateError("More than one element"));
    }
    elementAt(index) {
  ...
  HtmlCollection[dart.implements_] = () => [_js_helper.JavaScriptIndexingBehavior, core.List$(Node)];
  ...
  dart.setSignature(HtmlCollection, {
    ...
    methods: () => ({
      get: [Node, [core.int]],
      set: [dart.voidR, [core.int, Node]],
      elementAt: [Node, [core.int]],
      item: [Element, [core.int]],
      [_item_1]: [Element, [dart.dynamicR]],
      namedItem: [Element, [core.String]],
      [_namedItem_1]: [Element, [dart.dynamicR]]
    }),
  ...
  HtmlCollection[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLCollection')), dart.const_(new _js_helper.Native("HTMLCollection"))];
  class HtmlDocument extends Document {
    ...
    createElementUpgrader(type, opts) {
      let extendsTag = opts && 'extendsTag' in opts ? opts.extendsTag : null;
      dart.throw_('ElementUpgrader not yet supported on DDC');
    }
  }
  ...
  dart.setSignature(HtmlDocument, {
    ...
    methods: () => ({
      ...
      registerElement: [dart.voidR, [core.String, core.Type], {extendsTag: core.String}],
      register: [dart.voidR, [core.String, core.Type], {extendsTag: core.String}],
  ...
  HtmlDocument[dart.metadata] = () => [dart.const_(new _metadata.DomName('HTMLDocument')), dart.const_(new _js_helper.Native("HTMLDocument"))];
  ...
  const _CustomEventStreamProvider$ = dart.generic(function(T) {
    class _CustomEventStreamProvider extends core.Object {
      ...
      get [_eventType]() {
        return dart.throw_(new core.UnsupportedError('Access type through getEventType method.'));
      }
    }
    _CustomEventStreamProvider[dart.implements_] = () => [EventStreamProvider$(T)];
    dart.setSignature(_CustomEventStreamProvider, {
      constructors: () => ({_CustomEventStreamProvider: [_CustomEventStreamProvider$(T), [dart.dynamicR]]}),
      methods: () => ({
        forTarget: [async.Stream$(T), [EventTarget], {useCapture: core.bool}],
        forElement: [ElementStream$(T), [Element], {useCapture: core.bool}],
        [_forElementList]: [ElementStream$(T), [ElementList], {useCapture: core.bool}],
  ...
  HtmlDocument.visibilityChangeEvent = dart.const_(new (_CustomEventStreamProvider$(Event))(HtmlDocument._determineVisibilityChangeEventType));
  ...
  HtmlHtmlElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLHtmlElement')), dart.const_(new _js_helper.Native("HTMLHtmlElement"))];
  ...
  HttpRequestEventTarget[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('XMLHttpRequestEventTarget')), dart.const_(new _metadata.Experimental()), dart.const_(new _js_helper.Native("XMLHttpRequestEventTarget"))];
  ...
  class HttpRequest extends HttpRequestEventTarget {
    ...
    static postFormData(url, data, opts) {
      ...
      }, dart.voidR, [core.String, core.String]));
    ...
    static requestCrossOrigin(url, opts) {
      ...
      if (dart.notNull(HttpRequest.supportsCrossOrigin)) {
        ...
        }, dart.dynamicR, [HttpRequest])), async.Future$(core.String));
      }
    }
    get responseHeaders() {
  ...
  dart.setSignature(HttpRequest, {
    ...
    methods: () => ({
      open: [dart.voidR, [core.String, core.String], {async: core.bool, user: core.String, password: core.String}],
      abort: [dart.voidR, []],
      [_abort_1]: [dart.voidR, []],
      getAllResponseHeaders: [core.String, []],
      [_getAllResponseHeaders_1]: [core.String, []],
      getResponseHeader: [core.String, [core.String]],
      [_getResponseHeader_1]: [core.String, [dart.dynamicR]],
      overrideMimeType: [dart.voidR, [core.String]],
      [_overrideMimeType_1]: [dart.voidR, [dart.dynamicR]],
      send: [dart.voidR, [], [dart.dynamicR]],
      [_send_1]: [dart.voidR, []],
      [_send_2]: [dart.voidR, [Document]],
      [_send_3]: [dart.voidR, [core.String]],
      setRequestHeader: [dart.voidR, [core.String, core.String]],
      [_setRequestHeader_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]]
    }),
    statics: () => ({
      getString: [async.Future$(core.String), [core.String], {withCredentials: core.bool, onProgress: dart.functionType(dart.voidR, [ProgressEvent])}],
      postFormData: [async.Future$(HttpRequest), [core.String, core.Map$(core.String, core.String)], {withCredentials: core.bool, responseType: core.String, requestHeaders: core.Map$(core.String, core.String), onProgress: dart.functionType(dart.voidR, [ProgressEvent])}],
      request: [async.Future$(HttpRequest), [core.String], {method: core.String, withCredentials: core.bool, responseType: core.String, mimeType: core.String, requestHeaders: core.Map$(core.String, core.String), sendData: dart.dynamicR, onProgress: dart.functionType(dart.voidR, [ProgressEvent])}],
  ...
  HttpRequest[dart.metadata] = () => [dart.const_(new _metadata.DomName('XMLHttpRequest')), dart.const_(new _js_helper.Native("XMLHttpRequest"))];
  ...
  ProgressEvent[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('ProgressEvent')), dart.const_(new _js_helper.Native("ProgressEvent"))];
  HttpRequest.readyStateChangeEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('readystatechange'));
  HttpRequest.DONE = 4;
  HttpRequest.HEADERS_RECEIVED = 2;
  HttpRequest.LOADING = 3;
  HttpRequest.OPENED = 1;
  HttpRequest.UNSENT = 0;
  HttpRequestEventTarget.abortEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('abort'));
  HttpRequestEventTarget.errorEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('error'));
  HttpRequestEventTarget.loadEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('load'));
  HttpRequestEventTarget.loadEndEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('loadend'));
  HttpRequestEventTarget.loadStartEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('loadstart'));
  HttpRequestEventTarget.progressEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('progress'));
  HttpRequestEventTarget.timeoutEvent = dart.const_(new (EventStreamProvider$(ProgressEvent))('timeout'));
  ...
  dart.setSignature(InputElement, {
    ...
    methods: () => ({
      ...
      select: [dart.voidR, []],
      [_select_1]: [dart.voidR, []],
      setCustomValidity: [dart.voidR, [core.String]],
      [_setCustomValidity_1]: [dart.voidR, [dart.dynamicR]],
      setRangeText: [dart.voidR, [core.String], {start: core.int, end: core.int, selectionMode: core.String}],
      [_setRangeText_1]: [dart.voidR, [dart.dynamicR]],
      [_setRangeText_2]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_setRangeText_3]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      setSelectionRange: [dart.voidR, [core.int, core.int], [core.String]],
      [_setSelectionRange_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_setSelectionRange_2]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      stepDown: [dart.voidR, [], [core.int]],
      [_stepDown_1]: [dart.voidR, [dart.dynamicR]],
      [_stepDown_2]: [dart.voidR, []],
      stepUp: [dart.voidR, [], [core.int]],
      [_stepUp_1]: [dart.voidR, [dart.dynamicR]],
      [_stepUp_2]: [dart.voidR, []]
    }),
    statics: () => ({internalCreateInputElement: [InputElement, []]}),
    names: ['internalCreateInputElement']
  });
  InputElement[dart.metadata] = () => [dart.const_(new _metadata.DomName('HTMLInputElement')), dart.const_(new _js_helper.Native("HTMLInputElement"))];
  ...
  InputElementBase[dart.implements_] = () => [Element];
  class HiddenInputElement extends core.Object {
    static new() {
      return InputElement.new({type: 'hidden'});
    }
  }
  HiddenInputElement[dart.implements_] = () => [InputElementBase];
  ...
  TextInputElementBase[dart.implements_] = () => [InputElementBase];
  ...
  SearchInputElement[dart.implements_] = () => [TextInputElementBase];
  dart.setSignature(SearchInputElement, {
    constructors: () => ({new: [SearchInputElement, []]})
  });
  SearchInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.SAFARI))];
  class TextInputElement extends core.Object {
    static new() {
      return InputElement.new({type: 'text'});
    }
  }
  TextInputElement[dart.implements_] = () => [TextInputElementBase];
  ...
  UrlInputElement[dart.implements_] = () => [TextInputElementBase];
  dart.setSignature(UrlInputElement, {
    constructors: () => ({new: [UrlInputElement, []]})
  });
  UrlInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.SAFARI))];
  ...
  TelephoneInputElement[dart.implements_] = () => [TextInputElementBase];
  dart.setSignature(TelephoneInputElement, {
    constructors: () => ({new: [TelephoneInputElement, []]})
  });
  TelephoneInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.SAFARI))];
  ...
  EmailInputElement[dart.implements_] = () => [TextInputElementBase];
  dart.setSignature(EmailInputElement, {
    constructors: () => ({new: [EmailInputElement, []]})
  });
  EmailInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.FIREFOX)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.SAFARI))];
  class PasswordInputElement extends core.Object {
    static new() {
      return InputElement.new({type: 'password'});
    }
  }
  PasswordInputElement[dart.implements_] = () => [TextInputElementBase];
  ...
  RangeInputElementBase[dart.implements_] = () => [InputElementBase];
  ...
  DateInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(DateInputElement, {
    constructors: () => ({new: [DateInputElement, []]})
  });
  DateInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME, '25')), dart.const_(new _metadata.Experimental())];
  ...
  MonthInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(MonthInputElement, {
    constructors: () => ({new: [MonthInputElement, []]})
  });
  MonthInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME, '25')), dart.const_(new _metadata.Experimental())];
  ...
  WeekInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(WeekInputElement, {
    constructors: () => ({new: [WeekInputElement, []]})
  });
  WeekInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME, '25')), dart.const_(new _metadata.Experimental())];
  ...
  TimeInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(TimeInputElement, {
    constructors: () => ({new: [TimeInputElement, []]})
  });
  TimeInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.Experimental())];
  ...
  LocalDateTimeInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(LocalDateTimeInputElement, {
    constructors: () => ({new: [LocalDateTimeInputElement, []]})
  });
  LocalDateTimeInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME, '25')), dart.const_(new _metadata.Experimental())];
  ...
  NumberInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(NumberInputElement, {
    constructors: () => ({new: [NumberInputElement, []]})
  });
  NumberInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.SAFARI)), dart.const_(new _metadata.Experimental())];
  ...
  RangeInputElement[dart.implements_] = () => [RangeInputElementBase];
  dart.setSignature(RangeInputElement, {
    constructors: () => ({new: [RangeInputElement, []]})
  });
  RangeInputElement[dart.metadata] = () => [dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.IE, '10')), dart.const_(new _metadata.Experimental())];
  class CheckboxInputElement extends core.Object {
    static new() {
      return InputElement.new({type: 'checkbox'});
    }
  }
  CheckboxInputElement[dart.implements_] = () => [InputElementBase];
  ...
  RadioButtonInputElement[dart.implements_] = () => [InputElementBase];
  ...
  FileUploadInputElement[dart.implements_] = () => [InputElementBase];
  ...
  SubmitButtonInputElement[dart.implements_] = () => [InputElementBase];
  ...
  ImageButtonInputElement[dart.implements_] = () => [InputElementBase];
  ...
  ResetButtonInputElement[dart.implements_] = () => [InputElementBase];
  ...
  ButtonInputElement[dart.implements_] = () => [InputElementBase];
  ...
  dart.setSignature(UIEvent, {
    ...
    methods: () => ({
      [_initUIEvent]: [dart.voidR, [core.String, core.bool, core.bool, Window, core.int]],
      [_initUIEvent_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR, Window, dart.dynamicR]]
    }),
    statics: () => ({internalCreateUIEvent: [UIEvent, []]}),
    names: ['internalCreateUIEvent']
  });
  UIEvent[dart.metadata] = () => [dart.const_(new _metadata.DomName('UIEvent')), dart.const_(new _js_helper.Native("UIEvent"))];
  ...
  dart.setSignature(KeyboardEvent, {
    ...
    methods: () => ({
      [_initKeyboardEvent]: [dart.voidR, [core.String, core.bool, core.bool, Window, core.String, core.int, core.bool, core.bool, core.bool, core.bool]],
      getModifierState: [core.bool, [core.String]],
      [_getModifierState_1]: [core.bool, [dart.dynamicR]]
    }),
    statics: () => ({internalCreateKeyboardEvent: [KeyboardEvent, []]}),
    names: ['internalCreateKeyboardEvent']
  });
  KeyboardEvent[dart.metadata] = () => [dart.const_(new _metadata.DomName('KeyboardEvent')), dart.const_(new _js_helper.Native("KeyboardEvent"))];
  ...
  Location[dart.implements_] = () => [LocationBase];
  ...
  dart.setSignature(Location, {
    ...
    methods: () => ({
      assign: [dart.voidR, [], [core.String]],
      [_assign_1]: [dart.voidR, [dart.dynamicR]],
      [_assign_2]: [dart.voidR, []],
      reload: [dart.voidR, []],
      [_reload_1]: [dart.voidR, []],
      replace: [dart.voidR, [core.String]],
      [_replace_1]: [dart.voidR, [dart.dynamicR]]
    }),
    statics: () => ({internalCreateLocation: [Location, []]}),
    names: ['internalCreateLocation']
  });
  Location[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Location')), dart.const_(new _js_helper.Native("Location"))];
  ...
  dart.setSignature(MouseEvent, {
    ...
    methods: () => ({
      [_initMouseEvent]: [dart.voidR, [core.String, core.bool, core.bool, Window, core.int, core.int, core.int, core.int, core.int, core.bool, core.bool, core.bool, core.bool, core.int, EventTarget]],
      [_initMouseEvent_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR, Window, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
    statics: () => ({internalCreateMouseEvent: [MouseEvent, []]}),
    names: ['internalCreateMouseEvent']
  });
  MouseEvent[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('MouseEvent')), dart.const_(new _js_helper.Native("MouseEvent,DragEvent,PointerEvent,MSPointerEvent"))];
  ...
  Navigator[dart.implements_] = () => [NavigatorCpu];
  ...
  dart.setSignature(Navigator, {
    ...
    methods: () => ({
      ...
      getStorageUpdates: [dart.voidR, []],
      [_getStorageUpdates_1]: [dart.voidR, []],
      registerProtocolHandler: [dart.voidR, [core.String, core.String, core.String]],
      [_registerProtocolHandler_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      sendBeacon: [core.bool, [core.String, core.String]],
      [_sendBeacon_1]: [core.bool, [dart.dynamicR, dart.dynamicR]]
    }),
    statics: () => ({internalCreateNavigator: [Navigator, []]}),
    names: ['internalCreateNavigator']
  });
  Navigator[dart.metadata] = () => [dart.const_(new _metadata.DomName('Navigator')), dart.const_(new _js_helper.Native("Navigator"))];
  ...
  NavigatorCpu[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('NavigatorCPU')), dart.const_(new _metadata.Experimental())];
  class _ChildNodeListLazy extends collection.ListBase$(Node) {
    ...
    get single() {
      let l = this.length;
      if (l == 0) dart.throw_(new core.StateError("No elements"));
      if (dart.notNull(l) > 1) dart.throw_(new core.StateError("More than one element"));
    ...
    setAll(index, iterable) {
      dart.throw_(new core.UnsupportedError("Cannot setAll on Node list"));
    }
    removeLast() {
      let result = this.last;
      if (result != null) {
    ...
    sort(compare) {
      if (compare === void 0) compare = null;
      dart.throw_(new core.UnsupportedError("Cannot sort Node list"));
    }
    shuffle(random) {
      if (random === void 0) random = null;
      dart.throw_(new core.UnsupportedError("Cannot shuffle Node list"));
    }
    setRange(start, end, iterable, skipCount) {
      if (skipCount === void 0) skipCount = 0;
      dart.throw_(new core.UnsupportedError("Cannot setRange on Node list"));
    }
    fillRange(start, end, fill) {
      if (fill === void 0) fill = null;
      dart.throw_(new core.UnsupportedError("Cannot fillRange on Node list"));
    }
    get length() {
      return this[_this].childNodes[dartx.length];
    }
    set length(value) {
      dart.throw_(new core.UnsupportedError("Cannot set length on immutable List."));
    }
    get(index) {
  ...
  _ChildNodeListLazy[dart.implements_] = () => [html_common.NodeListWrapper];
  dart.setSignature(_ChildNodeListLazy, {
    constructors: () => ({_ChildNodeListLazy: [_ChildNodeListLazy, [Node]]}),
    methods: () => ({
      add: [dart.voidR, [Node]],
      addAll: [dart.voidR, [core.Iterable$(Node)]],
      insert: [dart.voidR, [core.int, Node]],
      insertAll: [dart.voidR, [core.int, core.Iterable$(Node)]],
      setAll: [dart.voidR, [core.int, core.Iterable$(Node)]],
      removeLast: [Node, []],
      removeAt: [Node, [core.int]],
      [_filter]: [dart.voidR, [dart.functionType(core.bool, [Node]), core.bool]],
      removeWhere: [dart.voidR, [dart.functionType(core.bool, [Node])]],
      retainWhere: [dart.voidR, [dart.functionType(core.bool, [Node])]],
      set: [dart.voidR, [core.int, Node]],
      sort: [dart.voidR, [], [core.Comparator$(Node)]],
      setRange: [dart.voidR, [core.int, core.int, core.Iterable$(Node)], [core.int]],
      fillRange: [dart.voidR, [core.int, core.int], [Node]],
      get: [Node, [core.int]]
    })
  });
  ...
  NodeList[dart.implements_] = () => [_js_helper.JavaScriptIndexingBehavior, core.List$(Node)];
  ...
  NodeList[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('NodeList')), dart.const_(new _js_helper.Native("NodeList,RadioNodeList"))];
  ...
  ParentNode[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('ParentNode')), dart.const_(new _metadata.Experimental())];
  ...
  dart.setSignature(Range, {
    ...
    methods: () => ({
      ...
      cloneRange: [Range, []],
      [_cloneRange_1]: [Range, []],
      collapse: [dart.voidR, [], [core.bool]],
      [_collapse_1]: [dart.voidR, [dart.dynamicR]],
      [_collapse_2]: [dart.voidR, []],
      compareBoundaryPoints: [core.int, [core.int, Range]],
      [_compareBoundaryPoints_1]: [core.int, [dart.dynamicR, Range]],
      comparePoint: [core.int, [Node, core.int]],
      [_comparePoint_1]: [core.int, [Node, dart.dynamicR]],
      createContextualFragment: [DocumentFragment, [core.String]],
      [_createContextualFragment_1]: [DocumentFragment, [dart.dynamicR]],
      deleteContents: [dart.voidR, []],
      [_deleteContents_1]: [dart.voidR, []],
      detach: [dart.voidR, []],
      [_detach_1]: [dart.voidR, []],
      expand: [dart.voidR, [core.String]],
      [_expand_1]: [dart.voidR, [dart.dynamicR]],
      extractContents: [DocumentFragment, []],
      [_extractContents_1]: [DocumentFragment, []],
      getBoundingClientRect: [math.Rectangle, []],
      [_getBoundingClientRect_1]: [math.Rectangle, []],
      insertNode: [dart.voidR, [Node]],
      [_insertNode_1]: [dart.voidR, [Node]],
      isPointInRange: [core.bool, [Node, core.int]],
      [_isPointInRange_1]: [core.bool, [Node, dart.dynamicR]],
      selectNode: [dart.voidR, [Node]],
      [_selectNode_1]: [dart.voidR, [Node]],
      selectNodeContents: [dart.voidR, [Node]],
      [_selectNodeContents_1]: [dart.voidR, [Node]],
      setEnd: [dart.voidR, [Node, core.int]],
      [_setEnd_1]: [dart.voidR, [Node, dart.dynamicR]],
      setEndAfter: [dart.voidR, [Node]],
      [_setEndAfter_1]: [dart.voidR, [Node]],
      setEndBefore: [dart.voidR, [Node]],
      [_setEndBefore_1]: [dart.voidR, [Node]],
      setStart: [dart.voidR, [Node, core.int]],
      [_setStart_1]: [dart.voidR, [Node, dart.dynamicR]],
      setStartAfter: [dart.voidR, [Node]],
      [_setStartAfter_1]: [dart.voidR, [Node]],
      setStartBefore: [dart.voidR, [Node]],
      [_setStartBefore_1]: [dart.voidR, [Node]],
      surroundContents: [dart.voidR, [Node]],
      [_surroundContents_1]: [dart.voidR, [Node]]
    }),
    statics: () => ({internalCreateRange: [Range, []]}),
    names: ['internalCreateRange']
  });
  Range[dart.metadata] = () => [dart.const_(new _metadata.DomName('Range')), dart.const_(new _metadata.Unstable()), dart.const_(new _js_helper.Native("Range"))];
  Range.END_TO_END = 2;
  ...
  const RequestAnimationFrameCallback = dart.typedef('RequestAnimationFrameCallback', () => dart.functionType(dart.voidR, [core.num]));
  ...
  Screen[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Screen')), dart.const_(new _js_helper.Native("Screen"))];
  ...
  dart.setSignature(ShadowRoot, {
    ...
    statics: () => ({
      ...
      _shadowRootDeprecationReport: [dart.voidR, []]
    }),
    names: ['internalCreateShadowRoot', '_shadowRootDeprecationReport']
  });
  ShadowRoot[dart.metadata] = () => [dart.const_(new _metadata.DomName('ShadowRoot')), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME, '26')), dart.const_(new _metadata.Experimental()), dart.const_(new _js_helper.Native("ShadowRoot"))];
  ...
  StyleElement[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('HTMLStyleElement')), dart.const_(new _js_helper.Native("HTMLStyleElement"))];
  ...
  TemplateElement[dart.metadata] = () => [dart.const_(new _metadata.Experimental()), dart.const_(new _metadata.DomName('HTMLTemplateElement')), dart.const_(new _metadata.SupportedBrowser(_metadata.SupportedBrowser.CHROME)), dart.const_(new _metadata.Experimental()), dart.const_(new _js_helper.Native("HTMLTemplateElement"))];
  ...
  dart.setSignature(Text, {
    ...
    methods: () => ({
      ...
      [_splitText_1]: [Text, [dart.dynamicR]]
    }),
    statics: () => ({internalCreateText: [Text, []]}),
    names: ['internalCreateText']
  });
  Text[dart.metadata] = () => [dart.const_(new _metadata.DomName('Text')), dart.const_(new _js_helper.Native("Text"))];
  ...
  UrlUtils[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('URLUtils')), dart.const_(new _metadata.Experimental())];
  ...
  class Window extends EventTarget {
    ...
    postMessage(message, targetOrigin, messagePorts) {
      ...
      if (messagePorts != null) {
        dart.throw_('postMessage unsupported');
      }
      this.raw.postMessage(message, targetOrigin);
    }
  }
  Window[dart.implements_] = () => [WindowBase];
  ...
  dart.setSignature(Window, {
    ...
    methods: () => ({
      [_open2]: [WindowBase, [dart.dynamicR, dart.dynamicR]],
      [_open3]: [WindowBase, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      open: [WindowBase, [core.String, core.String], [core.String]],
      requestAnimationFrame: [core.int, [RequestAnimationFrameCallback]],
      cancelAnimationFrame: [dart.voidR, [core.int]],
      [_requestAnimationFrame]: [core.int, [RequestAnimationFrameCallback]],
      [_cancelAnimationFrame]: [dart.voidR, [core.int]],
      [_ensureRequestAnimationFrame]: [dart.dynamicR, []],
      [__getter__]: [WindowBase, [dart.dynamicR]],
      [__getter___1]: [dart.dynamicR, [core.int]],
      [__getter___2]: [dart.dynamicR, [core.String]],
      alert: [dart.voidR, [], [core.String]],
      [_alert_1]: [dart.voidR, [dart.dynamicR]],
      [_alert_2]: [dart.voidR, []],
      close: [dart.voidR, []],
      [_close_1]: [dart.voidR, []],
      confirm: [core.bool, [], [core.String]],
      [_confirm_1]: [core.bool, [dart.dynamicR]],
      [_confirm_2]: [core.bool, []],
      find: [core.bool, [core.String, core.bool, core.bool, core.bool, core.bool, core.bool, core.bool]],
      [_find_1]: [core.bool, [dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_getComputedStyle]: [CssStyleDeclaration, [Element, core.String]],
      [_getComputedStyle_1]: [CssStyleDeclaration, [Element, dart.dynamicR]],
      moveBy: [dart.voidR, [core.num, core.num]],
      [_moveBy_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      [_moveTo]: [dart.voidR, [core.num, core.num]],
      [_moveTo_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      print: [dart.voidR, []],
      [_print_1]: [dart.voidR, []],
      resizeBy: [dart.voidR, [core.num, core.num]],
      [_resizeBy_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      resizeTo: [dart.voidR, [core.num, core.num]],
      [_resizeTo_1]: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      scroll: [dart.voidR, [dart.dynamicR, dart.dynamicR], [core.Map]],
      [_scroll_1]: [dart.voidR, [core.num, core.num]],
      [_scroll_2]: [dart.voidR, [core.num, core.num, dart.dynamicR]],
      [_scroll_3]: [dart.voidR, [core.int, core.int]],
      [_scroll_4]: [dart.voidR, [core.int, core.int, dart.dynamicR]],
      scrollBy: [dart.voidR, [dart.dynamicR, dart.dynamicR], [core.Map]],
      [_scrollBy_1]: [dart.voidR, [core.num, core.num]],
      [_scrollBy_2]: [dart.voidR, [core.num, core.num, dart.dynamicR]],
      [_scrollBy_3]: [dart.voidR, [core.int, core.int]],
      [_scrollBy_4]: [dart.voidR, [core.int, core.int, dart.dynamicR]],
      scrollTo: [dart.voidR, [dart.dynamicR, dart.dynamicR], [core.Map]],
      [_scrollTo_1]: [dart.voidR, [core.num, core.num]],
      [_scrollTo_2]: [dart.voidR, [core.num, core.num, dart.dynamicR]],
      [_scrollTo_3]: [dart.voidR, [core.int, core.int]],
      [_scrollTo_4]: [dart.voidR, [core.int, core.int, dart.dynamicR]],
      showModalDialog: [core.Object, [core.String], [core.Object, core.String]],
      [_showModalDialog_1]: [core.Object, [dart.dynamicR, dart.dynamicR, dart.dynamicR]],
      [_showModalDialog_2]: [core.Object, [dart.dynamicR, dart.dynamicR]],
      [_showModalDialog_3]: [core.Object, [dart.dynamicR]],
      stop: [dart.voidR, []],
      [_stop_1]: [dart.voidR, []],
      moveTo: [dart.voidR, [math.Point]],
      postMessage: [dart.voidR, [dart.dynamicR, core.String], [core.List]]
    }),
    statics: () => ({internalCreateWindow: [Window, []]}),
    names: ['internalCreateWindow']
  });
  Window[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Window')), dart.const_(new _js_helper.Native("Window"))];
  Window.contentLoadedEvent = dart.const_(new (EventStreamProvider$(Event))('DOMContentLoaded'));
  Window.PERSISTENT = 1;
  Window.TEMPORARY = 0;
  ...
  _Attr[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('Attr')), dart.const_(new _js_helper.Native("Attr"))];
  ...
  _ClientRect[dart.implements_] = () => [math.Rectangle];
  ...
  _ClientRect[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('ClientRect')), dart.const_(new _js_helper.Native("ClientRect"))];
  ...
  dart.setSignature(_JenkinsSmiHash, {
    statics: () => ({
      ...
      hash2: [core.int, [dart.dynamicR, dart.dynamicR]],
      hash4: [core.int, [dart.dynamicR, dart.dynamicR, dart.dynamicR, dart.dynamicR]]
    }),
  ...
  _NamedNodeMap[dart.implements_] = () => [_js_helper.JavaScriptIndexingBehavior, core.List$(Node)];
  ...
  dart.setSignature(_NamedNodeMap, {
    ...
    methods: () => ({
      ...
      [__getter___1]: [Node, [dart.dynamicR]],
      getNamedItem: [Node, [core.String]],
      [_getNamedItem_1]: [Node, [dart.dynamicR]],
      getNamedItemNS: [Node, [core.String, core.String]],
      [_getNamedItemNS_1]: [Node, [dart.dynamicR, dart.dynamicR]],
      item: [Node, [core.int]],
      [_item_1]: [Node, [dart.dynamicR]],
      removeNamedItem: [Node, [core.String]],
      [_removeNamedItem_1]: [Node, [dart.dynamicR]],
      removeNamedItemNS: [Node, [core.String, core.String]],
      [_removeNamedItemNS_1]: [Node, [dart.dynamicR, dart.dynamicR]],
  ...
  _NamedNodeMap[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('NamedNodeMap')), core.deprecated, dart.const_(new _js_helper.Native("NamedNodeMap,MozNamedAttrMap"))];
  ...
  _XMLHttpRequestProgressEvent[dart.metadata] = () => [dart.const_(new _metadata.DocsEditable()), dart.const_(new _metadata.DomName('XMLHttpRequestProgressEvent')), dart.const_(new _metadata.Experimental()), dart.const_(new _js_helper.Native("XMLHttpRequestProgressEvent"))];
  ...
  class _AttributeMap extends core.Object {
    ...
    addAll(other) {
      other.forEach(dart.fn(((k, v) => {
        this.set(k, v);
      }).bind(this), dart.voidR, [core.String, core.String]));
    }
    containsValue(value) {
  ...
  _AttributeMap[dart.implements_] = () => [core.Map$(core.String, core.String)];
  dart.setSignature(_AttributeMap, {
    constructors: () => ({_AttributeMap: [_AttributeMap, [Element]]}),
    methods: () => ({
      addAll: [dart.voidR, [core.Map$(core.String, core.String)]],
      containsValue: [core.bool, [core.Object]],
      putIfAbsent: [core.String, [core.String, dart.functionType(core.String, [])]],
      clear: [dart.voidR, []],
      forEach: [dart.voidR, [dart.functionType(dart.voidR, [core.String, core.String])]]
    })
  });
  ...
  dart.setSignature(_ElementAttributeMap, {
    ...
    methods: () => ({
      ...
      set: [dart.voidR, [core.String, core.String]],
  ...
  _DataAttributeMap[dart.implements_] = () => [core.Map$(core.String, core.String)];
  ...
  class CssRect extends math.MutableRectangle$(core.num) {
    ...
    set height(newHeight) {
      dart.throw_(new core.UnsupportedError("Can only set height for content rect."));
    }
    set width(newWidth) {
      dart.throw_(new core.UnsupportedError("Can only set width for content rect."));
    }
  ...
  dart.setSignature(_ContentCssRect, {
    constructors: () => ({_ContentCssRect: [_ContentCssRect, [dart.dynamicR]]})
  });
  ...
  dart.setSignature(_ContentCssListRect, {
    constructors: () => ({_ContentCssListRect: [_ContentCssListRect, [dart.dynamicR]]})
  });
  ...
  dart.setSignature(_PaddingCssRect, {
    constructors: () => ({_PaddingCssRect: [_PaddingCssRect, [dart.dynamicR]]})
  });
  ...
  dart.setSignature(_BorderCssRect, {
    constructors: () => ({_BorderCssRect: [_BorderCssRect, [dart.dynamicR]]})
  });
  ...
  dart.setSignature(_MarginCssRect, {
    constructors: () => ({_MarginCssRect: [_MarginCssRect, [dart.dynamicR]]})
  });
    ...
    get _MultiElementCssClassSet() {
      class _MultiElementCssClassSet extends html_common.CssClassSetImpl {
        ...
        readClasses() {
          ...
          this[_sets][dartx.forEach](dart.fn(e => s.addAll(e.readClasses()), dart.voidR, [html_common.CssClassSetImpl]));
          return s;
        }
        writeClasses(s) {
          let classes = s.join(' ');
        ...
        modify(f) {
          this[_sets][dartx.forEach](dart.fn(e => e.modify(f), dart.voidR, [html_common.CssClassSetImpl]));
        }
      ...
      dart.setSignature(_MultiElementCssClassSet, {
        ...
        methods: () => ({
          ...
          writeClasses: [dart.voidR, [core.Set$(core.String)]]
        })
      });
    ...
    get _ElementCssClassSet() {
      ...
      dart.setSignature(_ElementCssClassSet, {
        ...
        statics: () => ({
          ...
          _addAll: [dart.voidR, [Element, core.Iterable$(core.String)]],
          _removeAll: [dart.voidR, [Element, core.Iterable$(core.String)]],
          _removeWhere: [dart.voidR, [Element, dart.functionType(core.bool, [core.String]), core.bool]],
          ...
          _classListAdd: [dart.voidR, [DomTokenList, core.String]],
          _classListRemove: [dart.voidR, [DomTokenList, core.String]],
  ...
  Dimension[dart.metadata] = () => [dart.const_(new _metadata.Experimental())];
  const EventListener = dart.typedef('EventListener', () => dart.functionType(dart.dynamicR, [Event]));
  const ElementStream$ = dart.generic(function(T) {
    class ElementStream extends core.Object {}
    ElementStream[dart.implements_] = () => [async.Stream$(T)];
  ...
  const _EventStream$ = dart.generic(function(T) {
    class _EventStream extends async.Stream$(T) {
      ...
      asBroadcastStream(opts) {
        ...
        dart.as(onListen, dart.functionType(dart.voidR, [async.StreamSubscription$(T)]));
        let onCancel = opts && 'onCancel' in opts ? opts.onCancel : null;
        dart.as(onCancel, dart.functionType(dart.voidR, [async.StreamSubscription$(T)]));
        return this;
      }
      get isBroadcast() {
        return true;
      ...
      listen(onData, opts) {
        dart.as(onData, dart.functionType(dart.voidR, [T]));
        let onError = opts && 'onError' in opts ? opts.onError : null;
        let onDone = opts && 'onDone' in opts ? opts.onDone : null;
        dart.as(onDone, dart.functionType(dart.voidR, []));
    ...
    dart.setSignature(_EventStream, {
      ...
      methods: () => ({
        asBroadcastStream: [async.Stream$(T), [], {onListen: dart.functionType(dart.voidR, [async.StreamSubscription$(T)]), onCancel: dart.functionType(dart.voidR, [async.StreamSubscription$(T)])}],
        listen: [async.StreamSubscription$(T), [dart.functionType(dart.voidR, [T])], {onError: core.Function, onDone: dart.functionType(dart.voidR, []), cancelOnError: core.bool}]
      })
    });
    return _EventStream;
  });
  ...
  const _ElementEventStreamImpl$ = dart.generic(function(T) {
    class _ElementEventStreamImpl extends _EventStream$(T) {
      ...
      matches(selector) {
        return dart.as(this.where(dart.fn(event => dart.as(dart.dcall(event.target.matchesWithAncestors, selector), core.bool), core.bool, [T])).map(dart.fn(e => {
          ...
          return e;
        }, dart.dynamicR, [T])), async.Stream$(T));
      }
      capture(onData) {
        dart.as(onData, dart.functionType(dart.voidR, [T]));
    ...
    _ElementEventStreamImpl[dart.implements_] = () => [ElementStream$(T)];
    dart.setSignature(_ElementEventStreamImpl, {
      constructors: () => ({_ElementEventStreamImpl: [_ElementEventStreamImpl$(T), [dart.dynamicR, dart.dynamicR, dart.dynamicR]]}),
      methods: () => ({
        matches: [async.Stream$(T), [core.String]],
        capture: [async.StreamSubscription$(T), [dart.functionType(dart.voidR, [T])]]
      })
    });
  ...
  const _ElementListEventStreamImpl$ = dart.generic(function(T) {
    ...
    _ElementListEventStreamImpl[dart.implements_] = () => [ElementStream$(T)];
  ...
  const _EventStreamSubscription$ = dart.generic(function(T) {
    class _EventStreamSubscription extends async.StreamSubscription$(T) {
      ...
      onData(handleData) {
        dart.as(handleData, dart.functionType(dart.voidR, [T]));
        if (dart.notNull(this[_canceled])) {
          dart.throw_(new core.StateError("Subscription has been canceled."));
        }
        this[_unlisten]();
      ...
      onError(handleError) {}
      onDone(handleDone) {
        dart.as(handleDone, dart.functionType(dart.voidR, []));
      }
      pause(resumeSignal) {
    ...
    dart.setSignature(_EventStreamSubscription, {
      constructors: () => ({_EventStreamSubscription: [_EventStreamSubscription$(T), [EventTarget, core.String, dart.dynamicR, core.bool]]}),
      methods: () => ({
        cancel: [async.Future, []],
        onData: [dart.voidR, [dart.functionType(dart.voidR, [T])]],
        onError: [dart.voidR, [core.Function]],
        onDone: [dart.voidR, [dart.functionType(dart.voidR, [])]],
        pause: [dart.voidR, [], [async.Future]],
        resume: [dart.voidR, []],
        [_tryResume]: [dart.voidR, []],
        [_unlisten]: [dart.voidR, []],
        asFuture: [async.Future, [], [dart.dynamicR]]
      })
    });
  ...
  const CustomStream$ = dart.generic(function(T) {
    ...
    CustomStream[dart.implements_] = () => [async.Stream$(T)];
    return CustomStream;
  });
  ...
  const _CustomEventStreamImpl$ = dart.generic(function(T) {
    ...
    _CustomEventStreamImpl[dart.implements_] = () => [CustomStream$(T)];
  ...
  class _WrappedEvent extends core.Object {
    ...
    [_initEvent](eventTypeArg, canBubbleArg, cancelableArg) {
      dart.throw_(new core.UnsupportedError('Cannot initialize this Event.'));
    }
    preventDefault() {
  ...
  _WrappedEvent[dart.implements_] = () => [Event];
  ...
  class KeyEvent extends _WrappedEvent {
    ...
    [_initUIEvent](type, canBubble, cancelable, view, detail) {
      dart.throw_(new core.UnsupportedError("Cannot initialize a UI Event from a KeyEvent."));
    }
    ...
    get [_keyIdentifier]() {
      dart.throw_(new core.UnsupportedError("keyIdentifier is unsupported."));
    }
    [_initKeyboardEvent](type, canBubble, cancelable, view, keyIdentifier, keyLocation, ctrlKey, altKey, shiftKey, metaKey) {
      dart.throw_(new core.UnsupportedError("Cannot initialize a KeyboardEvent from a KeyEvent."));
    }
    get [_layerX]() {
      return dart.throw_(new core.UnsupportedError('Not applicable to KeyEvent'));
    }
    get [_layerY]() {
      return dart.throw_(new core.UnsupportedError('Not applicable to KeyEvent'));
    }
    ...
    getModifierState(keyArgument) {
      return dart.throw_(new core.UnimplementedError());
    }
    get location() {
      return dart.throw_(new core.UnimplementedError());
    }
  ...
  KeyEvent[dart.implements_] = () => [KeyboardEvent];
  ...
  dart.setSignature(KeyEvent, {
    ...
    statics: () => ({
      _makeRecord: [dart.dynamicR, []],
      _convertToHexString: [core.String, [core.int, core.int]]
    }),
    names: ['_makeRecord', '_convertToHexString']
  });
  KeyEvent[dart.metadata] = () => [dart.const_(new _metadata.Experimental())];
  ...
  const _StreamPool$ = dart.generic(function(T) {
    class _StreamPool extends core.Object {
      ...
      add(stream) {
        ...
        this[_subscriptions].set(stream, stream.listen(dart.bind(this[_controller], 'add'), {onError: dart.bind(this[_controller], 'addError'), onDone: dart.fn((() => this.remove(stream)).bind(this), dart.voidR, [])}));
      }
      remove(stream) {
        dart.as(stream, async.Stream$(T));
    ...
    dart.setSignature(_StreamPool, {
      ...
      methods: () => ({
        add: [dart.voidR, [async.Stream$(T)]],
        remove: [dart.voidR, [async.Stream$(T)]],
        close: [dart.voidR, []]
      })
    });
    return _StreamPool;
  ...
  _Html5NodeValidator[dart.implements_] = () => [NodeValidator];
  ...
  class _KeyboardEventHandler extends EventStreamProvider$(KeyEvent) {
    ...
    initializeAllEventListeners(type, target) {
      ...
      this[_stream] = null;
      super.EventStreamProvider(_KeyboardEventHandler._EVENT_TYPE);
      dart.throw_('Key event handling not supported in DDC');
    }
    get [_capsLockOn]() {
  ...
  class NodeValidatorBuilder extends core.Object {
    ...
    allowSvg() {
      dart.throw_('SVG not supported with DDC');
    }
  ...
  NodeValidatorBuilder[dart.implements_] = () => [NodeValidator];
  ...
  dart.setSignature(NodeValidatorBuilder, {
    ...
    methods: () => ({
      allowNavigation: [dart.voidR, [], [UriPolicy]],
      allowImages: [dart.voidR, [], [UriPolicy]],
      allowTextElements: [dart.voidR, []],
      allowInlineStyles: [dart.voidR, [], {tagName: core.String}],
      allowHtml5: [dart.voidR, [], {uriPolicy: UriPolicy}],
      allowSvg: [dart.voidR, []],
      allowCustomElement: [dart.voidR, [core.String], {uriPolicy: UriPolicy, attributes: core.Iterable$(core.String), uriAttributes: core.Iterable$(core.String)}],
      allowTagExtension: [dart.voidR, [core.String, core.String], {uriPolicy: UriPolicy, attributes: core.Iterable$(core.String), uriAttributes: core.Iterable$(core.String)}],
      allowElement: [dart.voidR, [core.String], {uriPolicy: UriPolicy, attributes: core.Iterable$(core.String), uriAttributes: core.Iterable$(core.String)}],
      allowTemplating: [dart.voidR, []],
      add: [dart.voidR, [NodeValidator]],
      allowsElement: [core.bool, [Element]],
      allowsAttribute: [core.bool, [Element, core.String, core.String]]
    })
  });
  class _SimpleNodeValidator extends core.Object {
    static allowNavigation(uriPolicy) {
      return new _SimpleNodeValidator(uriPolicy, {allowedElements: dart.const_(dart.list(['A', 'FORM'], core.String)), allowedAttributes: dart.const_(dart.list(['A::accesskey', 'A::coords', 'A::hreflang', 'A::name', 'A::shape', 'A::tabindex', 'A::target', 'A::type', 'FORM::accept', 'FORM::autocomplete', 'FORM::enctype', 'FORM::method', 'FORM::name', 'FORM::novalidate', 'FORM::target'], core.String)), allowedUriAttributes: dart.const_(dart.list(['A::href', 'FORM::action'], core.String))});
    }
    static allowImages(uriPolicy) {
      return new _SimpleNodeValidator(uriPolicy, {allowedElements: dart.const_(dart.list(['IMG'], core.String)), allowedAttributes: dart.const_(dart.list(['IMG::align', 'IMG::alt', 'IMG::border', 'IMG::height', 'IMG::hspace', 'IMG::ismap', 'IMG::name', 'IMG::usemap', 'IMG::vspace', 'IMG::width'], core.String)), allowedUriAttributes: dart.const_(dart.list(['IMG::src'], core.String))});
    }
    static allowTextElements() {
      return new _SimpleNodeValidator(null, {allowedElements: dart.const_(dart.list(['B', 'BLOCKQUOTE', 'BR', 'EM', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'HR', 'I', 'LI', 'OL', 'P', 'SPAN', 'UL'], core.String))});
    }
    _SimpleNodeValidator(uriPolicy, opts) {
      ...
      this.allowedElements.addAll(dart.as((allowedElements != null ? allowedElements : dart.const_([])), core.Iterable$(core.String)));
      allowedAttributes = dart.as((allowedAttributes != null ? allowedAttributes : dart.const_([])), core.Iterable$(core.String));
      allowedUriAttributes = dart.as((allowedUriAttributes != null ? allowedUriAttributes : dart.const_([])), core.Iterable$(core.String));
  ...
  _SimpleNodeValidator[dart.implements_] = () => [NodeValidator];
  ...
  _TemplatingNodeValidator._TEMPLATE_ATTRS = dart.const_(dart.list(['bind', 'if', 'ref', 'repeat', 'syntax'], core.String));
  ...
  const _WrappedList$ = dart.generic(function(E) {
    ...
    _WrappedList[dart.implements_] = () => [html_common.NodeListWrapper];
  ...
  const _WrappedIterator$ = dart.generic(function(E) {
    ...
    _WrappedIterator[dart.implements_] = () => [core.Iterator$(E)];
  ...
  dart.setSignature(_HttpRequestUtils, {
    statics: () => ({get: [HttpRequest, [core.String, dart.functionType(dart.dynamicR, [HttpRequest]), core.bool]]}),
    names: ['get']
  });
  ...
  const FixedSizeListIterator$ = dart.generic(function(T) {
    ...
    FixedSizeListIterator[dart.implements_] = () => [core.Iterator$(T)];
  ...
  const _VariableSizeListIterator$ = dart.generic(function(T) {
    ...
    _VariableSizeListIterator[dart.implements_] = () => [core.Iterator$(T)];
  ...
  dart.fn(_convertNativeToDart_Window, WindowBase, [dart.dynamicR]);
  ...
  dart.fn(_convertNativeToDart_EventTarget, EventTarget, [dart.dynamicR]);
  ...
  dart.fn(_convertDartToNative_EventTarget, EventTarget, [dart.dynamicR]);
  ...
  class _DOMWindowCrossFrame extends core.Object {
    ...
    get on() {
      return dart.throw_(new core.UnsupportedError('You can only attach EventListeners to your own window.'));
    }
    [_addEventListener](type, listener, useCapture) {
      if (type === void 0) type = null;
      if (listener === void 0) listener = null;
  ...
  _DOMWindowCrossFrame[dart.implements_] = () => [WindowBase];
  dart.setSignature(_DOMWindowCrossFrame, {
    constructors: () => ({_DOMWindowCrossFrame: [_DOMWindowCrossFrame, [dart.dynamicR]]}),
    methods: () => ({
      close: [dart.voidR, []],
      postMessage: [dart.voidR, [dart.dynamicR, core.String], [core.List]],
      [_addEventListener]: [dart.voidR, [], [core.String, EventListener, core.bool]],
    ...
    statics: () => ({_createSafe: [WindowBase, [dart.dynamicR]]}),
    names: ['_createSafe']
  });
  ...
  _LocationCrossFrame[dart.implements_] = () => [LocationBase];
  dart.setSignature(_LocationCrossFrame, {
    constructors: () => ({_LocationCrossFrame: [_LocationCrossFrame, [dart.dynamicR]]}),
    statics: () => ({
      _setHref: [dart.voidR, [dart.dynamicR, dart.dynamicR]],
      _createSafe: [LocationBase, [dart.dynamicR]]
    }),
  ...
  _HistoryCrossFrame[dart.implements_] = () => [HistoryBase];
  dart.setSignature(_HistoryCrossFrame, {
    constructors: () => ({_HistoryCrossFrame: [_HistoryCrossFrame, [dart.dynamicR]]}),
    methods: () => ({
      back: [dart.voidR, []],
      forward: [dart.voidR, []],
      go: [dart.voidR, [core.int]]
    }),
    statics: () => ({_createSafe: [HistoryBase, [dart.dynamicR]]}),
    names: ['_createSafe']
  });
  ...
  dart.fn(_wrapZone, dart.dynamicR, [dart.functionType(dart.dynamicR, [dart.dynamicR])]);
  function _wrapBinaryZone(callback) {
    if (dart.equals(async.Zone.current, async.Zone.ROOT)) return callback;
    if (callback == null) return null;
    return async.Zone.current.bindBinaryCallback(callback, {runGuarded: true});
  }
  dart.fn(_wrapBinaryZone, dart.dynamicR, [dart.functionType(dart.dynamicR, [dart.dynamicR, dart.dynamicR])]);
  ...
  _TrustedHtmlTreeSanitizer[dart.implements_] = () => [NodeTreeSanitizer];
  dart.setSignature(_TrustedHtmlTreeSanitizer, {
    constructors: () => ({_TrustedHtmlTreeSanitizer: [_TrustedHtmlTreeSanitizer, []]}),
    methods: () => ({sanitizeTree: [dart.voidR, [Node]]})
  });
  NodeTreeSanitizer.trusted = dart.const_(new _TrustedHtmlTreeSanitizer());
  ...
  _SameOriginUriPolicy[dart.implements_] = () => [UriPolicy];
  ...
  class _ThrowsNodeValidator extends core.Object {
    ...
    allowsElement(element) {
      if (!dart.notNull(this.validator.allowsElement(element))) {
        dart.throw_(new core.ArgumentError(Element._safeTagName(element)));
      }
      return true;
    }
    allowsAttribute(element, attributeName, value) {
      if (!dart.notNull(this.validator.allowsAttribute(element, attributeName, value))) {
        dart.throw_(new core.ArgumentError(`${Element._safeTagName(element)}[${attributeName}="${value}"]`));
      }
    }
  }
  _ThrowsNodeValidator[dart.implements_] = () => [NodeValidator];
  ...
  class _ValidatingTreeSanitizer extends core.Object {
    ...
    sanitizeTree(node) {
      ...
      dart.fn(walk, dart.voidR, [Node, Node]);
      walk(node, null);
    }
  ...
  _ValidatingTreeSanitizer[dart.implements_] = () => [NodeTreeSanitizer];
  dart.setSignature(_ValidatingTreeSanitizer, {
    constructors: () => ({_ValidatingTreeSanitizer: [_ValidatingTreeSanitizer, [NodeValidator]]}),
    methods: () => ({
      sanitizeTree: [dart.voidR, [Node]],
      [_removeNode]: [dart.voidR, [Node, Node]],
      [_sanitizeUntrustedElement]: [dart.voidR, [dart.dynamicR, Node]],
      [_sanitizeElement]: [dart.voidR, [Element, Node, core.bool, core.String, core.String, core.Map, core.String]],
      sanitizeNode: [dart.voidR, [Node, Node]]
    })
  });
  dart.defineLazyProperties(exports, {
    get window() {
  ...
  _EntryArray[dart.implements_] = () => [core.List$(dart.dynamicR)];
  _EntryArray[dart.metadata] = () => [dart.const_(new _js_helper.Native("EntryArray"))];
  function spawnDomUri(uri, args, message) {
    dart.throw_(new core.UnimplementedError());
  }
  dart.fn(spawnDomUri, async.Future$(isolate.Isolate), [core.Uri, core.List$(core.String), dart.dynamicR]);
  const _F1 = dart.typedef('_F1', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  ...
  dart.fn(createCustomUpgrader, dart.dynamicR, [core.Type, dart.dynamicR]);
  dart.defineLazyProperties(exports, {
    get htmlBlinkMap() {
  ...
  dart.fn(getHtmlCreateFunction, dart.dynamicR, [core.String]);
  ...
  const __CastType2 = dart.typedef('__CastType2', () => dart.functionType(dart.dynamicR, [dart.dynamicR]));
  // Exports:
